...
// $model->bkg_status = Booking::STATUS_VERIFY;
	...
	public function actionTerms()
	{
		...
		$this->metaDescription	 = "Gozo cabs | Terms & Conditions | aaocab.com";
...
//		$this->checkV2Theme();
	...
	public function actionGst()
	{
		...
		if ($name != '')
		{
			...
			emailWrapper::createLog('info@aaocab.com', $subject, $body, "", $usertype, $delivered, '', $refType, '', EmailLog::SEND_SERVICE_EMAIL);
...
// exit;
	...
	public function actionOnewayCabs()
	{
		...
		Yii::app()->clientScript->registerLinkTag('canonical', null, 'http://www.aaocab.com/one-way-cab');
