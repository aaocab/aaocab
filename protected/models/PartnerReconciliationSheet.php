...
class PartnerReconciliationSheet extends CActiveRecord
{
	...
	public $arrSheetType = ["1" => "Payout Sheet", "2" => "Penalty Sheet"];
	...
	public function rules()
	{
		...
		return array(
			...
			array('prs_id, prs_title, prs_sheet_type, prs_filename, prs_row_count, prs_status, prs_created_by, prs_create_date', 'safe', 'on' => 'search'),
			array('prs_id, prs_title, prs_sheet_type, prs_filename, prs_row_count, prs_status, prs_created_by, prs_create_date', 'safe'),
		);
	}
