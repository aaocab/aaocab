...
class SpacesS3
{
	...
	public function list(): array
	{
		...
		foreach (SpacesAPI\Result::parse($this->s3->listBuckets()['Buckets']) as $bucket)
		{
	 ...
	 */
	public function create(string $name, bool $public = false): \SpacesAPI\Space
	{
		try
		{
		...
		return new \SpacesAPI\Space($this->s3, $name, false);
	}
	 ...
	 */
	public function space(string $name): \SpacesAPI\Space
	{
		return new \SpacesAPI\Space($this->s3, $name);
	}
