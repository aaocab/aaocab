...
use components\FirebaseCloudMessaging\Recipient\Recipient;
...
class Message implements \JsonSerializable
{
	 ...
	 *
	 * @return \FirebaseCloudMessaging\Message
	 */
	...
	{
		$this->recipientType = Device::class;
	...
	public function jsonSerialize()
	{
		...
		if ($this->recipientType == Device::class)
		{
			...
			{
				$jsonData['to'] = $this->createRecipient();
			}
			else
			{
				$jsonData['registration_ids'] = $this->createRecipient();
			}
		}

		if ($this->recipientType == Topic::class)
		{
			if (count($this->recipients) == 1)
			{
