...
<div class="container mt50">
	<?
	$resultSet	 = Shuttle::model()->getAvailableSeatbyId($model->bkg_shuttle_id);
	$preData	 = $model->preData;
	$noOfSeat	 = $preData['preBookData']['bkg_no_of_seats'];
	if ($resultSet['available_seat'] > 0 && $resultSet['available_seat'] >= $noOfSeat)
	{
		?>
		<div class="spot-panel">
			...
			$form = $this->beginWidget('booster.widgets.TbActiveForm', array(
				'id'					 => 'shuttle_spot18', 'enableClientValidation' => FALSE,
				'clientOptions'			 => array('validateOnSubmit'	 => true,
					'errorCssClass'		 => 'has-error'),
				'enableAjaxValidation'	 => false,
				'errorMessageCssClass'	 => 'help-block',
				'htmlOptions'			 => array('onSubmit' => 'disableBttn();return true;', 'class' => 'form-horizontal'),
			));
			...
			<div class="col-xs-12">
				...
				<button class="col-xs-12 col-md-5 btn btn-primary pull-left payButton" style="height: 140px; line-height: 16px;" type="submit" onclick="return onPaymentOption(1);" name="payByAgent">    
					<div class="col-xs-12 col-md-6">
						...
						<h5 class="mt20  text-left">Gozo will charge you <i class="fa fa-inr"></i><?= $bkg_total_amount; ?> for the booking</h5>
					</div>
				</button>

				<button class="col-xs-12 col-md-5 btn btn-primary  ml5 pull-right payButton" style="height: 140px; line-height: 16px;" type="submit" onclick="return onPaymentOption(2);" name="payByCustomer">
					<div class="col-xs-12 col-md-6">
						<div class="text-left">
						...
						<div class=" text-left">
							<h5 class="mt20 text-left">Gozo will charge customer <i class="fa fa-inr"></i><?= $bkg_total_amount; ?> for the booking</h5>
						</div>
					</div>
				</button>
			</div>
			<div class="col-xs-12 mt30">
				<button type="submit" class="pull-left btn btn-danger btn-lg pl25 pr25 pt30 pb30" name="step18ToStep17"><b> <i class="fa fa-arrow-left"></i> Previous</b></button>
			</div>
			<?php $this->endWidget(); ?>
		</div>
		<?
	...
	{
		?>
		<div>All seats are booked in this shuttle. Choose other shuttle</div>
		<?
	}
	?>
</div>
