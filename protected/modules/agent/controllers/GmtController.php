...
//            $minAdvance      = $minPerAdvAmount - 2;
			...
			/* @var $isAllowedAdvance GoMmt */
			$model->requestType = \booking::CONFIRM_REQUEST;
			$isAllowedAdvance = \GoMmt::isCashBookingAllowed($model->bkg_from_city_id, $model->bkg_booking_type, $model->bkg_vehicle_type_id, $model->bkg_to_city_id, $model->bkg_agent_id, $model->requestType, $obj, $model);
			
			if ($isAllowedAdvance == false)
			{
			...
			{
				$advanceAmount = $model->bkgInvoice->bkg_advance_amount;
				$model->bkgInvoice->save();
