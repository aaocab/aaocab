	...
	<div class="span-6">
		<table style="margin-bottom:0;"><tr><td>
					...
					<form id="user-select-form">
						<?php echo CHtml::dropDownList('user[]', '', CHtml::listData($users, $this->module->userIdColumn, "name"), array('onchange' => 'selectUser("' . $this->createAbsoluteUrl('ajax/infoUserAssignments') . '");', 'multiple' => true, 'size' => '20', 'style' => 'width:220px;'));
						?>
					</form>
				</td></tr></table>
	</div>
