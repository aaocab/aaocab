...
class PromoController extends Controller
{
	...
	public function actionGetpromodiscount()
	{
		...
		if ($promoModel != '' && $promoModel->prm_type == 2 && $promoModel->prm_activate_on != 1)
		{
			$promoCredits	 = $discount;
			$discount		 = 0;
		}
		if ($promoModel != '' && $promoModel->prm_activate_on == 1 && $promoModel->prm_type == 2)
		{
			$promoCredits	 = $discount;
			$discount		 = 0;
			$success		 = false;
		}
		if ($promoModel != '' && $promoModel->prm_activate_on == 1 && $promoModel->prm_type == 1)
		{
			$promoCredits	 = 0;
			$discount		 = 0;
			$success		 = false;
	...
	public function actionValidatecode()
	{
		...
		$result	 = $model->validateCode($code, $userid, $bkgmodel->bkg_pickup_date);
