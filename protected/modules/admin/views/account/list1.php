                    ...
                    <div id="account_tab1">
						...
						if (!empty($dataProvider))
						{
							...
							$this->widget('booster.widgets.TbGridView', array(
								...
								'ajaxUrl'			 => CHtml::normalizeUrl(Yii::app()->createUrl('admin/account/list1', $dataProvider->getPagination()->params)),
								...
								'columns'			 => array(
									...
									array('name'	 => 'abc', 'filter' => false,
										'value'	 => function($data) {
											echo $data['abc'] . '</nobr>';
										}
										, 'sortable'			 => true, 'headerHtmlOptions'	 => array('style' => 'text-align:center'), 'htmlOptions'		 => array('class' => 'text-right'), 'header'			 => 'Year Month')
									,
									array('name'	 => 'name',
										'value'	 => function($data) {
										...
										'sortable'			 => true, 'headerHtmlOptions'	 => array('style' => 'text-align:left'), 'header'			 => 'Ledger Name'),
								...
								'columns'			 => array(
									...
									array('name'	 => 'name',
										'value'	 => function($data) {
												...
												echo CHtml::link($data["name"], Yii::app()->createUrl("admin/account/list1", $_REQUEST + ["ledgerId" => $data["ledgerId"]]));
