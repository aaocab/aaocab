...
{
	$result	 = $resultQT;
	$type	 = $model["scq_follow_up_queue_type"]==38 ? "Mmt Support": ( $model["scq_follow_up_queue_type"]==52? "CUSTOM PUSH API": "B2B Post pickup");
	$typeId	 = 2;
	?>
	<div class="">
		<div class="row">
						...
						<div class="row">
							...
							<div class="row" style="float:right; margin-right: 280px; margin-top: 20px;">
								<div class="col-xs-12">
									...
									<div class="col-xs-6" >
										<a class="" onclick="CloseB2BPostPickupCall()">	
				...
				<div class="row">
					<div class="col-xs-12">
						<ul class="nav nav-tabs" id="myTab">
							...
							?>
							<li  id="tablist_3"><a data-toggle="tab" id="tid_3" class="bg-white" href="#sec3"><?php echo 'Driver Details' ?>  </a></li>
						</ul>
						<div class="tab-content p0" id="details_2">
							<div id="<?php echo 'sec3' ?>" tabid="3" class="tab-pane">			 
								<?php
								$drvid		 = $model['scq_to_be_followed_up_with_entity_id'];
...
<script>
    ...
    function CloseB2BPostPickupCall()
    {
        bootbox.confirm({
            title: "Close Call",
            ...
            callback: function (result) {
                if (result)
                {
                    $href = '/aaohome/lead/CloseB2BPostPickupCall';
