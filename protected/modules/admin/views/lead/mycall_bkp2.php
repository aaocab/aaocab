						...
						<div class="panel-body panel-border">
							<div class="row">
								<div class="col-xs-12 col-lg-7">
									<p class="mb5"><b>Name:</b>   <?= $result['bkg_user_name'] . ' ' . $result['bkg_user_lname']; ?></p>
									<p class="mb5"><b>Account:</b></p>
									<p class="mb5"><b>Joining Date:</b>   <?= $result['usr_created_at'] ?></p>
								...
								<div class="col-xs-12 col-lg-5">
									<p class="mb5"><b>Call Queue:</b>  <?= $type ?></p>
									<p class="mb5"><b>Call request received at:</b>  <?= $result['bkg_create_date'] ?></p>

									<p class="mb5"><b>Ratings received:</b> Count (<?php if(count($userDriverRating >0)){ echo $userDriverRating['cntcustomer'];} else{echo "0";}?>) | Avg Rating (<?php if(count($userDriverRating >0)){ echo $userDriverRating['rtg_customer_overall'];} else{echo "0";}?>)</p>
									<p class="mb5"><b>Rating given:</b> Count (<?php if(count($userDriverRating >0)){ echo $userDriverRating['cntdriver'];} else{echo "0";}?>) | Avg Rating (<?php if(count($userDriverRating >0)){ echo $userDriverRating['rtg_customer_driver'];} else{echo "0";}?>)</p>
									...
									<p class="mb5"><b>Currently Assigned Quote/Lead ID:</b>
										...
										<?php 	foreach ($assignedLeads as $leadids)
												{
											?>
													<option value="<?= $leadids['bkg_id'] ?>" <?php if ($leadids['bkg_id'] == $result['bkg_id']) echo ' selected="selected"'; ?>><?= $leadids['bkg_booking_id'] ?></option>
											<?php } ?>
										</select>
									</p>
								</div>
