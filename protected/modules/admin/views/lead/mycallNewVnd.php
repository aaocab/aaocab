					...
					<div class="col-xs-12">
						<ul class="nav nav-tabs" id="myTab">
							...
							<li class="tabactive20 " id="tablist_20">
								<?php $tabUrl	 = "data-url=\"" . Yii::app()->createUrl('admin/vendor/listtoapprove', array('cttid' => $cModel->ctt_id, 'source' => 'mycall')) . '"';
								?>
								<a data-toggle="tabajax" id="tid_20" <?php echo $tabUrl ?> class="bg-white" href="#sec20"> Pending List	</a>
							</li>
							<li class="tabactive30 " id="tablist_30">
								<?php $tabUrl	 = "data-url=\"" . Yii::app()->createUrl('admin/vendor/list', array('cttid' => $cModel->ctt_id, 'source' => 'mycall')) . '"';
								?>
								<a data-toggle="tabajax" id="tid_30" <?php echo $tabUrl ?> class="bg-white" href="#sec30"> Existing List	</a>
							</li>
						</ul>
						<div class="tab-content p0" id="details_2">
							...
							<div id="sec30" tabid="30" class='tab-pane ' >
							</div>
