                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-5 table-responsive">
                                <table class="table table-striped table-bordered">
                                    <tr>
                                        <td><b>Vendor</b></td>
										<td><?php echo $record['vnd_name'] ?> <?php if(empty($vndmodel)) {?> <h4 style="color:#ff0000;">Deleted</h4> <?php } ?></td>
                                    </tr>
                                    <?php
                ...
                <div class="row">
                    <div class="tab-content p0">
                        ...
                        <div id="<?php echo 'sec0' ?>" tabid="0" class="tab-pane active">			 
                            ...
                            <?php
                            $vndId           = !empty($vndmodel->vnd_id) ? $vndmodel->vnd_id :  $vndid;							
    ...
    function closeCall(userid, csrid, bkgid)
    {
        bootbox.confirm({
            ...
            callback: function (result) {
                if (result)
                {
                    $href = '/aaohome/lead/closeVndCall';
