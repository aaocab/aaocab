...
$teamDetails = Teams::getMultipleTeamid($csr);
...
<div style="float:right">
	<?php
	if ($pmodel->adp_auto_allocated == 0)
	{
		?>
		<a href="javascript:void(0)" class="btn btn-primary mt5 isMultipleAllowed" data-id="<?php echo $teamId; ?>" style="width: 185px;">Allocate Multiple CBR</a>
	<?php } ?>
	<br/>
...
<script>
    ...
    {
        $(document).on('click', '.isMultipleAllowed', function () {
            var team = $(this).attr('data-id');
            bootbox.confirm({
                        title: "Assign Multiple CBR",
                        message: "Do you want to assign mutiple CBR?",
                        buttons: {
                            cancel: {
                                label: '<i class="fa fa-times"></i> Cancel'
                            },
