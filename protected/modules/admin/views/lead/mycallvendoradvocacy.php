						...
						<div class="row">
							...
							<div class="row" style="float:right; margin-right: 280px; margin-top: 20px;">
								<div class="col-xs-12">
									...
									<div class="col-xs-6" >
										<a class="" onclick="CloseVendorAdvocacyCall()">	
				...
				<div class="row">
					<div class="col-xs-12">
						<ul class="nav nav-tabs" id="myTab">
							...
							?>
							<li  id="tablist_3"><a data-toggle="tab" id="tid_3" class="bg-white" href="#sec3"><?php echo 'Vendor Details' ?>  </a></li>
						</ul>
...
<script>
    ...
    function CloseVendorAdvocacyCall()
    {
        bootbox.confirm({
            title: "Close Call",
            ...
            callback: function (result) {
                if (result)
                {
                    $href = '/aaohome/lead/CloseVendorAdvocacyCall';
