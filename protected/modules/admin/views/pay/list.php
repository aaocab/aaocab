		...
		<div class="col-xs-12">
            ...
            <div class='panel-footer'><div class='row m0'><div class='col-xs-12 col-sm-6 p5'>{summary}</div><div class='col-xs-12 col-sm-6 pr0'>{pager}</div></div></div>",
							...
							'columns'			 => array(
								...
								array('name'	 => 'onb_txn_type',
									'value'	 => function($data)
									{
										$payList = ICICIIB::payType;
										echo $payList[$data["onb_txn_type"]];
									}
									, 'sortable'			 => false, 'filter'			 => FALSE,
									'headerHtmlOptions'	 => array('class' => '  text-center'),
									'htmlOptions'		 => array('class' => 'text-center'), 'header'			 => 'Payment Type'),
								...
								array('name'				 => 'onb_code', 'value'				 => ' ($data["onb_code"])', 'sortable'			 => false, 'filter'			 => FALSE,
									'headerHtmlOptions'	 => array('class' => ' text-center'),
									'htmlOptions'		 => array('class' => 'text-center'), 'header'			 => 'Gozo Refcode'),
								array('name'	 => 'onb_response',
									'value'	 => function($data)
									{
										if ($data['onb_status'] == 1)
										{
											$res = json_decode($data['onb_response'],true);
											echo $res['UTRNUMBER'];
										}
										else
										{
									...
									, 'sortable'			 => false, 'filter'			 => FALSE,
									'headerHtmlOptions'	 => array('class' => ' text-center'),
									'htmlOptions'		 => array('class' => 'text-center'), 'header'			 => 'Bank Refcode'),
								array('name'				 => 'onb_process_started_on', 'value'				 => ' DateTimeFormat::DateTimeToLocale($data["onb_process_started_on"])', 'sortable'			 => false, 'filter'			 => FALSE,
									'headerHtmlOptions'	 => array('class' => ' text-center'),
									'htmlOptions'		 => array('class' => 'text-center'), 'header'			 => 'Transaction Start Time'),
								array('name'				 => 'onb_processed_on', 'value'				 => ' DateTimeFormat::DateTimeToLocale($data["onb_processed_on"])', 'sortable'			 => false, 'filter'			 => FALSE,
									'headerHtmlOptions'	 => array('class' => ' text-center'),
									'htmlOptions'		 => array('class' => 'text-center'), 'header'			 => 'Transaction Processed Time'),
