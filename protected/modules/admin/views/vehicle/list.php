    ...
    <div class="col-xs-12">
        ...
        <div class="form-group row">
            <div class="col-xs-12 mb10">
                ...
                <div class="col-xs-6 col-sm-4 cityinput">
					<?php
//                    $this->widget('booster.widgets.TbSelect2', array(
//                        'model' => $model,
...
//                    ));
            ...
            <div class="col-xs-12 mb10">
                <div class="col-xs-6 col-sm-4">
					<?= $form->numberFieldGroup($model, 'vhc_year', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('min' => 1990, 'max' => date('Y')),))) ?>
                </div>
                <div class="col-xs-6 col-sm-4">
					<?= $form->textFieldGroup($model, 'vhc_number', array('label' => '', 'widgetOptions' => array())) ?>
                </div>
                <div class="col-xs-6 col-sm-4">
                    <input class="form-control" type="checkbox" id="searchmarkvehicle" name="searchmarkvehicle" <?php
					if ($qry['searchmarkvehicle'] > 0)
					{
				...
				<div class="col-xs-6 col-sm-4">
                    <input class="form-control" type="checkbox" id="searchmarkvehicle" name="searchcngvehicle" <?php
					if ($qry['searchcngvehicle'] > 0)
					{
						echo 'checked="checked"';
					}
					?> >&nbsp; Is CNG
				...
				<div class="col-xs-6 col-sm-4">
                    <input class="form-control" type="checkbox" id="searchIsPartitioned" name="searchIsPartitioned" <?php
					if ($qry['searchIsPartitioned'] > 0)
					{
						echo 'checked="checked"';
					}
					?> >&nbsp; Is Partitioned
			...
			$this->widget('booster.widgets.TbGridView', array(
				...
				'columns'			 => array(
					...
					array('name'	 => 'vhc_number',
						...
						'value'	 => function ($data) {
							echo CHtml::link($data["vhc_number"], Yii::app()->createUrl("admin/vehicle/view", ["id" => $data['vhc_id']]), ["class" => "", "onclick" => "", 'target' => '_blank']) . "<br>";
...
//						},
					...
					array('name'	 => 'docScore',
						'value'	 => function ($data) {
							echo ($data["docScore"] > 0) ? CHtml::link($data["docScore"], Yii::app()->createUrl("admin/vehicle/view", ["id" => $data['vhc_id']]), ["class" => "", "onclick" => "", 'target' => '_blank']) . "<br>" : 'NA';
						},
						'sortable'			 => true,
						'headerHtmlOptions'	 => array(),
...
//						'header'			 => 'Registration Certificate'),
					...
					array(
						...
						'template'			 => '{approvedoc}{edit}{markedbadlist}{resetmarkedbad}<br>{log}{uberapprove}{uberunapprove}{vehicleFreeze}{vehicleUnfreeze}{detail} {updateVehicleDetails}{addremark}',
						'buttons'			 => array(
							'approvedoc'			 => array(
