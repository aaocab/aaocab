                        ...
                        <div class="row">
                            <div class="col-xs-12">
									...
									'clientOptions'			 => array(
										...
										'afterValidate'		 => 'js:function(form,data,hasError){
                                            if(!hasError){
                                                $.ajax({
                                                    "type":"POST",
                                                    "url":"' . CHtml::normalizeUrl(Yii::app()->createUrl('admin/vehicle/rejectvehicledoc', ['vhd_id' => $dmodel->vhd_id, 'vhd_status' => 2])) . '",
                                                    "data":form.serialize(),
                                                    "dataType": "json",
                                ...
                                <div class="form-group">
									<?= $form->textAreaGroup($model, 'vhd_remarks', array('label' => '', 'rows' => 10, 'cols' => 50)) ?>
                                </div>
