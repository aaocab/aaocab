                ...
                <div class="panel-body panel-body panel-no-padding">
                    <div class="panel-scroll">
                        ...
                        if(!hasError){
                            $.ajax({
                            "type":"POST",
                            "url":"' . CHtml::normalizeUrl(Yii::app()->createUrl('admin/vehicle/resetmarkedbad', ['refId' => $refId])) . '",
                            "data":form.serialize(),
							"dataType": "json",
								...
								?>
								<?= $form->hiddenField($vhcModel, 'vhc_mark_car_count') ?>
                                <div class="form-group">
                                    <label for="delete"><b>Add Remark : </b></label>
									<?=
									$form->textAreaGroup($vhcModel, 'vhc_reset_desc', array('label'			 => '',
										'widgetOptions'	 => [
