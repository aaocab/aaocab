								...
								$this->widget('booster.widgets.TbGridView', array(
									...
									'columns'			 => array(
										array('name'	 => 'name', 'filter' => FALSE, 'value'	 => function($data) {
												...
												if ($data['type'] == 'Vendor')
												{
													$modelv = Vendors::model()->findByPk($data['clg_user_ref_id']);
													echo ($modelv->vnd_owner != '') ? $modelv->vnd_owner : $modelv->vnd_name;
												}
                                                                                                if ($data['type'] == 'Driver')
												{
													$modelv = Drivers::model()->findByPk($data['clg_user_ref_id']);
										...
										array('name'	 => 'clg_event_id', 'filter' => FALSE, 'value'	 => function($data) {
												echo VehiclesLog::model()->getEventByEventId($data['clg_event_id']);
