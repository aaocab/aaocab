...
<!--                        <input class = 'btn btn-primary full-width' id="submitnow" name="submit" type="button" value="Submit">-->
				...
				<?php
				$checkExportAccess = Yii::app()->user->checkAccess("exportPickupReport");
				if ($checkExportAccess)
				{
					echo CHtml::beginForm(Yii::app()->createUrl('admin/report/pickup'), "post", ['style' => "margin-bottom: 10px;margin-top: 10px;"]);
					?>
