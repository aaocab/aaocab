				...
				if (!empty($dataProvider))
				{
					$this->widget('booster.widgets.TbGridView', array(
						...
						'columns'			 => array(
							...
							array('name' => 'credited', 'value' => $data["credited"], 'htmlOptions' => array('class' => 'text-right'), 'headerHtmlOptions' => array('class' => 'text-right'), 'header' => 'Credit'),
							array('name' => 'debited', 'value' => $data["debited"], 'htmlOptions' => array('class' => 'text-right'), 'headerHtmlOptions' => array('class' => 'text-right'), 'header' => 'Debit'),
							array('name' => 'balance', 'value' => $data["balance"], 'htmlOptions' => array('class' => 'text-right'), 'headerHtmlOptions' => array('class' => 'text-right'), 'header' => 'Balance'),
					)));
				}
				?>
			</div>
