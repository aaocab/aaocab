            ...
            <div class="panel-body">
				...
				<div class="row" style="margin-top: 10px">  <div class="col-xs-12 col-sm-7 col-md-5">       
                    ...
                    <div class="col-xs-12 col-sm-5 col-md-5">
						<?php
						$checkExportAccess = Yii::app()->user->checkAccess("exportCancelReport");
						if ($checkExportAccess)
						{
							?>

							<?= CHtml::beginForm(Yii::app()->createUrl('admin/report/cancellations'), "post", ['style' => "margin-bottom: 10px;"]); ?>
                            ...
                            <input type="hidden" id="export_bkgtypes" name="export_bkgtypes" value="<?= implode(",", $model->bkgtypes) ?>"/>
