...
//							$dataagents			 = json_encode($edataagents);
					...
					<div class="col-xs-12 col-md-3">
                        <div class="form-group">
							...
							<?php
							$cities = Cities::model()->getAirportList();
							...
							$this->widget('booster.widgets.TbSelect2', array(
								...
								'htmlOptions'	 => array('style' => 'width:100%', 'placeholder' => 'Airport name')
							));
							?>
                        </div> 
                    </div>
					...
					<div class="col-xs-12 col-md-2">
                        <div class="form-group">
							...
							$this->widget('booster.widgets.TbSelect2', array(
								'model'			 => $model,
								'attribute'		 => 'pat_transfer_type',
								'val'			 => $model->pat_transfer_type,
								//'asDropDownList' => FALSE,
...
<?php $this->endWidget(); ?>
			...
			<a class="btn btn-primary mb10" href="<?= Yii::app()->createUrl('admin/rate/addpartnerat') ?>" style="text-decoration: none">Add new</a>
			<?php
            ...
            <div class='panel-footer'><div class='row m0'><div class='col-xs-12 col-sm-6 p5'>{summary}</div><div class='col-xs-12 col-sm-6 pr0'>{pager}</div></div></div>",
					...
					'columns'			 => array(
						...
						array('name' => 'airportName', 'value' => '$data[airportName]', 'sortable' => true, 'headerHtmlOptions' => array(), 'header' => 'Airport '),
						array('name'				 => 'transferType',
							'value'				 => '$data[transferType]',
							'sortable'			 => true, 'headerHtmlOptions'	 => array(), 'header'			 => 'Transfer type'),
						array('name' => 'pat_minimum_km', 'value' => '$data[pat_minimum_km]', 'sortable' => true, 'headerHtmlOptions' => array(), 'header' => 'Minimum km'),
						array('name' => 'pat_extra_per_km_rate', 'value' => '$data[pat_extra_per_km_rate]', 'sortable' => true, 'headerHtmlOptions' => array(), 'header' => 'Extra rate/km'),
						array('name' => 'vehicleType', 'value' => '$data[vehicleType]', 'sortable' => true, 'headerHtmlOptions' => array(), 'header' => 'Cab type'),
						array('name' => 'pat_vendor_amount', 'value' => '$data[pat_vendor_amount]', 'sortable' => true, 'headerHtmlOptions' => array(), 'header' => 'Vendor amount'),
						array('name' => 'pat_total_fare', 'value' => '$data[pat_total_fare]', 'sortable' => true, 'headerHtmlOptions' => array(), 'header' => 'Total fare'),
						array(
						...
						array(
							...
							'buttons'			 => array(
								'edit'			 => array(
									'url'		 => 'Yii::app()->createUrl("admin/rate/addpartnerat", array("patid" => $data[pat_id]))',
								...
								'delete'		 => array(
									...
									'url'		 => 'Yii::app()->createUrl("admin/rate/deletePac", array(\'patid\' => $data[pat_id]))',
								...
								'log'			 => array(
									...
									'url'		 => 'Yii::app()->createUrl("admin/rate/showPatLog", array("patid" => $data["pat_id"]))',
