            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="form-group">
                        <label  class="col-xs-12 col-sm-4 control-label ">Refrence Id : </label>
                    ...
                    <div class="col-xs-12 col-sm-6 ">  
						<?= $form->numberFieldGroup($model, 'adt_amount', array('label' => 'Refund Amount', 'widgetOptions' => array('htmlOptions' => ['class' => 'form-control', 'placeholder' => "Refund Amount", 'min' => 0]))) ?>
                    </div>
                    <div class="col-xs-12 col-sm-6 "> 
