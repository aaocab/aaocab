            ...
            <div class="panel-body">
                <div class="row">
					...
					<div class="col-xs-12 col-sm-6 "> 
						<?= $form->textAreaGroup($model, 'adt_remarks', array('label' => 'Delete Reason', 'widgetOptions' => array('htmlOptions' => ['class' => 'form-control', 'placeholder' => "Enter Delete Reason"]))) ?>
                    </div>
                </div>
            </div>
            <div class="row">
