    ...
    <div class="<?= $panelCss ?>" style="float: none; margin: auto">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="row">
					<?//= "jggjg".$form->errorSummary($model); ?>
					<?php echo CHtml::errorSummary($model); ?>
					<?php
					{
					?>
					<div>Total vendor Coin : <?=$coin?></div>
					
					<div> Adjustable Amount: Rs <?=$coin*10?> </div>
					
					<div> Penalty Amount: Rs <?=$oldAmount?> </div><br></br>
					<?php
					}?>
					
                    <div class="col-xs-12 col-sm-6 ">  
						<?= $form->numberFieldGroup($model, 'adt_amount', array('label' => 'Redeem Amount', 'widgetOptions' => array('htmlOptions' => ['class' => 'form-control', 'placeholder' => "Redeem Amount", 'min' => 0]))) ?>
                    </div>
                     <div class="col-xs-12 col-sm-6 "> 
