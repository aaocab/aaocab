        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="row"> 
					...
					{
						echo '<div class="col-xs-12"><div class="table-responsive panel panel-primary compact" id="packagesList"><div class="panel-heading"><div class="row m0"><div class="col-xs-12 col-sm-6 pt5"></div><div class="col-xs-12 col-sm-6 pr0"></div></div></div><div class="panel-body"><table class="table table-striped table-bordered mb0 table"><thead><tr><th id="boostlist_c0">Vendor</th><th id="packagesList_c1">Car Code(s)</th><th id="packagesList_c2">Mailling address</th><th id="packagesList_c3">Packages Sent</th><th id="packagesList_c4">Packages Received Date</th><th class="col-xs-1 text-center" style="min-width: 100px;" id="packagesList_c5">Action</th></tr></thead><tbody><tr><td colspan="6" class="empty"><span class="empty">No results found.</span></td></tr></tbody></table></div><div class="panel-footer"><div class="row m0"><div class="col-xs-12 col-sm-6 p5"></div><div class="col-xs-12 col-sm-6 pr0"></div></div></div><div class="keys" style="display:none" title="/aaohome/vendor/packagesList"></div></div></div>';
					}
					?> 
                </div> 
