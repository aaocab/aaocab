					...
					<div class="col-xs-12 widget-tab-box3">
						...
						<div class="col-xs-4">
							...
							<p class="font-16"><b>
									...
									{
										$securty_date = ($data["vnd_security_receive_date"]!= " "?DateTimeFormat::DateToDatePicker($data["vnd_security_receive_date"]):"");
										echo '&#x20B9;' . $data['vnd_security_amount'] . ' on ' .$securty_date;
									}
									else
									{
										echo '&#x20B9;0';
