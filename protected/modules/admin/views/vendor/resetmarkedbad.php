                        ...
                        <div class="row">
                            <div class="col-xs-12">
								...
								$form = $this->beginWidget('booster.widgets.TbActiveForm', array(
									'id'					 => 'reset-vendor-form', 'enableClientValidation' => true,
									'clientOptions'			 => array(
										...
										'afterValidate'		 => 'js:function(form,data,hasError){
                                            if(!hasError){
                                                $.ajax({
                                                "type":"POST",
                                                "url":"' . CHtml::normalizeUrl(Yii::app()->createUrl('admin/vendor/resetmarkedbad', ['refId' => $refId])) . '",
                                                "data":form.serialize(),
                                                    "dataType": "json",
                                ...
                                <div class="form-group">
									...
									<?=
									$form->textAreaGroup($agtModel, 'vnd_reset_desc', array('label'			 => '',
										'widgetOptions'	 => [
