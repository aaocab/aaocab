        ...
        <div class="panel-body p0">
            <div class="col-xs-12">
                <div class="row bordered mt10 pt10">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 mb10">
                        <span class="color-gray">Security Amount: </span><br><span class="font-18 line-height20"><b><?= $model->vrs_security_amount; ?></b></span>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-4 mb10">
                ...
                <div class="row bordered mt10">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 pt10 mb10">
                        <span class="color-gray">Locked Amount </span><br><span class="font-18 line-height20"><b><?= $model->vrs_locked_amount; ?></b></span>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-4 pt10 mb10">
                        <span class="color-gray">Withdrawable Balance: </span><br><span class="font-18 line-height20"><b><?= $model->vrs_withdrawable_balance; ?></b></span>
                    </div>
