		...
		'clientOptions'			 => array(
			...
			'afterValidate'		 => 'js:function(form,data,hasError){
                    if(!hasError)
                    {
                        $.ajax({
                            "type":"POST",
                            "url":"' . CHtml::normalizeUrl(Yii::app()->createUrl('admin/vendor/freeze', ['vnd_id' => $model->vnd_id, 'vnp_is_freeze' => $modelpref->vnp_is_freeze])) . '",
                            "data":form.serialize(),
                                "dataType": "json",
            ...
            <div class="panel" >
                <div class="panel-body panel-body p0">
                    ...
                    <div class="panel-scroll1">
                        <div>
							<?= $form->hiddenField($logModel, 'vlg_vnd_id', array('value' => $model->vnd_id)) ?>
