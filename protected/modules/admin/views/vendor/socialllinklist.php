<div class="row">
    ...
    <div class="col-xs-12">
		...
		if (!empty($dataProvider))
		{
			...
			echo '<div class="col-xs-12"><div class="table-responsive panel panel-primary compact" id="contactlist"><div class="panel-heading"><div class="row m0"><div class="col-xs-12 col-sm-6 pt5"></div><div class="col-xs-12 col-sm-6 pr0"></div></div></div><div class="panel-body"><table class="table table-striped table-bordered mb0 table"><thead><tr><th id="contactlist_c0">Vendor Code</th><th id="contactlist_c1">Vendor Name</th><th id="contactlist_c2">Email</th><th id="contactlist_c3">Mobile</th><th id="contactlist_c4">Socail Email</th><th class="col-xs-1 text-center" style="min-width: 100px;" id="contactlist_c5">Action</th></tr></thead><tbody><tr><td colspan="6" class="empty"><span class="empty">No results found.</span></td></tr></tbody></table></div><div class="panel-footer"><div class="row m0"><div class="col-xs-12 col-sm-6 p5"></div><div class="col-xs-12 col-sm-6 pr0"></div></div></div><div class="keys" style="display:none" title="/admpnl/vendor/sociallist"></div></div></div>';	
		}
		?>
    </div>
</div>