		...
		if (!empty($dataProvider))
		{
			...
			$this->widget('booster.widgets.TbGridView', array(
				...
				'columns'			 => array(	
					...
					array('name' => 'vnd_code','value' => function($data) {	echo $data[vnd_code];},'sortable' => false, 'headerHtmlOptions' => array(), 'header' => 'Vendor Code'),
					array('name' => 'vnd_name','value' => function($data) {	echo $data[vnd_name];},'sortable' => false, 'headerHtmlOptions' => array(), 'header' => 'Vendor Name'),
					...
					array('name' => 'profile_cache', 'value' =>function($data) {
						if($_REQUEST['Users']['email']!=NULL  ||  $_REQUEST['Users']['search']!=NULL){
							...
							if($data[cr_is_consumer]!=NULL){
							    $datas=Users::model()->getProfileCacheByUserId($data[cr_is_consumer]);
								if(count($datas)>0){
									$socialemail="";
									$k=1;
					...
					array(
						...
						'buttons'			 => array(
							   'unlink'		 => array(
								'visible'=>'$data[cr_is_consumer]==NULL ? false : true',
							    'click'		 => 'function(e){
							...
							'url'		 => 'Yii::app()->createUrl("admin/vendor/unlinksocialaccount", array(\'vnd_id\' => $data[vnd_id],\'profile\'=>$data[provider],\'identifier\'=>$data[identifier]))',
			...
			echo '<div class="col-xs-12"><div class="table-responsive panel panel-primary compact" id="contactlist"><div class="panel-heading"><div class="row m0"><div class="col-xs-12 col-sm-6 pt5"></div><div class="col-xs-12 col-sm-6 pr0"></div></div></div><div class="panel-body"><table class="table table-striped table-bordered mb0 table"><thead><tr><th id="contactlist_c0">Vendor Code</th><th id="contactlist_c1">Vendor Name</th><th id="contactlist_c2">Email</th><th id="contactlist_c3">Mobile</th><th id="contactlist_c4">Socail Email</th><th class="col-xs-1 text-center" style="min-width: 100px;" id="contactlist_c5">Action</th></tr></thead><tbody><tr><td colspan="6" class="empty"><span class="empty">No results found.</span></td></tr></tbody></table></div><div class="panel-footer"><div class="row m0"><div class="col-xs-12 col-sm-6 p5"></div><div class="col-xs-12 col-sm-6 pr0"></div></div></div><div class="keys" style="display:none" title="/aaohome/vendor/sociallist"></div></div></div>';	
		}
		?>
    </div>
</div>