...
<div class="row" id="louList">
    ...
    <div class="col-xs-12">
		...
		{
			echo '<div class="col-xs-12"><div class="table-responsive panel panel-primary compact" id="loulist"><div class="panel-heading"><div class="row m0"><div class="col-xs-12 col-sm-6 pt5"></div><div class="col-xs-12 col-sm-6 pr0"></div></div></div><div class="panel-body"><table class="table table-striped table-bordered mb0 table"><thead><tr><th id="loulist_c0">Vendor Code</th><th id="loulist_c1">Vendor Name</th><th id="loulist_c2">Email</th><th id="loulist_c3">Mobile</th><th id="loulist_c4">Lou Approved By</th><th class="col-xs-1 text-center" style="min-width: 100px;" id="loulist_c5">Action</th></tr></thead><tbody><tr><td colspan="6" class="empty"><span class="empty">No results found.</span></td></tr></tbody></table></div><div class="panel-footer"><div class="row m0"><div class="col-xs-12 col-sm-6 p5"></div><div class="col-xs-12 col-sm-6 pr0"></div></div></div><div class="keys" style="display:none" title="/admpnl/vendor/loulist"></div></div></div>';
		}
		?>
    </div>
</div>
