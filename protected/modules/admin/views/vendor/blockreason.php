...
<div class="panel-advancedoptions " >
                ...
                <div class="panel-body panel-body p0">
                    <div class="panel-scroll1">
						<? if ($model->vnd_active == 1)
						{
							?>
							<div>
								<?= CHtml::beginForm(Yii::app()->createUrl('admin/vendor/block'), "post", ['accept-charset' => "UTF-8", 'id' => "blockForm", 'onsubmit' => 'return submitDelForm(this);', 'class' => "form", 'data-replace' => ".error-message p"]); ?>
	...
	<?= CHtml::textArea('vnd_reason', '', ['id' => "vndreasontext", 'class' => "form-control", 'placeholder' => 'Enter reason to block ' . $model->vnd_name]) ?>
									</div>
								</div>
								<div class="col-xs-12 mt10" id="reasontext" >
	<?= CHtml::checkBoxList('chkopt', '', ['1' => 'Inform Vendor'], []); ?>
						...
						else
						{
							?>
							<div class="col-xs-12">
								<span class="has-error text-danger" id = 'vnderror' > Vendor is already blocked</span>
							</div>
<? }
?>
                    </div>
