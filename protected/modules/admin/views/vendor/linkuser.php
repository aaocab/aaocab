...
<div class="panel">
    <div class="panel panel-body">
        <div class="col-xs-6"><b>Vendor Code :</b> <?= $agentModel->vnd_code;?></div>
        <div class="col-xs-6"><b>Name : </b><?= $agentModel->vnd_name; ?></div>
	
		<?php 
			$isDco = ($agentModel->vnd_is_dco) ? "Yes" :  "No";
		?>
		<div class="col-xs-6"><b>Is DCO : </b><?= $isDco ?></div>
    </div>
</div>

<div class="panel">
    <div class="panel panel-heading"><div class="col-sm-12">Linked Users <button class="btn btn-success pull-right" type="button" name="linkuser" onclick="linkUser(<?= $agentModel->vnd_id ?>);"><i class="fa fa-link"></i> Link user</button></div></div>
    <div class="panel panel-body">
		<div class="col-xs-12"> 
			<?
						...
						array(
							...
							'buttons'			 => array(
								'unlink'		 => array(
									...
									'url'		 => 'Yii::app()->createUrl("admin/agent/linkuser", array(\'user_id\' => $data[\'user_id\'],\'agt_id\'=>' . $agentModel->vnd_id . '))',
