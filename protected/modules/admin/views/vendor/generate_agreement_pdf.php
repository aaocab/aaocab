...
<div class="main-div">
	...
	<ol type="A" class="list_type">
		<li><b>aaocab</b> or <b>Gozo</b> is a technology Company that makes available a marketplace platform for matchmaking "consumers" seeking travel services from and to various destinations across India with "Operators" who can provide such travel and transportation services;</li>
	...
	<ol type="A" class="list_type">
		...
		<li>aaocab represents that it regularly enters into agreements with various third-parties including but not limited to other marketplace platforms, corporate clients, travel agencies, individuals or organizations to receive leads of consumers seeking Travel Services. Said leads are assigned to Operators that interact with the Gozo platform.</li>
	</ol>
	...
	<ol type="A" class="list_type">
		...
		<li><b>Unauthorized use of Operator Account:</b> If the Operator learns of any unauthorised use of its credentials for accessing the Platform, it must notify the Company immediately by email at vendor@aaocab.in or by phone at the Company's operator relations phone number.</li>
	...
	<ol type="A" class="list_type">
		...
		<li>All accounts and billing related communications to the Company must be sent via email to <a href="mailto:accounts@aaocab.in">accounts@aaocab.in</a></li>
	...
	<ol type="A" class="list_type">
		...
		<li>If there is any inconsistency between these terms and any updated or modified terms as listed on aaocab website, the updated terms listed on aaocab website will prevail to the extent of the inconsistency.</li>
			...
			<table width='100%'>
				<tr>
					<td width="70%">
						...
						<p>Email ID: operator@aaocab.in <br>With a copy to: legal@aaocab.com</p>
					</td>
					<td>
						<p>To the Vendor,</p>
