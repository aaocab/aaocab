    ...
    <div class="col-xs-12">
		...
		if (!empty($dataProvider))
		{
			$this->widget('booster.widgets.TbGridView', array(
				...
				array('name' => 'vendorCollected', 'value' => '$data["vendorCollected"]', 'sortable' => true, 'headerHtmlOptions' => array(), 'header' => 'Vendor Collected'),
				array('name' => 'debited', 'value' => '$data["debited"]', 'sortable' => true, 'headerHtmlOptions' => array(), 'header' => 'debited'),
				array('name' => 'DebitIds', 'value' => '$data["DebitIds"]', 'sortable' => true, 'headerHtmlOptions' => array(), 'header' => 'DebitIds'),
				array('name' => 'tripType', 'value' => '$data["tripType"]', 'sortable' => true, 'headerHtmlOptions' => array(), 'header' => 'tripType'),
