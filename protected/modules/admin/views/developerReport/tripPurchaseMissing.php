			...
			<div class="col-xs-12">
				...
				if (!empty($dataProvider))
				{
					$this->widget('booster.widgets.TbGridView', array(
						...
						'columns'			 => array(
							array('name' => 'bkg_id', 'value' => $data['bkg_id'], 'headerHtmlOptions' => array('class' => 'col-xs-1'), 'header' => 'Booking Ids'),
							...
							array('name' => 'bcb_pending_status', 'value' => '$data["bcb_pending_status"]', 'headerHtmlOptions' => array(), 'header' => 'Booking Pending Status'),
