				...
				if (!empty($dataProvider))
				{
					$this->widget('booster.widgets.TbGridView', array(
						...
						'columns'			 => array(
							...
							array('name' => 'partnerCommAmt', 'value' => '$data["partnerCommAmt"]', 'headerHtmlOptions' => array(), 'header' => 'Commission Amount'),
							array('name' => 'act_ids', 'value' => '$data["act_ids"]', 'headerHtmlOptions' => array(), 'header' => 'Act Ids'),
					)));
				}
				?>
			</div>
