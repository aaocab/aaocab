				...
				if (!empty($dataProvider))
				{
					$this->widget('booster.widgets.TbGridView', array(
						...
						'columns'			 => array(
							...
							array('name' => 'bcb_id', 'value' => '$data["bcb_id"]', 'headerHtmlOptions' => array(), 'header' => 'Bcb Id'),
							...
							array('name' => 'bkg_vendor_collected', 'value' => '$data["bkg_vendor_collected"]', 'headerHtmlOptions' => array(), 'header' => 'Vendor To Collect'),
							array('name' => 'tripPurchaseAmt', 'value' => '$data["tripPurchaseAmt"]', 'headerHtmlOptions' => array(), 'header' => 'Trip Purchase Amt'),
							array('name' => 'DebitIds', 'value' => '$data["DebitIds"]', 'headerHtmlOptions' => array(), 'header' => 'Debit Ids'),
