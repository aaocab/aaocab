				...
				<div class="panel-body">
					<div class="row mb15">
						...
						<div class="col-xs-12 col-md-6" id="fromArea">
							...
							<div id="get_area2" style="display:none;">
								<?php
										$this->widget('ext.yii-selectize.YiiSelectize', array(
											'model'				 => $model,
											'attribute'			 => 'dnt_area_id',
											'useWithBootstrap'	 => true,
											"placeholder"		 => "Select One or More Area(s)",
											'fullWidth'			 => false,
											'htmlOptions'		 => array('width'	 => '100%',
												'id'	 => 'DestinationNote_dnt_area_id2',
												'name'   => 'DestinationNote[dnt_area_id2][]'
											),
											'defaultOptions'	 => $selectizeOptions + array(
										'onInitialize'	 => "js:function(){
                                            populateSource(this, '{$model->dnt_area_id}');
                                                }",
							...
							<div class="col-xs-12">
								<label>Notes *</label>
								<?= $form->textAreaGroup($model, 'dnt_note', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => 'Note', 'id'=>'Note', 'style' => 'height:100px;')))) ?>
							</div>
                                    </div>
                                    <div class="row mb15">
							<div class="col-xs-12">
                                    ...
                                    <?php $datefrom	 = $model->dnt_valid_from_date != '' ? $model->dnt_valid_from_date : date('Y-m-d H:i:s');?>
									<?= $form->datePickerGroup($model, 'dnt_valid_from_date', array('label' => 'Valid From Date', 
								...
								<div class="col-xs-12 col-sm-6">
									<?php
										if ($model->dnt_valid_from_time != '')
										{
											$ptime = date('h:i A', strtotime($model->dnt_valid_from_time));
										}
										else
										{
										...
										?>
									<?=
									$form->timePickerGroup($model, 'dnt_valid_from_time', array('label'			 => 'Valid From Time',
							...
							<div class="col-xs-12">
                                                            <div class="row">
								<div class="col-xs-12 col-sm-6">
									 <?php $dateto	 = $model->dnt_valid_to_date != '' ? $model->dnt_valid_to_date : date('Y-m-d H:i:s');?>
									<?= $form->datePickerGroup($model, 'dnt_valid_to_date', array('label' => 'Valid To Date', 
								...
								<div class="col-xs-12 col-sm-6">
									<?php
										if ($model->dnt_valid_to_time != '')
										{
											$ptime = date('h:i A', strtotime($model->dnt_valid_to_time));
										}
										else 
										{
											$ptime =date('h:i A', strtotime(now));
										...
										?>
									<?=
									$form->timePickerGroup($model, 'dnt_valid_to_time', array('label'=> 'Valid To Time',
