    ...
    <div class="col-xs-12">
		...
		if (!empty($dataProvider))
		{
			...
			$this->widget('booster.widgets.TbGridView', array(
				...
				'columns'			 => array(
					array(
						'visible'		 => Yii::app()->request->getParam("drv_id") == null ? false : true,
					...
					array('name'	 => 'Driver Code',
						'filter' => false,
						'value'	 => function($data) {
							echo $data[drv_code];
						},
						'sortable'			 => true, 'headerHtmlOptions'	 => array(), 'header'			 => 'Driver Code'),
					array('name'	 => 'Driver Name',
						...
						'sortable'			 => true, 'headerHtmlOptions'	 => array(), 'header'			 => 'Driver Name'),
					array('name'	 => 'phone',
						'filter' => false,
						'value'	 => function($data) {
					...
					array(
						...
						'buttons'			 => array(
							'merge' => array(
								...
								'url'		 => 'Yii::app()->createUrl("admin/driver/mergeduplicatedriver", array(\'ctt_id\' => $data[ctt_id],\'phone_no\' => $data[phn_phone_no],\'ctt_aadhaar_no\' => $data[ctt_aadhaar_no],\'ctt_pan_no\' => $data[ctt_pan_no],\'ctt_voter_no\' => $data[ctt_voter_no],\'ctt_license_no\' => $data[ctt_license_no],\'email_address\' => $data[eml_email_address],\'drv_id\' => $data[drv_id]))',
...
<script type="text/javascript">
    ...
    function mergeProcess() {
        ...
        if (numrows < 1)
        {
            ...
            window.location.href = '<?php echo Yii::app()->createUrl('admin/driver/mergedriver'); ?>?drvid=' +<?= $drv_id ?> + '&mdrvid=' + $strDrvKeys;
        }
    }
</script>
