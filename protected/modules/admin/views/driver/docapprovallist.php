...
<div id="list-content">
    <div class="row" >
        <div class="panel">
            <div class="panel-heading">Pending Driver document to approve</div>
					    ...
					    <div class="col-xs-6 col-sm-3">
								...
								<?php
									...
									'onInitialize'	 => "js:function(){
																  populateDriver(this, '{$model->drv_id}');
											}",
								...
								?>
                                <span class="has-error"><? echo $form->error($model, 'drv_id'); ?></span>
                            </div>
						<div class="col-xs-6 col-sm-3">
...
<script type="text/javascript">
	function openpic(pid,docid,dnam,doctype,sidetype) {
		 $.ajax({
            ...
            "data": {"ctt_id": pid,"docid":docid,'doctype':doctype,'sidetype':sidetype,'page':'driver'},
