...
'NoNeedProcess'		 => array(
		...
		{
				echo '<div class="col-xs-12"><div class="table-responsive panel panel-primary compact" id="synctlist"><div class="panel-heading"><div class="row m0"><div class="col-xs-12 col-sm-6 pt5"></div><div class="col-xs-12 col-sm-6 pr0"></div></div></div><div class="panel-body"><table class="table table-striped table-bordered mb0 table"><thead><tr><th id="synclist_c0">Driver Name</th><th id=synclist_c1">Booking Id</th><th id="synclist_c2">Hit Time</th><th id="synclist_c3">Event</th><th id="synclist_c4">Token</th><th class="col-xs-1 text-center" style="min-width: 100px;" id="synclist_c5">Data</th></tr></thead><tbody><tr><td colspan="6" class="empty"><span class="empty">No results found.</span></td></tr></tbody></table></div><div class="panel-footer"><div class="row m0"><div class="col-xs-12 col-sm-6 p5"></div><div class="col-xs-12 col-sm-6 pr0"></div></div></div><div class="keys" style="display:none" title="/aaohome/driver/syncFail"></div></div></div>';
		}
?>	
                </div> 
            </div>  
