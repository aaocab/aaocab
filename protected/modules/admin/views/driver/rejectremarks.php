                        ...
                        <div class="row">
                            <div class="col-xs-12">
									...
									'clientOptions'			 => array(
										...
										'afterValidate'		 => 'js:function(form,data,hasError){
                                            if(!hasError){
                                                $.ajax({
                                                    "type":"POST",
                                                    "url":"' . CHtml::normalizeUrl(Yii::app()->createUrl('admin/driver/rejectdriverdoc', ['drd_id' => $dmodel->drd_id, 'drd_status' => 2])) . '",
                                                    "data":form.serialize(),
                                                    "dataType": "json",
                                ...
                                <div class="form-group">
									<?= $form->textAreaGroup($model, 'drd_remarks', array('label' => '', 'rows' => 10, 'cols' => 50)) ?>
                                </div>
