                ...
                <div class="panel-body panel-body panel-no-padding">
                    <div class="panel-scroll">
                        ...
                        if(!hasError){
                            $.ajax({
                            "type":"POST",
                            "url":"' . CHtml::normalizeUrl(Yii::app()->createUrl('admin/booking/upsellremarks', ['booking_id' => $bookModel->bkg_id, 'upsell_status' => $upsell_status])) . '",
                            "data":form.serialize(),
							"dataType": "json",
                                ...
                                <input type="hidden" id="upsell" name="upsell" value="<?= $upsell ?>"/>
