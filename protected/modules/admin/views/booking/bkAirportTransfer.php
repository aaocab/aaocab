...
<div class="col-sm-6 ">
	<div class="form-group cityinput">
		<label class="control-label" for="exampleInputName6">Airport</label>
		<?php
		...
		'onInitialize'	 => "js:function(){
											booking.populateAirportList(this, '{$model->bkgAirport}');
										}",
		'load'			 => "js:function(query, callback){
											booking.loadAirportSource(query, callback);
										}",
		...
		<input id="isAirport0" name="BookingRoute[0][brt_from_city_is_airport]" type="hidden"  value="">
...
<div class="col-sm-6">
	<div class="form-group cityinput">
		...
		<input id="isAirport1" name="BookingRoute[1][brt_to_city_is_airport]" type="hidden"  value="">
