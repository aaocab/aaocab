...
$date		 = $model->bkgTrail->bkg_followup_date;
?>
                            ...
                            <div class="col-xs-12">
								...
								$form		 = $this->beginWidget('booster.widgets.TbActiveForm', array(
									...
									'clientOptions'			 => array(
                                        ...
                                        if(!hasError){
                                                $.ajax({
                                                "type":"POST",
                                                "url":"' . CHtml::normalizeUrl(Yii::app()->createUrl('admin/booking/completefollowup', ['booking_id' => $model->bkg_id])) . '",
                                                "data":form.serialize(),
                                                    "dataType": "json",
                                ...
                                <div id="changeFollowupBox"  class="row" style="display:none;">
                                    <div class="col-xs-12">
                                        <div class="form-group">
											...
											<?=
											$form->datePickerGroup($model->bkgTrail, 'bkg_followup_date', array('label'			 => '',
                                        ...
                                        <div class="form-group">
											...
											<?=
											$form->timePickerGroup($model->bkgTrail, 'bkg_followup_time', array('label'			 => '',
												'widgetOptions'	 => array('id'			 => CHtml::activeId($model->bkgTrail, "bkg_followup_time"),
                                        ...
                                        <div class="form-group">
											...
											<?= $form->textAreaGroup($model->bkgTrail, 'bkg_followup_comment', array('label' => '', 'rows' => 10, 'cols' => 50, 'placeholder' => 'Add Comment')) ?>
                                        </div>
                                ...
                                <div id="completeFollowupBox" class="row" style="display:none;">
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            <label for="delete"><b>Followup Date : </b></label>
											<?= date('d/m/Y h:i A', strtotime($model->bkgTrail->bkg_followup_date)); ?>
                                        </div>
                                        <div class="form-group">
                                            <label for="delete"><b>Followup Time : </b></label>
											<?= date('h:i A', strtotime($model->bkgTrail->bkg_followup_date)); ?>
                                        </div>
                                        <div class="form-group">
                                            <label for="delete"><b>Comment : </b></label>
								...
								<?= $form->hiddenField($model->bkgTrail, 'bkg_followup_active') ?>
								<?php $this->endWidget(); ?>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function openFollowupBox(type)
    {
        ...
        if (type == 1)
        {
            $("#changeFollowupBox").show();
            $("#completeFollowupBox").hide();
            $('#BookingTrail_bkg_followup_active').val('1');
        } else
        {
            $("#changeFollowupBox").hide();
            $("#completeFollowupBox").show();
            $('#BookingTrail_bkg_followup_active').val('0');
        }
    }
</script>
