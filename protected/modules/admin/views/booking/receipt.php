...
<?php
$returnType = "allDetail";
$cartype = SvcClassVhcCat::getVctSvcList($returnType);
	...
	<div class="container">
		<div class="row mt20">
				...
				<table style="width:100%" class="table-responsive">
					<tr style=" background-color: #fff;">
						<td style="border: 0">
							...
							<b>Name: </b><b><?= ucfirst($invoiceList['bkg_user_fname']) . ' ' . ucfirst($invoiceList['bkg_user_lname']); ?></b>
							<?php
							...
							<div class="col-xs-12 table-responsive">
								<table class="table table-bordered  " >
									...
									<tr>
										...
										<td style="border-width: 0"><?= $cartype[$type]["label"] //. ' (' . $invoiceList['make'] . '-' . $invoiceList['model'] . ')';                    ?></td>
									</tr>
								</table>
							</div>
						</div>
							...
							<div class="col-xs-12 table-responsive">
								<table class="table table-bordered " width="100%">
									...
									if ($invoiceList['bkg_addon_charges'] > 0)
									{
										?>
									<tr>
										<td class="text-right" style="border-width: 0">Addon Charge</td> 
									...
									if ($invoiceList['bkg_airport_entry_fee'] > 0)
									{
										?>
										<tr>
											<td class="text-right" style="border-width: 0">Airport Entry Fee</td>
											<td class="text-right" style="border-width: 0"><i class="fa fa-inr"></i> <?php echo number_format($invoiceList['bkg_airport_entry_fee']) ?></td>
										</tr>
										<?php
									}
									?>
									...
									<?php } ?>
									<?php
									if ($invoiceList['bkg_extra_km_charge'] > 0)
									{
										?>
										<tr>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <hr>
                    <p style="font-size: 11px; text-align: center; margin-bottom: 2px;line-height: 1.8em"><b>Corporate Office:</b> <?= $address ?></p>
