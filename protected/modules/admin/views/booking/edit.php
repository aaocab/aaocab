                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group ">
										...
										<?php
										if ($model->bkg_booking_type == 2 || $model->bkg_booking_type == 3 || $model->bkg_booking_type == 5)
										{
...
//										));
										?>
										<div class="form-control"><?= $model->bkgFromCity->cty_name . '-' . $model->bkgToCity->cty_name ?></div>
                                    </div>
                                </div>
                            </div>
                            <!-- multicity-->
                            ...
                            <div class="row">
                                <div class="col-xs-12"  id='tripTablecreate' style="display: <?= ($model->bkg_booking_type == 2 || $model->bkg_booking_type == 3 || $model->bkg_booking_type == 5) ? 'block' : 'none' ?>">
									<?
									if (count($bookingRouteModel) > 0 && ($model->bkg_booking_type == 2 || $model->bkg_booking_type == 3 || $model->bkg_booking_type == 5))
									{
										?>
                            ...
                            <div class="row" id="ctyinfo_bkg_type_1" style="display: <? echo ($model->bkg_booking_type == 1 || $model->bkg_booking_type == 4 ) ? '' : 'none' ?>">
                                <div class="col-sm-6">
                                    <div class="form-group">
										...
										<div class="form-control"><?= $model->bkgFromCity->cty_name ?></div>
...
//										));
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<div class="form-control"><?= $model->bkgToCity->cty_name ?></div>
										<?php
//										$this->widget('booster.widgets.TbSelect2', array(
//											'model'			 => $model,
							...
							<div class="row"  id="pickup_div" style="display:  <?= ($model->bkg_booking_type == 1 || $model->bkg_booking_type == 4) ? 'block' : 'none' ?>">
								<div class="col-sm-6">
									...
									$form->datePickerGroup($model, 'bkg_pickup_date_date', array('label'			 => 'Pickup Date',
										'widgetOptions'	 => array('options' => array('autoclose' => true, 'startDate' => date(), 'format' => 'dd/mm/yyyy'), 'htmlOptions' => array('placeholder' => 'Pickup Date', 'value' => DateTimeFormat::DateTimeToDatePicker($model->bkg_pickup_date), 'class' => 'input-group border-gray full-width', 'disabled' => 'disabled')), 'prepend'		 => '<i class="fa fa-calendar"></i>'));
									?>
								...
								<div class="col-sm-6">
									...
									$form->timePickerGroup($model, 'bkg_pickup_date_time', array('label'			 => 'Pickup Time',
										'widgetOptions'	 => array('id' => CHtml::activeId($model, "bkg_pickup_date_time"), 'options' => array('autoclose' => true), 'htmlOptions' => array('placeholder' => 'Pickup Time', 'value' => date('h:i A', strtotime($model->bkg_pickup_date)), 'class' => 'input-group border-gray full-width', 'disabled' => 'disabled'))));
									?>
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										$this->widget('booster.widgets.TbSelect2', array(
											...
											'data'			 => $vehicleList,
											'htmlOptions'	 => array("width" => "100%", "style" => "width:100%;padding:8px;", 'class' => 'selectReadOnly', 'placeholder' => 'Select Car Type')
										));
										?>
					...
					<div class="panel panel-default panel-border">
						...
						<div class="panel-body pt0">
							<div class="row">
								...
								<?= $form->hiddenField($model->bkgTrack, 'bkg_garage_time'); ?>
								...
								<?
								$toll_checked	 = ($model->bkgInvoice->bkg_is_toll_tax_included == 1) ? 'checked="checked" ' : "";
								$state_checked	 = ($model->bkgInvoice->bkg_is_state_tax_included == 1) ? 'checked="checked"  ' : "";
								?>
							...
							<div class="row">
								<div class="col-sm-6" >
									<?= $form->textFieldGroup($model->bkgInvoice, 'bkg_rate_per_km_extra', array('widgetOptions' => array('htmlOptions' => ['class' => 'clsReadOnly']))) ?>                                    
								</div>
								...
								<div class="col-sm-6">
									<?= $form->textFieldGroup($model->bkgInvoice, 'bkg_base_amount', array('label' => 'Amount', 'widgetOptions' => array('htmlOptions' => ['class' => 'clsReadOnly', 'placeholder' => 'Net Charge']))) ?>
							...
							<div class="row">
								<div class="col-sm-6">
									<?= $form->textFieldGroup($model->bkgInvoice, 'bkg_additional_charge_remark', array('widgetOptions' => array('htmlOptions' => ['class' => 'clsReadOnly']))) ?>
								</div>
								<div class="col-sm-6">
									<?= $form->textFieldGroup($model->bkgInvoice, 'bkg_additional_charge', array('widgetOptions' => array('htmlOptions' => ['class' => 'clsReadOnly']))) ?>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6">
									...
									?>
									<?= $form->textFieldGroup($model->bkgInvoice, 'bkg_promo1_code', array('label' => 'Promo Code', 'widgetOptions' => array('htmlOptions' => ['class' => 'clsReadOnly', 'placeholder' => 'Promo Code'] + $agentDisable))) ?>
								</div>
								<div class="col-sm-6">

									<?= $form->textFieldGroup($model->bkgInvoice, 'bkg_discount_amount', array('label' => 'Discount', 'widgetOptions' => array('htmlOptions' => ['readonly' => 'readonly', 'placeholder' => 'Discount']))) ?>
								</div>
							</div>
							<?
							if ($model->bkgInvoice->bkg_corporate_discount > 0)
							{
								?>
								<div class="row">
									<div class="col-sm-offset-6 col-sm-6">
										<?= $form->textFieldGroup($model->bkgInvoice, 'bkg_corporate_discount', array('label' => 'Corporate Discount', 'widgetOptions' => array('htmlOptions' => ['readonly' => 'readonly', 'placeholder' => 'Corporate Discount']))) ?>
									</div>
								</div>
							<? } ?>
							<div class="row">
								<div class="col-sm-6">
									<?= $form->textFieldGroup($model->bkgInvoice, 'bkg_vendor_amount', array('widgetOptions' => array('htmlOptions' => ['class' => 'clsReadOnly']))) ?>
									<input type="hidden" name="rtevndamt" id="rtevndamt"> 
									<?= $form->hiddenField($model->bkgInvoice, 'bkg_quoted_vendor_amount'); ?>
								</div>
								<div class="col-sm-6">
									<?= $form->numberFieldGroup($model->bkgInvoice, 'bkg_driver_allowance_amount', array('label' => 'Driver Allowance', 'widgetOptions' => array('htmlOptions' => ['class' => 'clsReadOnly', 'placeholder' => 'Driver allowance', 'oldamount' => 0]))); ?>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6"></div>
								<div class="col-sm-6">
									<?= $form->textFieldGroup($model->bkgInvoice, 'bkg_toll_tax', array('label' => 'Toll Tax', 'widgetOptions' => array('htmlOptions' => array('readonly' => 'readonly', 'plceholder' => 'Toll Tax')))) ?>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6"></div>
								<div class="col-sm-6">
									<?= $form->textFieldGroup($model->bkgInvoice, 'bkg_state_tax', array('label' => 'State Tax', 'widgetOptions' => array('htmlOptions' => array('readonly' => 'readonly', 'plceholder' => 'State Tax')))) ?>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-sm-6">
									...
									?>
									<? $model->bkgInvoice->bkg_service_tax_rate = $model->bkgInvoice->getServiceTaxRate(); ?>
									<?= $form->hiddenField($model->bkgInvoice, 'bkg_service_tax_rate'); ?>
									<?= $form->textFieldGroup($model->bkgInvoice, 'bkg_service_tax', array('label' => "$taxLabel    (rate: " . $model->bkgInvoice->getServiceTaxRate() . '%)', 'widgetOptions' => array('htmlOptions' => array('readonly' => 'readonly')))) ?>
								</div>
							</div>
							<?
							$model11								 = clone $model;
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input readonly="readonly" class="form-control" name="amountwithoutcod" id="amountwithoutcod" type="text" value="<?= $model11->bkgInvoice->bkg_total_amount ?>">
									</div> 
								</div>
								<div class="col-sm-6">
									<?= $form->textFieldGroup($model->bkgInvoice, 'bkg_total_amount', array('label' => 'Total Chargeable ' . $model->getAttributeLabel('bkg_total_amount'), 'widgetOptions' => array('htmlOptions' => array('readonly' => 'readonly')))) ?>
								</div>
							</div>
							<?
							if ($model->bkgInvoice->bkg_corporate_credit > 0)
							{
								...
								<div class="row">
									<div class="col-lg-offset-6 col-sm-6">
										<?= $form->textFieldGroup($model->bkgInvoice, 'bkg_corporate_credit', array('label' => 'Corporate Credits Used', 'widgetOptions' => array('htmlOptions' => array('readonly' => 'readonly')))) ?>
									</div>
								</div>
							<? } ?>
							<div class="row">
								...
								if ($model->bkgInvoice->bkg_advance_amount > 0)
								{
									?>
									<div class="col-sm-6">
										<?= $form->textFieldGroup($model->bkgInvoice, 'bkg_advance_amount', array('label' => 'Advance Paid by User', 'widgetOptions' => array('htmlOptions' => array('readonly' => 'readonly', 'value' => round($model->bkgInvoice->bkg_advance_amount))))) ?>
									</div>
								<? } ?>
								<?
								if ($model->bkgInvoice->bkg_credits_used != '' && $model->bkgInvoice->bkg_credits_used > 0)
								{
									?>
									<div class="col-sm-6">
										<?= $form->textFieldGroup($model->bkgInvoice, 'bkg_credits_used', array('label' => 'Gozo Coins Applied', 'widgetOptions' => array('htmlOptions' => ['placeholder' => 'Gozo Coins Applied', 'readOnly' => true]))) ?>

									</div>
								<? } ?>
								<?
								if (($model->bkgInvoice->bkg_credits_used != '' && $model->bkgInvoice->bkg_credits_used > 0) || $model->bkgInvoice->bkg_advance_amount > 0 || $model->bkgInvoice->bkg_corporate_credit > 0)
								{
									$dispdue = 'block';
								}
								else
								...
								<div class="col-sm-6" id="duediv" style="display: <?= $dispdue ?>">
									<?= $form->textFieldGroup($model->bkgInvoice, 'bkg_due_amount', array('widgetOptions' => array('htmlOptions' => array('readonly' => 'readonly', 'value' => round($model->bkgInvoice->bkg_due_amount))))) ?>
								</div>
							...
							<?
							if ($model != '' && $model->bkgUserInfo->bkg_user_id != '')
							{
								$creditVal	 = UserCredits::getApplicableCredits($model->bkgUserInfo->bkg_user_id, $model->bkgInvoice->bkg_base_amount, true, $model->bkg_from_city_id, $model->bkg_to_city_id);
								...
								<div class="row">
									...
									<div class="col-xs-8">
										<label class="checkbox-inline ">
											<div class="form-control"><?= ($model->bkgInvoice->bkg_corporate_remunerator == 2) ? "Company/Partner" : "Customer" ?></div>                                    </label>
									</div>
								</div> 
							<? } ?>
							<div class="row">
...
//                                        ));
							...
							<div class="row ">
								<!--                                <div class="col-xs-12 special_request">
																	<h2 class="mb10">Partner Preferences</h2>
																	<div class="col-xs-12">
								<p<<label>Use of Driver app is required</label> <?= ($model->bkgPref->bkg_driver_app_required == 1) ? '&nbsp;&nbsp;<b>Yes<b>' : '&nbsp;&nbsp;<b>No</b>'; ?></p>
								<p><label>OTP is required from customer</label> <?= ($model->bkgPref->bkg_trip_otp_required == 1) ? '&nbsp;&nbsp;<b>Yes<b>' : '&nbsp;&nbsp;<b>No</b>'; ?></p>
								<p><label>All receipts & duty slips required</label> <?= ($model->bkgPref->bkg_duty_slip_required == 1) ? '&nbsp;&nbsp;<b>Yes<b>' : '&nbsp;&nbsp;<b>No</b>'; ?><p>
								<p><label>2x 500ml water bottles required</label> <?= ($model->bkgPref->bkg_water_bottles_required == 1) ? '&nbsp;&nbsp;<b>Yes<b>' : '&nbsp;&nbsp;<b>No</b>'; ?></p>
								<p><label>Do not ask customer for cash</label> <?= ($model->bkgPref->bkg_is_cash_required == 1) ? '&nbsp;&nbsp;<b>Yes<b>' : '&nbsp;&nbsp;<b>No</b>'; ?></p>
								<?php
								if ($model->bkgPref->bkg_pref_req_other != '')
								{
									?>
													<p><label>Other</label> <?= ($model->bkgPref->bkg_pref_req_other != '') ? '&nbsp;&nbsp;<b>' . $model->bkgPref->bkg_pref_req_other . '</b>' : ''; ?></p>
								<?php } ?>
																	</div> 
																</div>-->
							</div>
							...
							<div class="row ">
								<div class="col-xs-12 special_request">
									...
									<div class="col-xs-12">
										...
										<?= $form->dropDownListGroup($model->bkgAddInfo, 'bkg_spl_req_lunch_break_time', ['label' => '', 'widgetOptions' => ['data' => ['0' => 'Minutes', '30' => '30', '60' => '60', '90' => '90', '120' => '120', '150' => '150', '180' => '180'], 'htmlOptions' => ['readonly' => 'readonly']]]) ?>
									</div> 
								</div>
							</div>
						</div>
...
//			}
						?>						
						<h3 class="pl15">Billing Details</h3>
						<div class="panel-body pt0">
							<div class="row">
								<div class="col-sm-6">
									<?= $form->textFieldGroup($model->bkgUserInfo, 'bkg_bill_fullname', array('label' => 'Full Name', 'widgetOptions' => array('htmlOptions' => array('class' => 'nameFilterMask')))) ?>
								</div>
								<div class="col-sm-6">
									<?= $form->textFieldGroup($model->bkgUserInfo, 'bkg_bill_contact', array('label' => 'Contact Number', 'widgetOptions' => array('htmlOptions' => array('class' => 'nameFilterMask')))) ?>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6">
									<?= $form->emailFieldGroup($model->bkgUserInfo, 'bkg_bill_email', array('label' => 'Email Address', 'widgetOptions' => array('htmlOptions' => array('class' => 'nameFilterMask')))) ?>

								</div>
								<div class="col-sm-6">
									<?= $form->textAreaGroup($model->bkgUserInfo, 'bkg_bill_address', array('label' => 'Address', 'widgetOptions' => array('htmlOptions' => array()))) ?>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6">
									<?= $form->textFieldGroup($model->bkgUserInfo, 'bkg_bill_postalcode', array('label' => 'Postal Code', 'widgetOptions' => array('htmlOptions' => array('class' => 'nameFilterMask')))) ?>
								</div>
								<div class="col-sm-6">
									<?= $form->textFieldGroup($model->bkgUserInfo, 'bkg_bill_gst', array('label' => 'GSTIN', 'widgetOptions' => array('htmlOptions' => array('class' => 'nameFilterMask')))) ?>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<label class="control-label" for="car">Country</label>
										<?
										$country	 = Countries::model()->getByCode($model->bkgUserInfo->bkg_bill_country);
										?>
...
//											'val'			 => $model->bkgUserInfo->bkg_bill_country,
//											'data'			 => Countries::model()->getList(),
//											'htmlOptions'	 => array("width" => "100%", "style" => "width:100%;padding: 4%", 'placeholder' => 'Select Country')
//										));
										?>
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<div class="form-control"><?= States::model()->findByPk($model->bkgUserInfo->bkg_bill_state)->stt_name ?></div>
										<?php
//										$this->widget('booster.widgets.TbSelect2', array(
//											'model'			 => $model->bkgUserInfo,
...
//											'htmlOptions'	 => array('style' => 'width: 100%;padding: 4%', 'placeholder' => 'Select State')
//										));
										?>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										...
										<div class="form-control"><?=  Cities::model()->findByPk($model->bkgUserInfo->bkg_bill_city)->cty_name ?></div>

										<?php
//										$this->widget('booster.widgets.TbSelect2', array(
//											'model'			 => $model->bkgUserInfo,
//											'attribute'		 => 'bkg_bill_city',
//											'val'			 => $model->bkgUserInfo->bkg_bill_city,
//											//'asDropDownList' => FALSE,
//											'data'			 => Cities::model()->getCityList2($model->bkgFromCity->ctyState->stt_id),
//											//'options' => array('data' => new CJavaScriptExpression($regionList), 'allowClear' => true),
//											'htmlOptions'	 => array('style' => 'width: 100%;padding: 4%', 'placeholder' => 'Select City')
//										));
										?>
...
<?
if (($model->bkgInvoice->bkg_gozo_base_amount == '' || $model->bkgInvoice->bkg_gozo_base_amount == 0) && ($model->bkgInvoice->bkg_base_amount == '' || $model->bkgInvoice->bkg_base_amount == 0) && $model->bkg_status == 1)
{
	?>
...
<? } ?>
	...
	$("#BookingInvoice_bkg_base_amount").change(function () {
		var promo = $('#BookingInvoice_bkg_promo1_code').val();
		if (promo != '') {
	...
	$('#BookingInvoice_bkg_convenience_charge').change(function () {
		var convenience_charge = isNaN(parseInt($('#BookingInvoice_bkg_convenience_charge').val())) ? 0 : parseInt($('#BookingInvoice_bkg_convenience_charge').val());
		...
		if (data.success)
				//        if (data.data.quoteddata[data.data.cartypeid]['error'] > 0)
						//        {
								//            alert('Sorry! Your request can not be processed right now!Please try later.' + data.data.quoteddata[data.data.cartypeid]['error']);
										//        } else
										{
											...
											$("#BookingInvoice_bkg_toll_tax").val(qRouteRates.tollTaxAmount);
											$("#BookingInvoice_bkg_state_tax").val(qRouteRates.stateTax);
											$("#BookingInvoice_bkg_total_amount").val('');
											$("#BookingInvoice_bkg_rate_per_km_extra").val(qRouteRates.ratePerKM);
											$("#BookingInvoice_bkg_total_amount").val(qRouteRates.totalAmount).change;
											...
											if (data.data.quoteddata.chargeableDistance > 0)
											{
												$('#BookingInvoice_bkg_chargeable_distance').val(data.data.quoteddata.chargeableDistance);
											} else
											{
												$('#BookingInvoice_bkg_chargeable_distance').val(qRouteDistance.quotedDistance);
											}
											...
											$('#BookingInvoice_bkg_vendor_amount').val(venamt);
					...
					function calculateEstimatedAmount() {
						...
						var net_amount = Math.round($('#BookingInvoice_bkg_base_amount').val());
						...
						var rateVendorAmount = Math.round($('#BookingInvoice_bkg_quoted_vendor_amount').val());
						...
						var advance = isNaN(parseFloat($('#BookingInvoice_bkg_advance_amount').val())) ? 0 : parseFloat($('#BookingInvoice_bkg_advance_amount').val());
						...
						{
							service_tax_amount = Math.round(((net_amount + tollTaxVal + stateTaxVal + driver_allowance) * parseFloat(service_tax_rate) / 100));
						...
						var credits_used = parseInt(($('#BookingInvoice_bkg_credits_used').val() != '' && $('#BookingInvoice_bkg_credits_used').val() != undefined && $('#BookingInvoice_bkg_credits_used').val() != 'undefined') ? $('#BookingInvoice_bkg_credits_used').val() : 0);
						var credits = 0;
						...
						var refund = Math.round($('#BookingInvoice_bkg_refund_amount').val());
						refund = (refund == '') ? 0 : parseInt(refund);
						var due = net_amount - advance - credits_used - credits + refund;

						$('#BookingInvoice_bkg_convenience_charge').val(convenience_charge);
						$('#BookingInvoice_bkg_due_amount').val(due);
					...
					function calculateAmount() {
						...
						var tollTaxVal = ($('#BookingInvoice_bkg_toll_tax').val() == '') ? 0 : parseInt($('#BookingInvoice_bkg_toll_tax').val());
						var stateTaxVal = ($('#BookingInvoice_bkg_state_tax').val() == '') ? 0 : parseInt($('#BookingInvoice_bkg_state_tax').val());
						var service_tax_rate = $('#BookingInvoice_bkg_service_tax_rate').val();
						var service_tax_amount = 0;
						...
						$('#BookingInvoice_bkg_convenience_charge').val(convenience_charge);
						$('#BookingInvoice_bkg_due_amount').val(due);
						$('#BookingInvoice_bkg_total_amount').val(bkg_total_amount);
						// $('#Booking_bkg_vendor_amount').val(vendor_amount);
						$('#BookingInvoice_bkg_service_tax').val(service_tax_amount);
					}
					...
					function getCarmodel() {
						if ($("#Booking_bkg_route").val() != '')
						{
							...
							var href = '<?= Yii::app()->createUrl("admin/booking/getcarmodel"); ?>';
							$.ajax({
								url: href,
								dataType: "json",
								data: {"rt_id": rtid},
