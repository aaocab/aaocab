            ...
            <div class="panel panel-body panel-default pt0" id="divpmt">
				...
				if ($maxrefund > 0)
				{
					...
					<div class="col-xs-12 mt5">
						...
						<div class="row">
							<div class="row">
								<div class="col-xs-12 col-sm-5">Total advance: <?php echo $balanceArr['advance'] ?></div>
								<div class="col-xs-12 col-sm-7">Cancellation  charge (suggested) : <?php echo $refundArr['cancelCharge']; ?></div>
								<div class="col-xs-12 col-sm-5">Already  refunded : <?php echo $balanceArr['refund']; ?></div>
								<div class="col-xs-12 col-sm-7">Suggested  refund : <?php echo $refundArr['refund']; ?>
									<?php
									if ($refundArr['isDBOApplicable'] == 1)
									{
										echo "(DBO Refund Added)";
									}
									?>
								</div>
							</div>
						...
						<div class="row">	
							<div class="col-xs-12" id="dtext" style="display:<?= $display ?>">
								<span id="dvalue"></span> will be refunded.
							</div>
						</div>
					</div>
					<?php
