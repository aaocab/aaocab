...
$higherVechileType	 = Booking::model()->getHigherVehicleTypeInBookings($arrBkgIds); //returns vct_id based on service class
$quote				 = Quotation::model()->getVendorAmountListByBookingIds($arrBkgIds);
/* if ($bookingNotinNew > 0)
  {
  ?>
  <div class="alert alert-danger h4 text-center">
  You cannot match these bookings as one or more booking are not in NEW status.
  </div>
  <?
  } */
?>
    ...
    <div class="panel-body">	
			...
			<div class="row mb20">
				...
				<div class="col-xs-12 bordered pb10 pt10 ">
					...
					<input type="hidden" name="bkg_booking_id_Json" value='<?= $arrBkgIdsJSON ?>'/>
					<input type="hidden" name="bkgids" value='<?= implode(',', $arrBkgIds) ?>'/>
					<div class="row">
						<div class="col-xs-12 pb10">
							<div class="row">
								...
								<div class="col-xs-6 col-md-3 text-center mt10">
									Trip Vendor Amount: <b><i class="fa fa-inr"></i><?= $arrAmounts['bcb_vendor_amount'] ?></b>
								</div>
								<div class="col-xs-6 col-md-3 text-center mt10">
								<?	$carClassType = SvcClassVhcCat::getVctSvcList("string", 0, $higherVechileType, 0); ?>
									Proposed Vendor Amount: <b><i class="fa fa-inr"></i><?= $quote[$higherVechileType] . " (". $carClassType  . ")" ?></b>
								</div>
							</div>
						</div>
								...
								<div class="col-md-4 col-xs-12 ">
									<div class="row">
										...
										<div class="col-xs-5 text-left">
											...
											<input type="hidden" id="multicityjsondata" name="multicityjsondata" value='<?= json_encode($arrBkgIds); ?>'>
										</div>
									</div>
								</div>
											...
											<div class="row new-tab-border-b">
												<div class="col-xs-12 col-sm-6 new-tab-border-r">
													<div class="row new-tab1">
														...
														<div class="col-xs-7"><?= $number;//$model->bkgBcb->bcbVendor->vnd_phone ?>
														</div>
													</div>
												</div>
											</div>
