...
if (!empty(${"dataProvider" . $bid}))
{
	$this->widget('booster.widgets.TbGridView', array(
		...
		// 'ajaxType' => 'POST',
		'columns'			 => array(
			array('name' => 'bkg_booking_id', 'type' => 'raw', 'value' => 'CHtml::link($data->bkg_booking_id, Yii::app()->createUrl("admin/booking/view",["id"=>$data->bkg_id]),["class"=>"viewBooking", "onclick"=>"return viewBooking(this)"])', 'sortable' => true, 'htmlOptions' => array('class' => 'text-center'), 'headerHtmlOptions' => array('class' => 'text-center'), 'header' => 'Booking ID'),
