...
<?php
	...
	$checkAccess = Yii::app()->user->checkAccess('vendorUnassignWithoutPenalty')|false;
?>
        ...
        <div class="col-md-12">            
            ...
            <div class="panel mb0" >                
                <div style="width: 100%; padding: 3px; overflow: auto; line-height: 10px; font: normal arial; border-radius: 5px; -moz-border-radius: 5px; border: 1px #aaa solid;color: #444;">
					<?= CHtml::beginForm(Yii::app()->createUrl('admin/booking/canvendor'), "post", ['accept-charset' => "UTF-8", 'id' => "deleteForm", 'class' => "form", 'data-replace' => ".error-message p"]); ?>
...
$('#bkreason').change(function() {
	var checkAccess = "<?php echo $checkAccess; ?>";
	if(checkAccess == false && $(this).val() == 11)
	{
		alert('Your are not authorized for this action.');
		$("#bkreason")[0].selectedIndex = 0;
		return false;
	}
});
});
