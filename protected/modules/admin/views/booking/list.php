		...
		<nav class="navbar mb20">
			<div class="container-fluid">
				<ul class="nav navbar-nav pull-right">
					<li class="active"><a class="btn btn-success  btn-sm" style="background-color: blue;" id="delegatedAssignmentId" href="<?= Yii::app()->createUrl('aaohome/booking/list?source=224') ?>" title="Delegated assignment"><span style="font-size: 24px; font-weight: bold;"> <?= $assignment['delegation']; ?></span> in Delegated to Operation manager</a></li>
					<li><a class="btn btn-danger  btn-sm "  id="DemSupMisfire" href="<?= Yii::app()->createUrl('aaohome/booking/list?source=228&tab=2') ?>" title="Demand Supply Misfired"><span style="font-size: 24px; font-weight: bold;"> <?= $demsupmisfireCount; ?> </span> At Risk Bookings</a></li>
					<li><a class="btn btn-success  btn-sm" style="background-color: orange;" id="manualAssignmentId" href="<?= Yii::app()->createUrl('aaohome/booking/list?source=225') ?>" title="Manual assignment"><span style="font-size: 24px; font-weight: bold;"> <?= $assignment['manual']; ?></span> in Manual assignment</a></li>
					<li><a class="btn btn-success  btn-sm" style="background-color: red;" id="criticalAssignmentId" href="<?= Yii::app()->createUrl('aaohome/booking/list?source=226') ?>" title="Critical assignment"><span style="font-size: 24px; font-weight: bold;"> <?= $assignment['critical']; ?> </span> in Critical assignment</a></li>
					<!--					<li class="dropdown">
