...
";
?>
<div id="admin-content1" class="panel-advancedoptions" >
    <div class="row">
        <div class="col-md-12">
            <div class="panel">
                    ...
                    <div class="well p5 m0">
                        ...
                        if(!hasError){
                                ...
                                "success":function(data1){  
									jQuery(document).off("click","#assinvendorgrid a.btn.btn-xs.btn-info.vbtn");
									 $("#admin-content1").parent().html(data1);
                                    },
                                });
...
//										
                                    ...
                                    return false;
											...
											'url'		 => 'Yii::app()->createUrl("admin/booking/assignDispatchCsr", array(\'csrid\' => $data->adm_id,\'bkid\'=>' . $bkid . '))',
											'imageUrl'	 => false,
											'label'		 => 'Assign',
											'options'	 => array('style' => '', 'class' => 'btn btn-xs btn-info vbtn', 'id' => 'btn_' . $bkid, 'title' => 'Assign'),
										),
