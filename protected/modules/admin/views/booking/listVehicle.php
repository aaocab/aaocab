...
$this->widget('booster.widgets.TbGridView', array(
	...
	'columns'			 => array(
		...
		array('name' => 'last_booking', 'type' => 'raw', 'value' => 'CHtml::link($data["last_booking"], Yii::app()->createUrl("admin/booking/view",["id"=>$data["last_bkg_id"]]),["class"=>"viewBooking", "onclick"=>"return viewBooking(this)"])', 'sortable' => false, 'htmlOptions' => array('class' => 'text-center'), 'headerHtmlOptions' => array('class' => 'text-center'), 'header' => 'LastBooking ID'),
		...
		array('name' => 'next_booking', 'type' => 'raw', 'value' => 'CHtml::link($data["next_booking"], Yii::app()->createUrl("admin/booking/view",["id"=>$data["next_bkg_id"]]),["class"=>"viewBooking", "onclick"=>"return viewBooking(this)"])', 'sortable' => false, 'htmlOptions' => array('class' => 'text-center'), 'headerHtmlOptions' => array('class' => 'text-center'), 'header' => ' Next Booking ID'),
		...
		array(
			'header'		 => 'Action',
			'type'			 => 'raw', 'value'			 => 'CHtml::link("Assign", Yii::app()->createUrl("admin/booking/assigncabdriver", array("vhc" => $data["vhc_id"],"cav" => $data["cav_id"], "booking_id"=>' . $bkid . ', "agtid"=>' . $agtid . ')),["onClick" => "return assignCab(this)", "cav"=>$data["cav"], "class" => "btn btn-xs btn-info assignCab"])',
