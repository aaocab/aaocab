...
<div class="row mb10">
    <div class="col-xs-12">
        <p class="weight400 text-center">Please enter the verification code you received on <br>
			...
			if ($contactNo != '')
			{
				?><b>Phone: +<?= $countryCode ?><?= $contactNo ?></b> 
				<br>OR <br>
			<? } ?>
            ...
            <div class="panel-body">
				...
				$form = $this->beginWidget('booster.widgets.TbActiveForm', array(
					...
					'clientOptions'			 => array(
						...
						"dataType":"json",
						"url":"' . Yii::app()->createUrl('admin/booking/confirmmobile') . '",
						"data":form.serialize(),
						...
						"success":function(data2){                     
                            ...
                            if(data2.success){
                               ...
                               location.href = "' . Yii::app()->createUrl('admin/booking/view', ['id' => '']) . '"+data2.bkgid;
                ...
                <div class="row">
                    <div class="col-sm-6">
						<?= $form->textFieldGroup($model, 'bkg_verification_code1', array('label' => 'Phone', 'widgetOptions' => array('htmlOptions' => ['class' => 'form-control full-width border-radius', 'placeholder' => 'Verification code']))) ?>
                    </div>
					<div class="col-sm-6">
						<?= $form->textFieldGroup($model, 'bkg_verification_code2', array('label' => 'Email', 'widgetOptions' => array('htmlOptions' => ['class' => 'form-control full-width border-radius', 'placeholder' => 'Verification code']))) ?>
                    </div>
