                ...
                <div class="panel-body panel-body panel-no-padding">
                    <div class="panel-scroll">
                        <div class="row">
                            <div class="col-xs-12">
								...
								$form = $this->beginWidget('booster.widgets.TbActiveForm', array(
									'id'					 => 'cng-form', 'enableClientValidation' => true,
									'clientOptions'			 => array(
                        ...
                        if(!hasError){
                            $.ajax({
                            "type":"POST",
                            "url":"' . CHtml::normalizeUrl(Yii::app()->createUrl('admin/booking/cngAllowed', ['booking_id' => $bookModel->bkg_id, 'cngallowed_status' => $cngallowed_status])) . '",
                            "data":form.serialize(),
							"dataType": "json",
                                                        "success":function(data1){
									if(data1.success)
									{
										alert("Cng allowed update.");
										location.reload();
									}
								},
                            });
                                ...
                                <input type="hidden" id="cngallowed" name="cngallowed" value="<?= $cngallowed ?>"/>
