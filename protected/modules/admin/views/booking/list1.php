...
$this->widget('booster.widgets.TbGridView', array(
	...
	// 'ajaxType' => 'POST',
	'columns'			 => array(
		array('name' => 'bkg_booking_id', 'type' => 'raw', 'value' => 'CHtml::link($data->bkg_booking_id, Yii::app()->createUrl("admin/booking/view",["id"=>$data->bkg_id]),["class"=>"viewBooking", "onclick"=>"return viewBooking(this)"])', 'sortable' => false, 'htmlOptions' => array('class' => 'text-center'), 'headerHtmlOptions' => array('class' => 'text-center'), 'header' => 'Booking ID'),
		...
		array(
			'header'		 => 'Action',
			'type'			 => 'raw', 'value'			 => 'CHtml::link("Assign", Yii::app()->createUrl("admin/booking/assignvendor", array("ref_bkg_id"=>$data->bkg_id, "bkid"=>' . $bkid . ')),["class" => "btn btn-xs btn-info assignRefBooking", "onclick"=>"return vendorAssigned(this);"])',
