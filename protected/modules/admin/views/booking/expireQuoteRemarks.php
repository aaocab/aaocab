                ...
                <div class="panel-body panel-body panel-no-padding">
                    <div class="panel-scroll">
                        <div class="row">
                            <div class="col-xs-12">
								...
								$form = $this->beginWidget('booster.widgets.TbActiveForm', array(
									'id'					 => 'expireQuote-form', 'enableClientValidation' => true,
									'clientOptions'			 => array(
                        ...
                        if(!hasError){
                            $.ajax({
                            "type":"GET",
                            "url":"' . CHtml::normalizeUrl(Yii::app()->createUrl('admin/booking/expireQuote', ['booking_id' => $bookModel->bkg_id])) . '",
                            "data":form.serialize(),
							"dataType": "json",
                                    "success":function(data1){
									if(data1.success)
									{
										quoteExpired(data1.oldStatus);
										location.reload();
									}
								},
                            });
