                ...
                <div class="panel-body panel-body panel-no-padding">
                    <div class="panel-scroll">
                        ...
                        if(!hasError){
                            $.ajax({
                            "type":"POST",
                            "url":"' . CHtml::normalizeUrl(Yii::app()->createUrl('admin/booking/escalationremarks', ['booking_id' => $bookModel->bkg_id, 'escalation_status' => $escalation_status])) . '",
                            "data":form.serialize(),
							"dataType": "json",
                                                        "success":function(data1){
									if(data1.success)
									{
										escalationSent(data1.oldStatus);
									}
								},
                            });
                            }
