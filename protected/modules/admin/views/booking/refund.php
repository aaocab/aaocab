            ...
            <div class="panel panel-body panel-default pt0" id="divpmt">
				...
				if ($maxrefund > 0)
				{
					...
					<div class="col-xs-12 mt5">
						...
						<div class="row">
							<div class="col-xs-6 pl0">Total advance: <?php echo $balanceArr['advance'] ?></div>
							<div class="col-xs-6 pr0">Already  refunded : <?php echo $balanceArr['refund']; ?></div>

						</div> 
						<div class="row">	
							<div class="col-xs-6 pl0" >Suggested  refund : <?php echo $refundArr['refund']; ?></div>
							<div class="col-xs-6 pr0">Cancellation  charge (suggested) : <?php echo $refundArr['cancelCharge']; ?></div>
