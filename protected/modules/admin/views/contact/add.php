					...
					<div class="row ">
						...
						<div class="col-xs-12 col-sm-6 col-md-6">
							...
							<div class="form-group">
								<label class="control-label" for="">Email*</label><input value="" placeholder="Email" id="ContactEmail"  class="form-control"></div>
								<div id="messageEmail"></div>
							<div class="row float-right " style="white-space: nowrap">
								<div class="col-xs-12">
									<a class="btn btn-primary  weight400 font-bold " onclick="AddEmail()"title="Add More"><i class="fa fa-plus" aria-hidden="true"></i></a>
								</div>
							</div>
							<?php $this->renderPartial('emailwidget', ['model' => $model]);  ?>
						</div>
						
						<div class="col-xs-12 col-sm-6 col-md-6">

							<div class="form-group">
								<label class="control-label" for="">Phone*</label><input value="" placeholder="Phone" id="ContactPhone"  class="form-control"></div>
								<div id="messagePhone"></div>
							<div class="row float-right " style="white-space: nowrap">
								<div class="col-xs-12">
									<a class="btn btn-primary  weight400 font-bold " onclick="AddPhone()"title="Add More"><i class="fa fa-plus" aria-hidden="true"></i></a>
								</div>
							</div>
							<?php $this->renderPartial('phonewidget', ['model' => $model]);  ?>
						</div>
...
<?php if ($drvconttype == "1"){	?>   $("#Contact_ctt_user_type_1").attr('disabled', true); <?php } ?>
    });
    $sourceList1 = null;
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.success) {
                    ...
                    $("#contactDetails").text(data.ContactName + ' | ' + data.ContactEmail + ' | ' + data.ContactPhone);
