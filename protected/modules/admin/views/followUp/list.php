		...
		if (!empty($dataProvider))
		{
			$this->widget('booster.widgets.TbGridView', array(
				...
				'columns'			 => array(
					...
					array('name' => 'fwp_prefered_time', 'value' => 'DateTimeFormat::DateTimeToLocale($data["flwPreferedTime"])', 'headerHtmlOptions' => array('class' => 'col-xs-5'), 'header' => 'Time'),
					...
					array(
						...
						'buttons'			 => array(
							'add1'			 => array(
								...
								'url'		 => 'Yii::app()->createUrl("admin/followUp/add", array("Id" => $data["flwUpId"]))',
								'imageUrl'	 => false,
							...
							'log'			 => array(
								...
								'options'	 => array('data-toggle' => 'ajaxModal', 'style' => '', 'class' => 'btn btn-xs showlogfollow p0', 'title' => 'Show Log'),
							),
