                        ...
                        <div style="width: 100%; overflow: auto;  border: 1px #aaa solid;color: #444;">
							...
							if (!empty($dataProvider))
							{
								$this->widget('booster.widgets.TbGridView', array(
									'id'				 => 'pricerulelog-grid' . $qry['prl_id'],
									...
									'columns'			 => array(
										...
										array('name'	 => 'prl_desc', 'filter' => FALSE, 'value'	 => function($data) {
												echo $data['prl_desc'];
											}, 'sortable'			 => false,
											'headerHtmlOptions'	 => array('class' => 'col-xs-4'), 'header'			 => 'Description'),
										
										array('name'				 => 'prl_create_date',
											'filter'			 => FALSE,
											'value'				 => 'date("d/M/Y h:i A", strtotime($data[prl_create_date]))',
											'sortable'			 => false,
