				...
				if (!empty($dataProvider))
				{
					$this->widget('booster.widgets.TbExtendedGridView', array(
						...
						'columns'			 => array(
							...
							array('name' => 'bkg_assigned_at', 'value' => $data["bkg_assigned_at"], 'htmlOptions' => array('class' => 'text-center'), 'sortable' => true, 'headerHtmlOptions' => array('class' => 'col-xs-1 text-center'), 'header' => 'Assigned At'),
