       ...
       <div class="panel panel-default">
            <div class="panel-body">
				...
				if ($checkExportAccess)
				{
					...
					<?= CHtml::beginForm(Yii::app()->createUrl('admin/generalReport/zoneWiseCountBooking'), "post", ['style' => "margin-bottom: 10px;"]); ?>
					...
					$this->widget('booster.widgets.TbGridView', array(
						...
						//    'ajaxType' => 'POST',
						'columns'			 => array(
							array('name' => 'Region', 'value' => function($data)
									{
										if ($data['Region'] >= 1)
										{
											echo States::model()->findRegionName($data['Region']);
											
										} 
									},
									 'sortable' => true, 'headerHtmlOptions' => array('class' => 'col-xs-1'), 'header' => 'Region'),
							array('name' => 'Source_Zone', 'value' => '$data[Source_Zone]', 'sortable' => true, 'headerHtmlOptions' => array('class' => 'col-xs-1'), 'header' => 'Source Zone'),
