...
<div class="row m0">
    <div class="col-xs-12">
		...
		<div class="row"> 
			...
			'id' => 'manualAssignCount-form', 'enableClientValidation' => true,
			'clientOptions' => array(
		...
		if ($checkExportAccess && $reportReady)
		{
		  ?>
		<?= CHtml::beginForm(Yii::app()->createUrl('admin/generalReport/manualAssignmentCount'), "post", ['style' => "margin-bottom: 10px;"]); ?>
		...
		<button class="btn btn-default" type="submit">Report Ready. Download Report</button>
