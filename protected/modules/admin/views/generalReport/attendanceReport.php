                                ...
                                array(
                                    ...
                                    'buttons'           => array(
                                        'view'        => array(
                                            ...
                                            'url'      => 'Yii::app()->createUrl("admin/generalReport/AttendanceDetailsReport", array("id" => $data[adm_id],"fromDate" => date("Y-m-d", strtotime($data[fromDate])),"toDate" => date("Y-m-d", strtotime($data[toDate]))))',
