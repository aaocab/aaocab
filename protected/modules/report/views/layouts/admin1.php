...
<html lang="en">
    <head>
        ...
        <link href="<?= ASSETS_URL ?>/css/custom.css?v=4.1" rel="stylesheet" type="text/css"/>
            ...
            <div class="navbar">
                <div class="navbar-inner container">
                    ...
                    <div class="logo-box">
                        ...
                        <a  href="<?= Yii::app()->createUrl('report/index/dashboard') ?>"
                            style="font: inherit !important;  padding:5px">
                            <img style="width: 110px;margin-top: 10px" src="<?php echo Yii::app()->request->baseUrl; ?>/images/logo3_outstation.png?v1.1" />
                        </a>
                    </div><!-- Logo Box -->
...
<!--                                         <br /><span id="dailerBox"><?= Yii::app()->session['dialerNo'] ?></span>-->
    ...
    <script>
        ...
        $("#tags").autocomplete({
            ...
            return $("<li></li>").data("item.autocomplete", item).append("<div><a>" + item.label + "</a></div>").appendTo(ul);
        };
