        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="row"> 
					...
					{
						echo CHtml::beginForm(Yii::app()->createUrl('report/lead/leadsAndUnverifiedFeedback'), "post", []);
						?>
						<input type="hidden" id="export" name="export" value="true"/>
						<input type="hidden" id="from_date" name="from_date" value="<?php echo $model->lfu_from_date; ?>"/>
						<input type="hidden" id="to_date" name="to_date" value="<?php echo $model->lfu_to_date; ?>"/>
