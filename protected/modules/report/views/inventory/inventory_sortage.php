					...
					<div class="col-xs-6 col-sm-3 col-lg-3">
						...
						<label  class="control-label">Hide value with 0
							...
							if ($checkExportAccess)
							{
								...
								<?= CHtml::beginForm(Yii::app()->createUrl('report/inventory/inventoryShortage'), "post", []); ?>
								<input type="hidden" id="export" name="export" value="true"/>
								<input type="hidden" id="bkg_pickup_date1" name="bkg_pickup_date1" value="<?= $_REQUEST['Booking']['bkg_pickup_date1'] ?>"/>
								<input type="hidden" id="bkg_pickup_date2" name="bkg_pickup_date2" value="<?= $_REQUEST['Booking']['bkg_pickup_date2'] ?>"/>
								<input type="hidden" id="bkg_create_date1" name="bkg_create_date1" value="<?= $_REQUEST['Booking']['bkg_create_date1'] ?>"/>
								<input type="hidden" id="bkg_create_date2" name="bkg_create_date2" value="<?= $_REQUEST['Booking']['bkg_create_date2'] ?>"/>
								<input type="hidden" id="total_completedCount" name="total_completedCount" value="<?= $_REQUEST['Booking']['total_completedCount'] ?>"/>
								<input type="hidden" id="dem_sup_misfireCount" name="dem_sup_misfireCount" value="<?php echo ($_REQUEST['Booking']['dem_sup_misfireCount'] == '') ? 10 : ($_REQUEST['Booking']['dem_sup_misfireCount']); ?>"/>
								<input type="hidden" id="bkg_cancel_id" name="bkg_cancel_id" value="<?= implode(",", $_REQUEST['Booking']['bkg_cancel_id']) ?>"/>
								<input type="hidden" id="zero_percent" name="zero_percent" value="<?= $model->zero_percent == 1 || $_REQUEST['Booking']['zero_percent'] == 'on' ? 1 : 0; ?>"/>
