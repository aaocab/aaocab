    ...
    <div class="col-xs-12">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
				...
				{
					echo CHtml::beginForm(Yii::app()->createUrl('report/financial/pickupSummary'), "post", ['style' => "margin-bottom: 10px;margin-top: 10px;"]);
					?>
				...
				if (!empty($dataProvider))
				{
					...
					$this->widget('booster.widgets.TbGridView', array(
						...
						'columns'			 => array(
							...
							array('name'				 => 'bkg_partner_extra_commission', 'value'				 => '$data[bkg_partner_extra_commission]',
								'sortable'			 => true, 'headerHtmlOptions'	 => array('class' => 'col-xs-2'), 'header'			 => 'Partner Extra Commission'),
							...
							array('name'				 => 'vendor_name', 'value'				 => '$data[vendor_name]', 'sortable'			 => false,
								'headerHtmlOptions'	 => array('class' => 'col-xs-2'), 'header'			 => 'Vendor Name'),
							array('name'				 => 'driver_name', 'value'				 => '$data[driver_name]', 'sortable'			 => false,
								'headerHtmlOptions'	 => array('class' => 'col-xs-2'), 'header'			 => 'Driver Name'),
							array('name'				 => 'vhc_number', 'value'				 => '$data[vhc_number]', 'sortable'			 => false,
								'headerHtmlOptions'	 => array('class' => 'col-xs-2'), 'header'			 => 'Vehicle No'),
