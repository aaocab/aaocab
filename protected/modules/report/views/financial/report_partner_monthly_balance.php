        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="row"> 
					...
					{
						echo CHtml::beginForm(Yii::app()->createUrl('report/financial/PartnerMonthlyBalance'), "post", []);
						?>
						...
						<input type="hidden" id="cpm_agent_id" name="cpm_agent_id" value="<?php echo $partnerModel->cpm_agent_id; ?>"/>
