...
<div class="row"> 
	<div class="col-xs-12">
		...
		{
			?>
			<?= CHtml::beginForm(Yii::app()->createUrl('report/financial/partnercollection'), "post", ['style' => "margin-bottom: 10px;"]); ?>
			<input type="hidden" id="export1" name="export1" value="true"/>
			<input type="hidden" id="agt_id" name="agt_id" value="<?= $model->agt_id ?>"/>
