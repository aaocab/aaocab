    ...
    <div class="col-xs-12">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="row"> 
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
						...
						$form->select2Group($model, 'bkg_vendor_status', array('label'			 => 'Select Status',
							'widgetOptions'	 => array('data' => $statusList, 'options' => array('autoclose' => true), 'htmlOptions' => array('placeholder' => 'Select Status', 'class' => 'p0', 'style' => 'max-width: 100%'))));
						?>  
                    </div>
				...
				{
					?>
					<?= CHtml::beginForm(Yii::app()->createUrl('report/financial/daily'), "post", ['style' => "margin-bottom: 10px;"]); ?>
				...
				if (!empty($dataProvider))
				{
					...
					$this->widget('booster.widgets.TbGridView', array(
						...
						'columns'			 => array(
							...
							array('name'	 => 'from_city_name', 'value'	 =>
								function ($data) {
									$from_city_name = json_decode($data['bkg_route_city_names'], TRUE);
									echo $from_city_name[0];
								},
								'sortable'			 => false, 'headerHtmlOptions'	 => array('class' => 'col-xs-2'), 'header'			 => 'From City'),
							array('name'	 => 'to_city_name', 'value'	 =>
								function ($data) {
									$to_city_name = json_decode($data['bkg_route_city_names'], TRUE);
									echo $to_city_name[count($to_city_name) - 1];
								}, 'sortable'			 => false, 'headerHtmlOptions'	 => array('class' => 'col-xs-2'), 'header'			 => 'To City'),
							array('name' => 'no_of_days', 'value' => '$data[no_of_days]', 'sortable' => false, 'headerHtmlOptions' => array('class' => 'col-xs-2'), 'header' => 'No of days'),
							array('name' => 'bkg_vehicle_id', 'value' => '$data[serviceClass]', 'sortable' => false, 'headerHtmlOptions' => array('class' => 'col-xs-2'), 'header' => 'Cab Type'),
							...
							array('name' => 'bkg_amount', 'value' => '$data[bkg_total_amount]', 'sortable' => false, 'headerHtmlOptions' => array('class' => 'col-xs-2'), 'header' => 'Amount'),
							array('name' => 'bkg_drv_name', 'value' => '$data[drv_name]', 'sortable' => false, 'headerHtmlOptions' => array('class' => 'col-xs-2'), 'header' => 'Driver Name'),
							array('name' => 'commission', 'value' => '$data[commission]', 'sortable' => false, 'headerHtmlOptions' => array('class' => 'col-xs-2'), 'header' => 'Gozo Commission due'),
							array('name'	 => 'route_name', 'value'	 =>
								function ($data) {
									$city_name = json_decode($data['bkg_route_city_names'], TRUE);
									echo implode("-", $city_name);
								}
								, 'sortable'								 => false, 'headerHtmlOptions'						 => array('class' => 'col-xs-2'), 'header'								 => 'Route'),
							array('name' => 'bkg_vnd_name', 'value' => '$data[vendor_name]', 'sortable' => false, 'headerHtmlOptions' => array('class' => 'col-xs-2'), 'header' => 'Vendor Name'),
					)));
				}
				?> 
            </div>  
