    ...
    <div class="col-xs-12">      
        <div class="panel panel-default">
            <div class="panel-body">
				...
				{
					?>
					<?= CHtml::beginForm(Yii::app()->createUrl('report/financial/autoAssign'), "post", ['style' => "margin-bottom: 10px;"]); ?>
					...
					<input type="hidden" id="bkg_create_date2" name="bkg_create_date_2" value="<?= $model->bkg_create_date2 ?>"/>
					...
					<input type="hidden" id="tripAssignmnetFromTime" name="tripAssignmnetFromTime" value="<?= $model->tripAssignmnetFromTime ?>"/>
					<input type="hidden" id="tripAssignmnetToTime" name="tripAssignmnetToTime" value="<?= $model->tripAssignmnetToTime ?>"/>
					<input type="hidden" id="bkg_service_class" name="bkg_service_class" value="<?= implode(",", $model->bkg_service_class) ?>"/>
					<input type="hidden" id="is_reconfirm_flag" name="is_reconfirm_flag" value="<?= $model->is_reconfirm_flag ?>"/>
					<input type="hidden" id="is_advance_amount" name="is_advance_amount" value="<?= $model->is_advance_amount ?>"/>
					<input type="hidden" id="is_dbo_applicable" name="is_dbo_applicable" value="<?= $model->is_dbo_applicable ?>"/>
					<input type="hidden" id="is_New" name="is_New" value="<?= $model->is_New ?>"/>
