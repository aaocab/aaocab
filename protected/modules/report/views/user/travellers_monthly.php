            ...
            <div class="panel-body">
                <div class="row"> 
					...
					<div class="col-xs-2">
						...
						{
							echo CHtml::beginForm(Yii::app()->createUrl('report/user/Travellers'), "post", ['style' => "margin-top: 24px;"]);
							?>
							<input type="hidden" id="monthcount" name="monthcount" value="<?= $model->monthcount ?>"/>
