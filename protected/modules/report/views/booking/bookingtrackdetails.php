<div class="row m0">
    <div class="col-xs-12">
        ...
        <div class="panel panel-default">
			...
			{
				?>
				<?= CHtml::beginForm(Yii::app()->createUrl('report/booking/bookingtrackdetails'), "post", ['style' => "margin-bottom: 10px;"]); ?>
			...
			if (!empty($dataProvider))
			{
				...
				$this->widget('booster.widgets.TbGridView', array(
					...
					'columns'			 => array(
						...
						array('name' => 'bkg_amount', 'value' => '$data[adt_amount]', 'sortable' => true, 'headerHtmlOptions' => array('class' => 'col-xs-1'), 'htmlOptions' => array('class' => 'text-right'), 'header' => 'Penalty Amount'),
                        ...
                        {
                           if($data['bkg_pickup_date'] != null && $data['bkg_trip_arrive_time'] != null)
                           {
                                $dateTimeObject1 = date_create($data['bkg_trip_arrive_time']);  
                                $dateTimeObject2 = date_create($data['bkg_pickup_date']);  
                        ...
                        }, 'sortable' => true, 'headerHtmlOptions' => array('class' => 'col-xs-2'), 'header' => 'Time Diff(pickup and arrival)'),
