...
<div class="col-xs-offset-3 col-sm-offset-0 col-xs-6 col-sm-2 col-md-2 mt5">
	...
	{
		echo CHtml::beginForm(Yii::app()->createUrl('report/booking/upperTierList'), "post", ['style' => "margin-bottom: 10px;margin-top: 10px;"]);
		?>
			...
			$this->widget('booster.widgets.TbGridView', array(
				...
				'columns'			 => array(
					...
					array('name'	 => 'booking_count', 'value'	 => function ($data) {
							...
							echo ($data['booking_count']);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'Booking Count'),
					
					array('name'	 => 'total_booking_count', 'value'	 => function ($data) {

							echo ($data['total_booking_count']);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
