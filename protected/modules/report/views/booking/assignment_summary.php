    ...
    <div class="col-xs-12">
			...
			<div class="col-xs-12 pl0">
				<div class="row mb15">
					...
					<div class="col-xs-12 col-lg-7">
						...
						<div style="display: inline-block; ">
							<?php echo $form->radioButtonListGroup($model, 'assignMode', array('label' => '', 'inline' => true, 'widgetOptions' => array('data' => array(0 => 'Auto Assign', 1 => 'Manual Assign')), 'groupOptions' => ['htmlOptions' => ["style" => "display: inline-block"]])) ?>
						</div>

						<div style="display: inline-block">
							<?php echo $form->checkboxGroup($model, 'manualAssignment', array('label' => 'Manual Assignment')) ?>
						</div>

						<div style="display: inline-block">
							<?php echo $form->checkboxGroup($model, 'criticalAssignment', array('label' => 'Critical Assignment')) ?>
						</div>
						<div style="display: inline-block">
							<?php echo $form->checkboxGroup($model, 'includeTFR', array('label' => 'Include TFR (Non confirmed)')) ?>
						</div>
					</div>
					<div class="col-xs-12 col-lg-2">
						<div style="display: inline-block">
		...
		<div class="row">
			<div class="  col-xs-12 col-sm-12 col-md-2 text-center mb20"  >
				...
				{
					echo CHtml::beginForm(Yii::app()->createUrl('report/booking/AssignmentSummary'), "post", []);
					?>
					...
					<input type="hidden" id="bkg_create_date1" name="bkg_create_date1" value="<?php echo $model->bkg_create_date1; ?>"/>
					<input type="hidden" id="bkg_create_date2" name="bkg_create_date2" value="<?php echo $model->bkg_create_date2; ?>"/>
					<input type="hidden" id="from_date" name="from_date" value="<?php echo $model->from_date; ?>"/>
					<input type="hidden" id="to_date" name="to_date" value="<?php echo $model->to_date; ?>"/>
					<input type="hidden" id="bkgtypes" name="bkgtypes" value="<?= implode(",", $model->bkgtypes); ?>"/>
					<input type="hidden" id="bkg_agent_id" name="bkg_agent_id" value="<?php echo $model->bkg_agent_id; ?>"/>
					...
					<input type="hidden" id="region" name="region" value="<?= implode(",", $model->region); ?>"/>
					<input type="hidden" id="state" name="state" value="<?= implode(",", $model->state); ?>"/>
					<input type="hidden" id="b2cbookings" name="b2cbookings" value="<?php echo $model->b2cbookings; ?>"/>

					<input type="hidden" id="mmtbookings" name="mmtbookings" value="<?php echo $model->mmtbookings; ?>"/>
					<input type="hidden" id="nonAPIPartner" name="nonAPIPartner" value="<?php echo $model->nonAPIPartner; ?>"/>
					<input type="hidden" id="excludeAT" name="excludeAT" value="<?php echo $model->excludeAT; ?>"/>
					<input type="hidden" id="gnowType" name="gnowType" value="<?= implode(",", $model->gnowType); ?>"/>
					<input type="hidden" id="nonProfitable" name="nonProfitable" value="<?php echo $model->nonProfitable; ?>"/>
					<input type="hidden" id="local" name="local" value="<?php echo $model->local; ?>"/>
					<input type="hidden" id="outstation" name="outstation" value="<?php echo $model->outstation; ?>"/>

					<input type="hidden" id="assignMode" name="assignMode" value="<?php echo $model->assignMode; ?>"/>
					<input type="hidden" id="manualAssignment" name="manualAssignment" value="<?php echo $model->manualAssignment; ?>"/>
					<input type="hidden" id="criticalAssignment" name="criticalAssignment" value="<?php echo $model->criticalAssignment; ?>"/>
