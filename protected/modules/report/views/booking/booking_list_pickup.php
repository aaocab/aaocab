...
<div class="col-xs-offset-3 col-sm-offset-0 col-xs-6 col-sm-2 col-md-2 mt5">
	...
	{
		echo CHtml::beginForm(Yii::app()->createUrl('report/booking/listTotalAmountByPickup'), "post", ['style' => "margin-bottom: 10px;margin-top: 10px;"]);
		?>
			...
			$this->widget('booster.widgets.TbGridView', array(
				...
				'columns'			 => array(
					array('name'	 => 'pickupDate', 'value'	 => function ($data) 
						...
						'header'			 => 'Pickup Date'),
					array('name'	 => 'totalCnt', 'value'	 => function ($data) 
						{
					...
					array('name'	 => 'BookingAmount<1000', 'value'	 => function ($data) 
						{

							echo ($data['BookingAmount<1000']);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'BookingAmount<1000'),
					array('name'	 => '1000<=BookingAmount>2000', 'value'	 => function ($data) 
						{

							echo ($data['1000<=BookingAmount>2000']);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => '1000<=BookingAmount>2000'),
					array('name'	 => '2000<=BookingAmount>3000', 'value'	 => function ($data) 
						{

							echo ($data['2000<=BookingAmount>3000']);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => '2000<=BookingAmount>3000'),
					array('name'	 => '3000<=BookingAmount>4000', 'value'	 => function ($data) 
						{

							echo ($data['3000<=BookingAmount>4000']);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => '3000<=BookingAmount>4000'),	
					array('name'	 => '4000<=BookingAmount>5000', 'value'	 => function ($data) 
						{

							echo ($data['4000<=BookingAmount>5000']);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => '4000<=BookingAmount>5000'),	
					array('name'	 => 'BookingAmount>=5000', 'value'	 => function ($data) 
						{

							echo ($data['BookingAmount>=5000']);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'BookingAmount>=5000'),
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var end = '<?= ($model->bkg_pickup_date2 == '') ? date('d/m/Y') : date('d/m/Y', strtotime($model->bkg_pickup_date2)); ?>';
