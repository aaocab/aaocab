...
<div class="col-xs-offset-3 col-sm-offset-0 col-xs-6 col-sm-2 col-md-2 mt5">
	...
	{
		echo CHtml::beginForm(Yii::app()->createUrl('report/booking/anyAssignment'), "post", ['style' => "margin-bottom: 10px;margin-top: 10px;"]);
		?>
			...
			$this->widget('booster.widgets.TbGridView', array(
				...
				'columns'			 => array(
					...
					array('name'	 => 'booking_amount', 'value'	 => function ($data) {
							...
							echo "<i class=\"fa fa-inr\"></i>" . $data['booking_amount'];
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-1 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'Booking amount'
					),
					array('name'	 => 'gozo_amount', 'value'	 => function ($data) {

							echo "<i class=\"fa fa-inr\"></i>" . $data['gozo_amount'];
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-1 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'Gozo Amount'
