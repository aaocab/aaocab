...
<div class="col-xs-offset-3 col-sm-offset-0 col-xs-6 col-sm-2 col-md-2 mt5">
	...
	{
		echo CHtml::beginForm(Yii::app()->createUrl('report/booking/salesAssistedByTier'), "post", ['style' => "margin-bottom: 10px;margin-top: 10px;"]);
		?>
			...
			$this->widget('booster.widgets.TbGridView', array(
				...
				'columns'			 => array(
					...
					array('name'	 => 'scc_label', 'value'	 => function ($data) 
						...
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'Scc Label'),	
					array('name'	 => 'count', 'value'	 => function ($data) 
						{
						...
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'Count'),
					array('name'	 => 'total_sum', 'value'	 => function ($data) 
						{
