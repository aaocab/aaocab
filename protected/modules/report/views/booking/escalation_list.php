    ...
    <div class="col-xs-12">      
        <div class="panel panel-default">
            <div class="panel-body">
				...
				{
					?>
					<?= CHtml::beginForm(Yii::app()->createUrl('report/booking/escalation'), "post", ['style' => "margin-bottom: 10px;"]); ?>
					<input type="hidden" id="export" name="export" value="true"/>
					<input type="hidden" id="btr_escalation_assigned_team" name="btr_escalation_assigned_team" value="<?= $teams; ?>"/>
