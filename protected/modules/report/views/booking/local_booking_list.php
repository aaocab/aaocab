...
<div class="col-xs-offset-3 col-sm-offset-0 col-xs-6 col-sm-2 col-md-2 mt5">
	...
	{
		echo CHtml::beginForm(Yii::app()->createUrl('report/booking/localBooking'), "post", ['style' => "margin-bottom: 10px;margin-top: 10px;"]);
		?>
		...
		if (!empty($dataProvider))
		{
			...
			$this->widget('booster.widgets.TbGridView', array(
				...
				'columns'			 => array(
					...
					array('name'	 => 'MMT/IBIBO(Booking/Completed/Cancel)', 'value'	 => function ($data) {

							echo ($data['MMT/IBIBO_Booking'] . "/" . $data['MMT/IBIBO_Completed'] . "/" . $data['MMT/IBIBO_Cancel']);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'MMT/IBIBO(Booking/Completed/Cancel)'
					),
					array('name'	 => 'EMT(Booking/Completed/Cancel)', 'value'	 => function ($data) {

							echo ($data['EMT_Booking'] . "/" . $data['EMT_Completed'] . "/" . $data['EMT_Cancel']);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'EMT(Booking/Completed/Cancel)'
					),
					array('name'	 => 'SPICEJET(Booking/Completed/Cancel)', 'value'	 => function ($data) {

							echo ($data['SPICEJET_Booking'] . "/" . $data['SPICEJET_Completed'] . "/" . $data['SPICEJET_Cancel']);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'SPICEJET(Booking/Completed/Cancel)'
					),
					array('name'	 => 'OTHER_B2B(Booking/Completed/Cancel)', 'value'	 => function ($data) {

							echo ($data['OTHER_B2B_Booking'] . "/" . $data['OTHER_B2B_Completed'] . "/" . $data['OTHER_B2B_Cancel']);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'OTHER_B2B(Booking/Completed/Cancel)'
					),
					array('name'	 => 'B2C(Booking/Completed/Cancel)', 'value'	 => function ($data) {

							echo ($data['B2C_Booking'] . "/" . $data['B2C_Completed'] . "/" . $data['B2C_Cancel']);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'B2C(Booking/Completed/Cancel)'
					),
					array('name'	 => 'Total(Booking/Completed/Cancel)', 'value'	 => function ($data) {

							echo ($data['Total_Booking'] . "/" . $data['Total_Completed'] . "/" . $data['Total_Cancel']);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'Total(Booking/Completed/Cancel)'
					),
			)));
		}
		?>
