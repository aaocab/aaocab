<div class='row p15'>
	...
	<div class="col-xs-offset-3 col-sm-offset-0 col-xs-6 col-sm-2 col-md-2 mt5">
		...
		{
			echo CHtml::beginForm(Yii::app()->createUrl('report/booking/margin'), "post", ['style' => "margin-bottom: 10px;margin-top: 10px;"]);
			?>
			...
			<input type="hidden" id="bkg_types" name="bkg_types" value="<?= $bkgTypes; ?>"/>
    ...
    <div class="col-xs-12">
		...
		if (!empty($dataProvider))
		{
			...
			$this->widget('booster.widgets.TbGridView', array(
				...
				'columns'			 => array(
					array('name'				 => 'TotalBookingCnt', 'value'				 => $data['TotalBookingCnt'], 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-1 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'Total Booking Count'),
					array('name'				 => 'tripType', 'value'				 => $data['tripType'], 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'Trip Type'),
					array('name'				 => 'PickupBins', 'value'				 => $data['PickupBins'], 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'PickupBins'),
					array('name'				 => 'Profit', 'value' => function($data)
					{
								echo "<i class=\"fa fa-inr\"></i>". $data['Profit'];
					}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'Profit'),
