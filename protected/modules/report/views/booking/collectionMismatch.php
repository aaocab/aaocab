                ...
                <div class="row"> 
					<div class="col-xs-12 ">
						<div class="row">
							...
							<div class="col-xs-12 col-sm-3 col-md-3">
								<div class="form-group">
									<label class="control-label">Select difference type</label>
									<?php
									$data			 = ['1' => 'Estimated > Collected', '2' => 'Estimated < Collected'];
									$this->widget('booster.widgets.TbSelect2', array(
										'model'			 => $model,
										'attribute'		 => 'diffCollectionType',
										'val'			 => $model->diffCollectionType,
										'data'			 => $data,
										'htmlOptions'	 => array('class'			 => 'p0',
											'style'			 => 'width: 100%', 'placeholder'	 => 'Select difference type')
									));
									?>
								</div> 
							</div>
			...
			if (!empty($dataProvider))
			{
				...
				$this->widget('booster.widgets.TbGridView', array(
					...
					'template'			 => "<div class='panel-heading'><div class='row'>
                                    ...
                                    <div class='panel-body'><div class='table table-responsive'>{items}</div></div>
					...
					'columns'			 => array(
						...
						array('name'				 => 'bkg_create_date',
							'value'				 => 'DateTimeFormat::DateTimeToLocale($data[bkg_create_date])',
							'sortable'			 => true, 'htmlOptions'		 => array('class' => 'text-center'),
							'headerHtmlOptions'	 => array('class' => 'text-center'), 'header'			 => 'Create Date'),
						array('name'				 => 'bkg_pickup_date',
							'value'				 => 'DateTimeFormat::DateTimeToLocale($data[bkg_pickup_date])',
							'sortable'			 => true, 'htmlOptions'		 => array('class' => 'text-center'),
							'headerHtmlOptions'	 => array('class' => 'text-center'), 'header'			 => 'Pickup Date'),
						array('name'				 => 'bkg_vendor_collected',
							'value'				 => 'Filter::moneyFormatter($data[bkg_vendor_collected])',
							'sortable'			 => true, 'htmlOptions'		 => array('class' => 'text-right'),
							'headerHtmlOptions'	 => array('class' => 'text-center'), 'header'			 => 'Estimated Amount to Collect'),
						array('name'				 => 'bkg_vendor_actual_collected',
							'value'				 => 'Filter::moneyFormatter($data[bkg_vendor_actual_collected])',
							'sortable'			 => true, 'htmlOptions'		 => array('class' => 'text-right'),
							'headerHtmlOptions'	 => array('class' => 'text-center'), 'header'			 => 'Actual Amount Collected'),
				)));
			}
			?> 
		</div> 
