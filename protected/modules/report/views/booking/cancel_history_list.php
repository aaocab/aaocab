			...
			$this->widget('booster.widgets.TbGridView', array(
				...
				'columns'			 => array(
					array('name'	 => 'PickupDate', 'value'	 => function ($data) {
						...
						'header'			 => 'Pickup Date'),
					array('name'	 => 'MMT/IBIBO(SC/TC/CI/GI,GI_TC(%))', 'value'	 => function ($data) {

							$MMT_GI_TC_PER = $data['MMT_GI_TC_PER'] > 0 ? $data['MMT_GI_TC_PER'] : 0.00;
							echo ($data['MMTSC'] . "/" . $data['MMTTC'] . "/" . $data['MMTCI'] . "/" . $data['MMTGI'] . "/" . $MMT_GI_TC_PER);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'MMT/IBIBO(SC/TC/CI/GI/GI_TC(%))'),
					array('name'	 => 'EMT(SC/TC/CI/GI/GI_TC(%))', 'value'	 => function ($data) {

							$EMT_GI_TC_PER = $data['EMT_GI_TC_PER'] > 0 ? $data['EMT_GI_TC_PER'] : 0.00;
							echo ($data['EMTSC'] . "/" . $data['EMTTC'] . "/" . $data['EMTCI'] . "/" . $data['EMTGI'] . "/" . $EMT_GI_TC_PER);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'EMT(SC/TC/CI/GI,GI_TC(%))'),
					array('name'	 => 'SPICE(SC/TC/CI/GI/GI_TC(%))', 'value'	 => function ($data) {

							$SPICE_GI_TC_PER = $data['SPICE_GI_TC_PER'] > 0 ? $data['SPICE_GI_TC_PER'] : 0.00;
							echo ($data['SPICESC'] . "/" . $data['SPICETC'] . "/" . $data['SPICECI'] . "/" . $data['SPICEGI'] . "/" . $SPICE_GI_TC_PER);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'SPICE(SC/TC/CI/GI/GI_TC(%))'),
					array('name'	 => 'B2C(SC/TC/CI/GI/GI_TC(%))', 'value'	 => function ($data) {

							$B2C_GI_TC_PER = $data['B2C_GI_TC_PER'] > 0 ? $data['B2C_GI_TC_PER'] : 0.00;
							echo ($data['B2CSC'] . "/" . $data['B2CTC'] . "/" . $data['B2CCI'] . "/" . $data['B2CGI'] . "/" . $B2C_GI_TC_PER);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'B2C(SC/TC/CI/GI/GI_TC(%))'),
			)));
		}
		?>
    </div>
