            ...
            <div class="panel-body">
                ...
                <div id="row" class="row">
					...
					<div class="col-xs-12 col-sm-3 "><?
						...
						?>
						<label  class="control-label">Pickup From & To Date Selection</label>
					...
					<div class="col-xs-12 col-sm-3 col-md-3">
						<div class="form-group cityinput">
							...
							<?php
							$cancelReasonList = CancelReasons::model()->getlist();
							$this->widget('booster.widgets.TbSelect2', array(
								'model'			 => $model,
				...
				<div class="row" >
					...
					<div class="col-xs-12 col-sm-3 mt10 n">
						<?php echo $form->checkboxGroup($model, 'isGozonow', array('label' => 'Only Gozo Now')) ?>
					</div>
				...
				<div class="row" style="margin-top: 10px">  <div class="col-xs-12 col-sm-7 col-md-5">       
                    ...
                    <div class="col-xs-12 col-sm-5 col-md-5">
						...
						if ($checkExportAccess)
						{
							...
							<?= CHtml::beginForm(Yii::app()->createUrl('report/booking/ReportCancellations'), "post", ['style' => "margin-bottom: 10px;"]); ?>
							...
							<input type="hidden" id="export_bkg_cancel_id" name="export_bkg_cancel_id" value="<?= $model->bkg_cancel_id ?>"/>
					...
					$this->widget('booster.widgets.TbGridView', array(
						...
						'columns'			 => array(
							...
							array('name'	 => 'refund_amount',
								'value'	 => function ($data) {
									echo number_format($data['bkg_cust_compensation_amount'], 2);
								},
								'sortable'			 => true,
								'headerHtmlOptions'	 => array('class' => 'col-xs-1'),
								'htmlOptions'		 => array('class' => 'text-right'),
