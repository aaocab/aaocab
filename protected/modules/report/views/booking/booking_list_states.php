...
<div class="col-xs-offset-3 col-sm-offset-0 col-xs-6 col-sm-2 col-md-2 mt5">
	...
	{
		echo CHtml::beginForm(Yii::app()->createUrl('report/booking/bookingCountByStates'), "post", ['style' => "margin-bottom: 10px;margin-top: 10px;"]);
		?>
		...
		if (!empty($dataProvider))
		{
			...
			$this->widget('booster.widgets.TbGridView', array(
				...
				'columns'			 => array(
					...
					array('name'	 => 'StateName', 'value'	 => function ($data) {
					...
					array('name'	 => 'cty_state_id', 'value'	 => function ($data) {

							echo ($data['cty_state_id']);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-2 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'State Id'
