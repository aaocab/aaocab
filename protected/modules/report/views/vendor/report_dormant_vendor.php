            ...
            <div class="panel-body">
				<div class="row"> 
					...
					<div class="col-xs-1">
						...
						{
							echo CHtml::beginForm(Yii::app()->createUrl('report/vendor/DormantVendor'), "post", []);
							?>
							<input type="hidden" id="vnp_home_zone" name="vnp_home_zone" value="<?= $modelPref->vnp_home_zone ?>"/>
									<input type="hidden" id="vnd_phone" name="vnd_phone" value="<?= $model->vnd_phone ?>"/>
							<input type="hidden" id="export" name="export" value="true"/>
							<button class="btn btn-default btn-5x pr30 pl30" type="submit" style="width: 185px;">Export</button>
