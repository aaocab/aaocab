...
<div class="row">
	<div class="col-xs-12  pb10">
		...
		<br>
		<a target="_blank" href="/report/scq/teamStaticalData/">Click To View Team Report</a>
	</div>
</div>
<div class="row"> 
...
if ($checkExportAccess)
{
	...
	echo CHtml::beginForm(Yii::app()->createUrl('report/scq/serviceRequests'), "post", ['style' => "margin-bottom: 10px;margin-top: 10px;"]);
	?>
	<input type="hidden" id="scq_to_be_followed_up_by_id" name="scq_to_be_followed_up_by_id" value="<?= $model->scq_to_be_followed_up_by_id ?>"/>
	<input type="hidden" id="isFollowUpOpen" name="isFollowUpOpen" value="<?= $model->isFollowUpOpen ?>"/>
	<input type="hidden" id="isDue24" name="isDue24" value="<?= $model->isDue24 ?>"/>
	<input type="hidden" id="search" name="search" value="<?= $model->search ?>"/>
	<input type="hidden" id="requestedBy" name="requestedBy" value="<?= $model->requestedBy ?>"/>
	<input type="hidden" id="custId" name="custId" value="<?= $model->custId ?>"/>
	<input type="hidden" id="vendId" name="vendId" value="<?= $model->vendId ?>"/>
	<input type="hidden" id="drvId" name="drvId" value="<?= $model->drvId ?>"/>
	<input type="hidden" id="adminId" name="adminId" value="<?= $model->adminId ?>"/>
	<input type="hidden" id="agntId" name="agntId" value="<?= $model->agntId ?>"/>
	<input type="hidden" id="scq_to_be_followed_up_by_type" name="scq_to_be_followed_up_by_type" value="<?= $model->scq_to_be_followed_up_by_type ?>"/>
	<input type="hidden" id="isGozen" name="isGozen" value="<?= $model->isGozen ?>"/>
