        ...
        <div class="panel panel-default">
            <div class="panel-body">
				...
				<div class="row"> 
					...
					<div class="col-xs-12 col-sm-3 pt20">   
				...
				<div class="col-xs-2">
					...
					{
						echo CHtml::beginForm(Yii::app()->createUrl('report/area/RegionVendorwiseDriverAppusage'), "post", ['style' => "margin-top: 24px;"]);
						?>
						...
						<input type="hidden" id="bcb_vendor_id" name="bcb_vendor_id" value="<?= $model->bcb_vendor_id ?>"/>
