...
<div class="col-xs-offset-3 col-sm-offset-0 col-xs-6 col-sm-2 col-md-2 mt5">
	...
	{
		echo CHtml::beginForm(Yii::app()->createUrl('report/area/routeAnalysis'), "post", ['style' => "margin-bottom: 10px;margin-top: 10px;"]);
		?>
    ...
    <div class="col-xs-12">
		...
		if (!empty($dataProvider))
		{
			...
			$this->widget('booster.widgets.TbGridView', array(
				...
				'columns'			 => array(
					array('name'	 => 'totalInquiry', 'value'	 => function ($data) {

							echo ($data['totalInquiry']);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-1 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'totalInquiry'),
					array('name'	 => 'B2CInquiry', 'value'	 => function ($data) {

							echo ($data['B2CInquiry']);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-1 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'B2CInquiry'),
					array('name'	 => 'B2BInquiry', 'value'	 => function ($data) {

							echo ($data['B2BInquiry']);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-1 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'B2BInquiry'),
					array('name'	 => 'B2CConfirm', 'value'	 => function ($data) {

							echo ($data['B2CConfirm']);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-1 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'B2CConfirm'),
					array('name'	 => 'B2BConfirm', 'value'	 => function ($data) {

							echo ($data['B2BConfirm']);
						}, 'sortable'			 => true,
						'headerHtmlOptions'	 => array('class' => 'col-xs-1 text-center'),
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'B2BConfirm'),
					...
					array('name'	 => 'toCityName', 'value'	 => function ($data) {
						...
						'htmlOptions'		 => array('class' => 'text-center'),
						'header'			 => 'To City'),
					array('name'	 => 'rut_name', 'value'	 => function ($data) {
