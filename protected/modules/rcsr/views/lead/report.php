...
//                                    'val' => $model->bkg_from_city_id_txt,
...
<?php $this->endWidget(); ?>
                ...
                <div class="row">
                    <div class="col-xs-12 pull-right pt5">
                        ...
                        <div class="pull-right">
							<a href="<?= Yii::app()->createUrl("rcsr/lead/autoAssign") ?>" onclick="return autoAssign(this);" class="btn btn-sm btn-animate-side btn-warning">Auto Assign Lead</a>
<? //CHtml::link('Unverified Bookings', Yii::app()->createUrl('rcsr/booking/list/tab/1'), ['class' => "btn btn-sm btn-info", 'title' => "Unverified Bookings"])  ?>
                            <a data-toggle="ajaxModal" id="lead" rel="popover" data-placement="left" class="btn btn-sm btn-primary" title="Follow" href="<?= Yii::app()->createUrl("/rcsr/lead/leadfollow") ?>">Create Lead</a>
                        </div>
						<!--                        <div class="pull-right mr5">
<?= CHtml::beginForm(Yii::app()->createUrl('r/lead/report'), "post", []); ?>
                    ...
                    <div class="tab-content p0">
						...
						foreach ($dataProviders as $bid => $dataProvider)
						{
							...
							<div id="<?= 'sec' . $bid ?>" class="tab-pane <?= ${'tabactive' . $bid} ?>">
								<?php
								$this->renderPartial("grid", ['status' => $bid, 'provider' => $dataProvider]);
