                ...
                if (!empty($dataProvider)) {
					...
					<div class='panel-footer'><div class='row m0'><div class='col-xs-12 col-sm-6 p5'>{summary}</div><div class='col-xs-12 col-sm-6 pr0'>{pager}</div></div></div>",
                        ...
                        'columns' => array(
                            ...
                            array('name' => 'bkg_user_email', 'value' => '$data["bkg_user_email"]', 'sortable' => false, 'headerHtmlOptions' => array(), 'htmlOptions' => array('style' => 'word-break: break-all'), 'header' => 'Email'),
                            ...
                            array(
                                ...
                                'buttons' => array(
                                    'inactive' => array(
                                        'url' => 'Yii::app()->createUrl("rcsr/lead/deactivate", array("bkg_id" => $data["bkg_id"]))',
