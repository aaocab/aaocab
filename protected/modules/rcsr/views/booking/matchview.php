...
//
//exit;
$advamt      = $model->bkg_advance_amount;
$amtdue      = $model->bkg_due_amount;
$refund      = $model->bkg_refund_amount;
$vndamt      = $model->bkg_vendor_amount;
$vndamt      = $model->bkg_vendor_amount;
$bkgamt      = $model->bkg_total_amount;
$gzamount    = ($gzamount == '') ? $bkgamt - $vndamt : $gzamount;
//$vndcolamt = $bkgamt + $refund - $advamt - $amtdue;
$vndcolamt   = $model->bkg_vendor_collected;
                ...
                <div class="col-xs-12 pt10">
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="row p5">
                            ...
                            <div class="col-xs-6 col-sm-12"><?= $model->bkg_user_name . ' ' . $model->bkg_user_lname; ?></div>
                        </div>
                        <div class="row p5">
                            ...
                            {
                                ?>
                                <div class="col-xs-6 col-sm-12">+<?= $model->bkg_country_code; ?>-<?= $model->bkg_contact_no; ?></div>
                                <?
                            }
                            else
                            {
                        ...
                        <div class="row p5">
                            ...
                            <div class="col-xs-6 col-sm-12"><?= $model->bkgVehicleType->vht_model ?></div>
                        </div>
                        <?
                        if ($model->bkg_promo_code != '')
                        {
                            ...
                            <div class="row p5">
                                ...
                                <div class="col-xs-6 col-sm-12"><?= strtoupper($model->bkg_promo_code) ?></div>
                            </div> 
                        <? } ?>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="row p5">
                            ...
                            <div class="col-xs-6 col-sm-12"><?= ($model->bkg_user_email != '') ? $model->bkg_user_email : "&nbsp;" ?></div>
                        </div>
                        <div class="row p5">
                            ...
                            {
                                ?>
                                <div class="col-xs-6 col-sm-12">+<?= $model->bkg_alt_country_code; ?>-<?= $model->bkg_alternate_contact; ?></div>
                                <?
                            }
                            else
                            {
                        ...
                        <div class="row p5 pb20">
                            ...
                            <div class="col-xs-6 col-sm-12"><?= ( $model->bkg_info_source != '') ? $model->bkg_info_source : "&nbsp;" ?></div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="row p5">
                        ...
                        <div class="row p5 pb20">
                            ...
                            <div class="col-xs-6 col-sm-12"><?= ($model->bkg_verification_code != '') ? $model->bkg_verification_code : "&nbsp;" ?></div>
                        </div>
                    </div>
        ...
        <div class="col-xs-12">
            <div class="form-group mt20 mb20">
                <div class = "col-xs-12 p0">
                    ...
                    <a href="/<?= $model->bkg_file_path ?>" target="_blank">File</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function accountFlag1(flag = '') {
        booking_id = '<?= $model->bkg_id ?>';
        $href = "<?= Yii::app()->createUrl('rcsr/booking/accountflag') ?>";
        jQuery.ajax({type: 'GET',
            url: $href,
            dataType: 'json',
