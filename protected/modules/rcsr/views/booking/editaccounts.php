...
<div class="row">
    <div class="col-xs-12">
        <div style="width: 100%; padding: 3px; border-radius: 5px; -moz-border-radius: 5px; border: 1px #aaa solid;color: #444;">
            <div class="row ">
                <div class="col-xs-12">
                    <div class="col-xs-offset-4 col-sm-offset-8  col-xs-4 col-sm-2 text-right" >
                        <a class="btn btn-primary btn-sm" id="setFlag" onclick="addRefund()" title="Add Refund" style="">Add Refund</a>    
                    </div>
                    <div class="col-xs-4 col-sm-2  text-right pr5" >
                        <a class="btn btn-info btn-sm" id="bkg_acct" onclick="addTransaction()" title="Add Transaction" style="">Add Transaction</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="panel-body panel-body panel-no-padding pb0">
                        ...
                        <div class="row">
                            <div class="col-xs-offset-1 pt15 <?= $colclass2 ?> text-danger">
                                <?= $model->bkg_total_amount ?>
                            </div>
                            <div class="pt15  <?= $colclass1 ?> text-danger">
                                <?= $model->bkg_trip_distance ?>
                            </div>
                            <div class="pt15  <?= $colclass1 ?> text-danger">
                                <?= $model->bkg_gozo_amount ?>
                            </div>
                            <div class="pt15  <?= $colclass1 ?> text-danger">
                                <?= $model->bkg_vendor_amount ?>
                            </div>
                            <div class="pt15  <?= $colclass1 ?> text-danger">
                                <?= $model->bkg_advance_amount ?>
                            </div>
                            <div class="pt15  <?= $colclass1 ?> text-danger">
                                <?= $model->bkg_vendor_collected ?>
                            </div>
                            <div class="pt15  <?= $colclass1 ?> text-danger">
                                <?
                                if ($model->bkg_agent_id > 0)
                                {
                                    ?>
                                    <?= $model->bkg_corporate_credit ?>
                                    <?
                                }
                                else
                                {
                                    ?>
                                    <?= $model->bkg_credits_used ?>
                                <? } ?>

                            </div>
                            <div class="pt15  <?= $colclass1 ?> bg bg-warning">
                                <?= ( $model->bkg_due_amount != 0) ? -1 * $model->bkg_due_amount : 0 ?>
                            </div>
                            <div class="pt15  <?= $colclass1 ?> bg bg-warning">
                                <span id="final_gozo_due_txt"><?= $model->bkg_gozo_due ?></span>
                            </div>
                            <div class="pt15  <?= $colclass1 ?> bg bg-warning">
                                <span id="final_vendor_due_txt_old"><?= $model->bkg_vendor_due ?></span>
                            </div>
                        </div>
                        ...
                        <div class="row mt20">
                            ...
                            <div class="<?= $colclass2 ?>">
                                <?= $form->textFieldGroup($model, 'bkg_base_amount', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => 'Base Amount', 'readonly' => 'readonly')))) ?>
                            </div>
                        </div>
                        ...
                        <div class="row mt20">
                            ...
                            <div class="<?= $colclass2 ?>">
                                <?= $form->textFieldGroup($model, 'bkg_discount_amount', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => 'Discount',)))) ?>
                            </div>
                            <div class="<?= $colclass2 ?>">
                        ...
                        <div class="row mt20">
                            ...
                            <div class="<?= $colclass2 ?>">
                                <?= $form->textFieldGroup($model, 'bkg_refund_amount', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => 'Refund', 'readonly' => 'readonly')))) ?>
                            </div>
                        ...
                        <div class="row mt20">
                            ...
                            <div class="<?= $colclass2 ?>">
                                <?= $form->textFieldGroup($model, 'bkg_driver_allowance_amount', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => 'Driver Allowance')))) ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="p15 <?= $colclass2 ?> bg bg-success  font-bold">
                            ...
                            <div class="<?= $colclass2 ?>">
                                <?= $form->textFieldGroup($model, 'bkg_additional_charge', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => 'Additional Charge',)))) ?>
                            </div>
                            <div class="<?= $colclass2 ?>">
                                <?= $form->textFieldGroup($model, 'bkg_additional_charge_remark', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => 'Enter Additional Charge Remark',)))) ?>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="<?= $colclass2 ?>">
                                <?= $form->textFieldGroup($model, 'bkg_convenience_charge', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => 'COD Charge',)))) ?>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="<?= $colclass2 ?>">
                                <?= $form->textFieldGroup($model, 'bkg_extra_km_charge', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => 'Extra KM Charge',)))) ?>
                            </div>
                            <div class="<?= $colclass2 ?>">
                                <?= $form->textFieldGroup($model, 'bkg_extra_km', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => 'Extra KM',)))) ?>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="<?= $colclass2 ?>">
                                <?= $form->textFieldGroup($model, 'bkg_toll_tax', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => 'Toll Tax',)))) ?>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="<?= $colclass2 ?>">
                                <?= $form->textFieldGroup($model, 'bkg_state_tax', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => 'State Tax',)))) ?>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="<?= $colclass2 ?>">
                                <?= $form->textFieldGroup($model, 'bkg_extra_state_tax', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => 'Extra State Tax',)))) ?>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="<?= $colclass2 ?>">
                                <?= $form->textFieldGroup($model, 'bkg_extra_toll_tax', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => 'Extra Toll Tax',)))) ?>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="<?= $colclass2 ?>">
                                <?= $form->textFieldGroup($model, 'bkg_parking_charge', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => 'Extra Parking Tax',)))) ?>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-offset-1 <?= $colclass2 ?> ">
                                <?= $form->textFieldGroup($model, 'bkg_total_amount', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => '', 'readonly' => 'readonly')))) ?>
                            </div>
                            <div class="<?= $colclass1 ?>">
                                <?= $form->textFieldGroup($model, 'bkg_trip_distance', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => '',)))) ?>
                            </div>
                            <div class="<?= $colclass1 ?>">
                                <?= $form->textFieldGroup($model, 'bkg_gozo_amount', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => '',)))) ?>
                            </div>
                            <div class="<?= $colclass1 ?>">
                                <?= $form->textFieldGroup($model, 'bkg_vendor_amount', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => '',) + $readonly))) ?>
                            </div>
                            <div class="<?= $colclass1 ?>">
                                <?= $form->textFieldGroup($model, 'bkg_advance_amount', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => '', 'readonly' => 'readonly')))) ?>
                            </div>
                            <div class="<?= $colclass1 ?>">
                                <?= $form->textFieldGroup($model, 'bkg_vendor_collected', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => '',)))) ?>
                            </div>
                            <div class="<?= $colclass1 ?>">
                                <?
                                if ($model->bkg_agent_id > 0)
                                {
                                    ?>
                                    <?= $form->textFieldGroup($model, 'bkg_corporate_credit', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => '', 'readonly' => 'readonly')))) ?>
                                    <?
                                }
                                else
                                {
                                    ?>
                                    <?= $form->textFieldGroup($model, 'bkg_credits_used', array('label' => '', 'widgetOptions' => array('htmlOptions' => array('placeholder' => '', 'readonly' => 'readonly')))) ?>
                                <? } ?>
                            </div>
                            <div class="pt15 <?= $colclass1 ?>  bg bg-warning" id="final_amount_due">
                                <span id="final_amount_due_txt"><?= ( $model->bkg_due_amount != 0) ? -1 * $model->bkg_due_amount : 0 ?></span>
                            </div>
                            <div class="pt15 <?= $colclass1 ?>  bg bg-warning" id='final_gozo_due'>
                                <span id="final_gozo_due_txt"><?= $model->bkg_gozo_due ?></span>
                            </div>
                            <div class="pt15 <?= $colclass1 ?> bg bg-warning " id='final_vendor_due'>
                                <span id="final_vendor_due_txt"><?= $model->bkg_vendor_due  ?></span>
                            </div>
                        </div>
...
<script type="text/javascript">
    bkgbase = parseInt(<?= $model->bkg_base_amount ?>);
    var $oldrfnamt = parseInt(<?= $model->bkg_refund_amount ?>);
    var acctbox;
    var $totBkgAmt = 0;
    var $taxRate = parseInt(<?= $model->bkg_service_tax_rate ?>);
    ...
    $('#Booking_bkg_total_amount').change(function () {
        calculateDueAmounts();
    ...
    $('#Booking_bkg_gozo_amount').change(function () {
    ...
    $('#Booking_bkg_vendor_amount').change(function () {
    ...
    $('#Booking_bkg_advance_amount').change(function () {
    ...
    $('#Booking_bkg_vendor_collected').change(function () {
    ...
    $('#Booking_bkg_extra_km_charge').change(function () {
        calculateDueAmounts();
    });

    $('#Booking_bkg_extra_km').change(function () {
    ...
    $('#Booking_bkg_toll_tax').change(function () {
        bkAccounts.populateTotalAmount();
    });
    $('#Booking_bkg_state_tax').change(function () {
        calculateDueAmounts();
    });
    ...
    $('#Booking_bkg_parking_charge').change(function () {
        calculateDueAmounts();
    });
    $('#Booking_bkg_additional_charge_remark').change(function () {
        var $addamt = parseInt($('#Booking_bkg_additional_charge').val());

        if ($addamt != '' && $('#Booking_bkg_additional_charge_remark').val() == '') {
    ...
    $('#Booking_bkg_discount_amount_remark').change(function () {
        var $addamt = parseInt($('#Booking_bkg_discount_amount').val());
    ...
    function checkValidation() {
        ...
        var $rfndamt = parseInt($('#Booking_bkg_refund_amount').val());
        var $oldrfnamt = parseInt(<?= $model->bkg_refund_amount ?>);
        ...
        var $addamt = parseInt($('#Booking_bkg_additional_charge').val());
        var $oldaddamt = parseInt(<?= $model->bkg_additional_charge ?>);
        if ($addamt != $oldaddamt && $('#Booking_bkg_additional_charge_remark').val() == '') {
            $('#additional_charge_remark_err').show();
            return false;
        }
