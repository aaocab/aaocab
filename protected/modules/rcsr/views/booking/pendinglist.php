		...
		'filter' => $model,
                ...
                'columns' => array(
                    array('name' => 'bkg_bcb_id',
                        'value' => function($data) {
                            echo CHtml::link($data['bkg_bcb_id'], Yii::app()->createUrl("rcsr/booking/triprelatedbooking", ["tid" => $data['bkg_bcb_id']]), ["class" => "viewRelatedBooking", "onclick" => "return viewList(this)"]);
                        },
                                'sortable' => true, 'headerHtmlOptions' => array(), 'header' => 'Trip Id','filter' => false),
                            array('name' => 'bkg_booking_id',
                                'value' => function($data) {
                                    echo CHtml::link($data['bkg_booking_id'], Yii::app()->createUrl("rcsr/booking/view", ["id" => $data['bkg_id']]), ["class" => "viewBooking", "onclick" => "return viewList(this)"]);
                                },
                                    ...
                                    array('name' => 'bkg_vendor_name', 'value' => '$data["vnd_owner"]', 'sortable' => true, 'headerHtmlOptions' => array(), 'header' => 'Vendor Name'),
                                    ...
                                    array(
                                        ...
                                        'buttons' => array(
                                            'edit' => array(
                                                'url' => 'Yii::app()->createUrl("rcsr/booking/pendingaction", array(\'id\' => $data["bkg_id"]))',
                                            ...
                                            'cancel' => array(
                                                'url' => 'Yii::app()->createUrl("rcsr/booking/cancelPendingBooking", array(\'id\' => $data["bkg_id"]))',
