                ...
                <div class="panel-body panel-body panel-no-padding">
                    <div class="panel-scroll">
                        <div class="row">
                            <div class="col-xs-12">
								...
								$form = $this->beginWidget('booster.widgets.TbActiveForm', array(
									'id'					 => 'reset-user-form', 'enableClientValidation' => true,
									'clientOptions'			 => array(
                        ...
                        if(!hasError){
                            $.ajax({
                            "type":"POST",
                            "url":"' . CHtml::normalizeUrl(Yii::app()->createUrl('admin/user/resetmarkedbad', ['refId' => $refId])) . '",
                            "data":form.serialize(),
							"dataType": "json",
                                ...
                                <div class="form-group">
									...
									<?=
									$form->textAreaGroup($usrModel, 'usr_reset_desc', array('label'			 => '',
										'widgetOptions'	 => [
