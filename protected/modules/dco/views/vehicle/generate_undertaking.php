...
<div class="main-div">
	...
	<table width="100%" class="tb_cfont">
		<tr>
			...
			<td width="40%" valign="top">
				<p>Date: <?= date("d/m/Y", strtotime($data['vvhc_lou_approve_date'])); ?></p>
			</td>
		</tr>
	</table>
	<p>&nbsp;</p>
	...
	<ul>
		<li>I am authorized to operate motor vehicle bearing the following details –<br>
			Registration Number <span class="ownerTxt"><?= $data['vhc_number']; ?></span> </li>
		<li>The vehicle is owned by <span class="ownerTxt"> <?= ($data['vhc_owner'] != '') ? $data['vhc_owner'] : '______________________________'; ?> </span>,
		...
		<li>And I am authorized by the Vehicle owner to operate this vehicle until<br>
			Day: <span class="ownerTxt"><?= ($data['vvhc_vhc_owner_auth_valid_date'] != '') ? date('d', strtotime($data['vvhc_vhc_owner_auth_valid_date'])) : '____'; ?></span>
			Month: <span class="ownerTxt"><?= ($data['vvhc_vhc_owner_auth_valid_date'] != '') ? date('m', strtotime($data['vvhc_vhc_owner_auth_valid_date'])) : '____'; ?></span>
			Year: <span class="ownerTxt"><?= ($data['vvhc_vhc_owner_auth_valid_date'] != '') ? date('Y', strtotime($data['vvhc_vhc_owner_auth_valid_date'])) : '________'; ?></span>
		</li>
	...
	{
		?>
		<p>Signed by <?= $data['vnd_owner']; ?>, <?php
			if ($data['vnd_company'] != "")
			{
				?><br>authorized signatory for and on behalf
				of <?=
				$data['vnd_company'];
			}
			?></p>
