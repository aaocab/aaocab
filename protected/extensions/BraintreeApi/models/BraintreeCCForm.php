...
class BraintreeCCForm extends CFormModel {
    ...
    public function rules() {
        return array(
            ...
            array('creditCard_name,creditCard_number,amount,
                 creditCard_cvv,creditCard_month,creditCard_year', 'required', 'on' => 'custom'),
            array('amount', 'required', 'on' => 'charge'),
            array('amount', 'numerical'),
            array('customer_email', 'email'),
            array('descriptor, creditCard_number,
				creditCard_cvv, creditCard_month,
				creditCard_year, creditCard_date,
				creditCard_name,
                customer_firstName,
                    customer_lastName,
                    customer_company,
