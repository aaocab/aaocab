...
class CCForm extends CWidget
{
	...
	public function init()
	{
		if (isset($this->fields))
			$this->fields_options = $this->fields;
	...
	{
		if (in_array('amount', $this->fields_options))
			$this->renderAmount();
		if (in_array('orderId', $this->fields_options))
			$this->renderOrderId();
		if (isset($this->fields_options['creditCard']))
			$this->renderCC();
		if (isset($this->fields_options['customer']))
			$this->renderCustomer();
		if (isset($this->fields_options['billing']))
			$this->renderBilling();
		if (isset($this->fields_options['shipping']))
			$this->renderShipping();
	}
	...
	{
		$label = ($this->label == '') ? 'Add Credit Card' : $this->label;
		echo "<div class='well'><h3>Add Credit Card</h3>";
		...
		if (in_array('number', $this->fields_options['creditCard']))
		{
			...
			echo "<div class='row control-group'>
                            ...
                            <div class='controls'>
                            <input type='text' size='20' maxlength='16' autocomplete='off' name='BraintreeCCForm[creditCard_number]' />
                            </div>
                        </div>";
		}
		if (in_array('cvv', $this->fields_options['creditCard']))
		{
			echo "<div class='row control-group'>
                            ...
                            <div class='controls'>
                            <input type='text' size='4' maxlength='4' autocomplete='off' name='BraintreeCCForm[creditCard_cvv]' />
                            </div>
                        </div>";
		}
		if (in_array('date', $this->fields_options['creditCard']))
		{
			...
			echo "<div class='row control-group'>
                            ...
                            <div class='controls'>
                            <input type='text' size='7' maxlength='7' autocomplete='off' name='BraintreeCCForm[creditCard_date]' />
                            </div>
                        </div>";
		}
		if (in_array('month', $this->fields_options['creditCard']) || in_array('year', $this->fields_options['creditCard']))
		{
			...
			echo "<div class='row control-group'>
                            <label class='control-label'>Expiration Date (MM/YYYY)</label>
                            <div class='controls'>
                            <input type='text' size='2' maxlength='2' autocomplete='off' name='BraintreeCCForm[creditCard_month]' />
                            /
                            <input type='text' size='4' maxlength='4' autocomplete='off' name='BraintreeCCForm[creditCard_year]' />
                            </div>
                        </div>";
		}
		echo "</div>";
