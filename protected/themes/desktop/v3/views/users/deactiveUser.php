...
.help-block{ color:#ff4243 !important;}
	...
	textarea{ font-family: 'Arial'; padding: 10px;}
	...
	<div>
		...
		<div style="min-height:100px">
			...
			<div style="margin-top: 15px;">
				<button type="submit" class="btn btn-primary" type="submit" value="Submit" tabindex="2" >Continue to Delete</button>
			</div>
		</div>
		<?php $this->endWidget(); ?>
	</div>
