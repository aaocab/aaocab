<div class="col-12 mb-1">Email ID <span style="color: #F00"> *</span> <a href="javascript:void(0);" onclick="addContact(1)" class="ml-1 btn btn-primary btn-sm round mb10 p5 pl10 pr10">Add new email</a><br></div>
<?php
