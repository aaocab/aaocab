...
//print_r($this->pageRequest->getEncrptedData());
?>
	<div class="form-group mt30 n"><a href="#" class="p10 pl0 color-black"><img src="/images/bxs-tachometer.svg" alt="img" width="14" height="14" onclick="return toggleSignin();"></a></div>
