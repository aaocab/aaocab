										...
										<div class="row">
											...
											<div class="col-12 col-xl-6">
												...
												<fieldset class="form-group position-relative">
													<?= $form->textField($model, 'bkg_user_name', ['placeholder' => "Enter first name", 'class' => 'form-control m0', 'id' => 'iconLeft', 'required' => true]) ?>
												</fieldset>
											</div>
											<div class="col-12 col-xl-6 mb-1">
												...
												<fieldset class="form-group position-relative">
													<?= $form->textField($model, 'bkg_user_lname', ['placeholder' => "Enter last name", 'class' => 'form-control m0', 'id' => 'iconLeft', 'required' => true]) ?>
												</fieldset>
											</div>
