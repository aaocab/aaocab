...
<?php }?>
<ol class="p15">
	<li class="mb10">This offer is valid for trips booked directly with Gozo Cabs either by booking by phone with us, on aaocab.com or through our mobile app.</li>
	...
	<li class="mb10">This program does not apply to bookings that are generated from a third-party marketing affiliate or reseller partner of Gozo cabs. Only applies to bookings directly made on aaocab.com website or mobile app or booked with us by directly by phone</li>
	<li class="mb10">In addition to the above terms, all standard Gozo terms and conditions as listed at www.aaocab.com/terms shall be applicable.</li>
	...
	<li class="mb10">In the scenario where Gozo’s car is a no-show, customer must inform via an email immediately to info@aaocab.com (will auto-reply with a case #) or via a phone call or web chat and get a case # immediately. Double back offer cannot be honored in the case of car no-show complaints unless a support case # was created and it is agreed between Gozo and customer in writing via an email or other instrument that the vehicle was not available for service.</li>
