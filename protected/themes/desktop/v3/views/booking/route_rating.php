<div class="container">
<div class="row">
<div class="col-12 merriw heading-line text-center"><?php echo $this->pageTitle; ?></div>
</div>
</div>
							...
							<div class="row">								
								...
								<div class="col-10 col-md-10">      
									...
									if ($rating_star > 0)
									{
										...
										{
											$strRating .= '<i class="fa fa-star warning font-12"></i>';
										}
										if ($data['rtg_customer_overall'] > $rating_star)
										{
											$strRating .= '<i class="fa fa-star-half warning"></i> ';
										}
									}
									$strRating .= '';
									?>                           
