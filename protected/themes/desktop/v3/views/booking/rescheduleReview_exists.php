<div class="">
	...
	<div class="row  mt10">
		...
		<div class="col-12  text-center mt10 mb15">
			<?php $payUrl = Yii::app()->createAbsoluteUrl("booking/paymentreview", ["id" => $newModel->bkg_id, "hash" => Yii::app()->shortHash->hash($newModel->bkg_id), 'minPayExtra' => $newModel->minPayExtra]); ?>
			<a href="<?=$payUrl?>"><div  class="btn btn-primary p5"  style="white-space: nowrap;"><?php echo ($newModel->minPayExtra > 0) ? "Proceed to pay " . Filter::moneyFormatter($newModel->minPayExtra) : "Proceed" ?></div></a>
		</div>
	</div>
