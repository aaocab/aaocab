...
.pstyle{ padding-left: 84px!important;}
</style>
<div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-6" style="display: none;">
                    ...
                    <div class="col-12 col-sm-12">   
                        <input type="text" value="<?= DateTimeFormat::DateTimeToDatePicker($model->bkg_pickup_date) ?>" name="Booking[bkg_pickup_date_date]" id="Booking_bkg_pickup_date_date">	
				        <input type="text" value="<?= date('h:i A', strtotime($model->bkg_pickup_date)) ?>" name="Booking[bkg_pickup_date_time]" id="Booking_bkg_pickup_date_time">	
                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 mb15">
                        ...
                        <div class="form-group">   
                                ...
                                $this->widget('ext.intlphoneinput.IntlPhoneInput', array(
                                    ...
                                    'htmlOptions' => ['class' => 'yii-selectize selectized form-control pstyle', 'id' => 'fullContactNumber' . $id],
