			...
			<div class="col-12 col-xl-9 mt-1">
                <div class="card">
                    ...
                    <div class="card-body p15 radio-style6">
							...
							else
							{
								...
								<div class="row mb-3">
									<div class="col-12 col-md-4 col-lg-3">
										<div class="widget-content-box">
											<div class="radio mt-1">
												<input type="radio" name="btnPriceHigh" id="btnPriceHigh" value="0" class="bkg_user_trip_type" onClick="openReconfirmBox(1)" <?php if($_POST['type']==1 || $reasonId == 1){ echo 'checked="true"'; }?>>
												<label for="btnPriceHigh"></label>
												<input type="hidden" id="contenttype" value="61">
												<div class="mb-0 label-text-2 weight500">The quoted price was too high</div>
											</div>
										</div>
									</div>
									<div class="col-12 col-md-4 col-lg-3">
										<div class="widget-content-box">
											<div class="radio mt-1">
												<input type="radio" name="btnWasConfused" id="btnWasConfused" value="0" class="bkg_user_trip_type" onClick="openReconfirmBox(4)" <?php if($_POST['type']==4 || $reasonId == 4){ echo 'checked="true"'; }?>>

												<label for="btnWasConfused"></label>
												<input type="hidden" id="contenttype" value="61">
												<div class="mb-0 label-text-2 weight500">I have special requirements and need a specialist to call me</div>
											</div>
										</div>
									</div>
									<div class="col-12 col-md-4 col-lg-4">
										<div class="widget-content-box">
											<div class="radio mt-1">
												<input type="radio" name="btnLooking" id="btnLooking" value="0" class="bkg_user_trip_type" onClick="openReconfirmBox(2)" <?php if($_POST['type']==2 || $reasonId == 2){ echo 'checked="true"'; }?>>

												<label for="btnLooking"></label>
												<input type="hidden" id="contenttype" value="61">
												<div class="mb-0 label-text-2 weight500">I was having technical issues with the gozo platform</div>
											</div>
										</div>
									</div>
									<div class="col-12 col-md-4 col-lg-2">
										<div class="widget-content-box">
											<div class="radio mt-1">
												<input type="radio" name="btnOther" id="btnOther" value="0" class="bkg_user_trip_type" onClick="openReconfirmBox(3)" <?php if($_POST['type']==3 || $reasonId == 3){ echo 'checked="true"'; }?>>

												<label for="btnOther"></label>
												<input type="hidden" id="contenttype" value="61">
												<div class="mb-0 label-text-2 weight500">Other</div>
											</div>
										</div>
									</div>
								</div>
						...
						<?= CHtml::hiddenField('userid',$userId); ?>
						<?php $this->endWidget(); ?>
					</div>
				</div>
			</div>
...
<script>
    $(document).ready(function ()
    {
		...
		hideBlocks(); 
		var lfuId = '<?= $model3->lfu_id  ?>';
		var reasonid =  parseInt('<?= $reasonId ?>');
		if(lfuId == '')
		{	
			switch (reasonid)
			{
