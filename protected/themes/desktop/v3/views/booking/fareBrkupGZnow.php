...
<div class="invoice-subtotal">
	<div class="invoice-calc d-flex justify-content-between"><span>Base Fare:</span> <span><?php echo Filter::moneyFormatter($objFare->minBaseFare) . ' - ' . Filter::moneyFormatter($objFare->maxBaseFare); ?></span></div>
...
<hr class="mt5 mb5">
	<div class="invoice-calc d-flex justify-content-between weight300 font-13 text-nowrap">Total Payable:</span><span><?php echo Filter::moneyFormatter($objFare->minTotalAmount) . ' - ' . Filter::moneyFormatter($objFare->maxTotalAmount); ?></span></div>
