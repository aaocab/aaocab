...
?>
<div class="row"><div class="col-12 text-center mt-2"><p class="heading-inner merriw mb20"><b>Become a Gozo's reseller. Join Gozo's travel partner family..</b></p></div></div>
<div class="row justify-center ml0 mr0 mb-3">
...
<div class="card bg-authentication mb-0">
	    <div class="row m0">
			...
			<? } ?>
			<div class="col-12" style="color:#008a00;text-align: center">
			...
			<div id="AgentInnerDiv" style="display: <?= $showdiv ?>">
				...
				<div class="col-12 ">
				    <div class="form-group">
					<label for="city">Select City in which your business is located</label>
					<?php
...
<?= CHtml::submitButton('Become a reseller', ['class' => "btn btn-md btn-primary text-uppercase hvr-push", 'name' => 'submit']) ?>
				</div>
			    </div>
			</div>
		    </div></div>
                <div class="col-12 col-lg-7 p0 ul-style-c">
                    <div class="p20">
		    <p class="font-18 merriw"><b>Gozo Travel partner program</b></p>
		    ...
		    <p class="font-18 merriw"><b>Benefits of joining Gozo's Travel network…</b></p>
		    <div>
			<ul class="p0">
			    <li><img src="/images/bx-right-arrow-circle.svg" alt="img" width="14" height="14" class="mr10">Get direct access to India's largest network of intercity AC Taxi</li>
			    <li><img src="/images/bx-right-arrow-circle.svg" alt="img" width="14" height="14" class="mr10">Offer convenience of outstation taxi bookings to your customers</li>
			    <li><img src="/images/bx-right-arrow-circle.svg" alt="img" width="14" height="14" class="mr10">Buy bookings at very low pricing - and sell them to create profits</li>
			    <li><img src="/images/bx-right-arrow-circle.svg" alt="img" width="14" height="14" class="mr10">Easily create pre-paid or post-paid bookings using our kiosk</li>
			    <li><img src="/images/bx-right-arrow-circle.svg" alt="img" width="14" height="14" class="mr10">Get 24x7 support from our travel desk & service center</li>
			    <li><img src="/images/bx-right-arrow-circle.svg" alt="img" width="14" height="14" class="mr10">Just like our other partners you can generate business of Rs. 50,000 to Rs. 1Lac every month</li>                                    
			</ul>
		    </div>

		    <p class="mt0 font-18 merriw"><b>Any questions? Contact our Travel Partner team</b></p>
...
<!--		    <p class="mt0 font-18 merriw"><b>DCO's and Taxi Operators... <a href="http://www.gozocabs.com/vendor/join" class="color-blue">Attach your taxi here</a></b></p>-->
