...
<p><img src="/images/img-2022/icon24.png" class="mb10" alt="Join US as an AGENT" title="Join US as an AGENT"><br>If you will create bookings <br> for GOZO  <strong>Join US as an AGENT</strong> <br><br/> यदि आप Gozo के लिए बुकिंग बनाएंगे <br> तो एक एजेंट (booking agent) के रूप में हमसे जुड़ें </p>
        ...
        <div id="info">
            <div align="center">
<!--                <br><br/><p><img src="/images/bx-paper-plane.svg" alt="img" width="20" height="20" class="mb10"> <a href="https://t.me/aaocab" target="_blank" style="color:#000;"> Join the aaocab channel on telegram. All drivers are welcome to the aaocab telegram. We provide bookings to registered drivers on telegram too.</a></p>-->
				<br>            
			</div>
        </div>
        <div class="clear"></div>
