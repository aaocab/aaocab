...
<!--					<li class="nav-item  hide "><a id="contactus" href="javascript:void(0)" >Contact</a></li>-->
<li class="nav-item dropdown" id="navbar_sign">
						<?php
						$this->renderDynamic('renderPartial',"application.themes.desktop.v2.views.index.navbarcontact", [], true);
						?>
                    </li>
                    <li class="nav-item dropdown" id="navbar_sign">
						<?php
						$this->renderDynamic('renderPartial',"application.themes.desktop.v2.views.users.navbarsign", [], true);
						?>
                    </li>
                </ul>
            </div>
            ...
            <div class="row search-panel">
                <div class="col-12 text-center">
                    <ul class="nav text-uppercase">
                        <li class="otrip"><a href="#menu4" class="full-width active" data-toggle="tab">One-way</a></li>
<!--<li class="p0 text-center ostrip"><a href="#menu4" class="full-width  " data-toggle="tab">One-way<br><span class="search-sub-text">SHARED CAB</span></a></li>-->
                        ...
                        <li class="mtrip"><a href="#menu6" class="search-pad  " data-toggle="tab">Round Trip OR Multi Way </a></li>
                        <li class="ttrip" style="white-space: nowrap"><a href="#menu7" class="search-pad  " data-toggle="tab">Airport Transfer</a></li>
                        <li class="ptrip" style="white-space: nowrap"><a href="#menu8" class="search-pad  " data-toggle="tab">Tour Packages</a></li>
                        <li class="drtrip" style="white-space: nowrap"><a href="#menu10" class="search-pad  " data-toggle="tab">Day Rental</a></li>
                    </ul>
...
//										$minDate		 = date('Y-m-d H:i:s ', strtotime('+4 hour'));
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <label class="text-uppercase mb0">Journey Time</label>
                            ...
                            <div class="col-12 col-lg-2 mt15 pb20 mt15 text-right">
								<input type="hidden" name="step" value="5"/>
                                <button type="submit" class="btn-orange"><span>proceed </span></button>
                            </div>
                        </div>
						<?php $this->endWidget(); ?>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-5 mt15 text-right">
											<button type="submit" class="btn-orange"><b>Add more city</b></button>
										</div>
                                        <div class="clear"></div>
                                    </div>
                                </div>
...
//										));
                                    ...
                                    <div class="col-12 col-sm-4 col-lg-4 form-group-1" >
										<div class="row">
											<label  id="dlabel" class="text-uppercase col-12">To Address</label>
											<div class="col-12">										
												<?php
												$this->widget('application.widgets.SelectAddressV2', array(
													'model'			 => $brtModel,
													"htmlOptions"	 => ["class" => "form-control border rounded p10 text-left SelectAddressV2 item", "id" => $acWidgetId] + ['platform' => 0],
													'attribute'		 => "place",
													'widgetId'		 => $acWidgetId,
...
<div class="modal full-screen" id="myAddressModal1">
		<div class="modal-dialog">
                ...
                <div class="modal-body1 p15">
                            ...
                            <div class="col-12 col-sm-8 col-lg-4">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 col-md-4 pl0 mt15 text-right">
                                        <button type="button" id="btnTransfer" class="btn-orange"><b>proceed</b></button>
                                    </div>
                                </div>
                            </div>
                        </div>
			...
			return '<div>' +'<span class=\"\">' + escape(data.text) + '</span></div>';
                                ...
                                <div class="col-2 text-right mt15 pr0"><input type="submit" class="btn-orange" value="PROCEED"></div>
                            </div>
							<?php $this->endWidget(); ?>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane" id="menu10">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-2 mt15  pb20 text-right">
								<input type="hidden" name="step" value="5"/>
                                <button type="button" class="btn-orange" id="dayrentalbtn"><span>proceed </span></button>
                            </div>
                        </div>
						<?php $this->endWidget(); ?>
                    </div>
    ...
    <div class="container carousel_area p0">
        <div id="style2c_wrapper">
            <div id="style2c" class="style2c" style="overflow: hidden; width: 876px; visibility: visible; position: relative; left: 0px;">
                <div class="previous_button1"></div>
                ...
                <ul style="width: 3504px; left: -584px; margin: 0px; padding: 0px; position: relative; list-style-type: none; z-index: 101;">
					...
					foreach ($rows as $row)
					{
						...
						{
							?>
							<li style="width: 368px; height: 240px; overflow: visible; float: left;" class="">
								<div class="slider-text-panel">
									<div class="slider-text-panelimg">
										<figure>
											<?php
											if ($i == 2)
											{
											...
											{
												?>
												<a href="https://bit.ly/ReviewGozoOnTripAdvisor"><img data-src="/images/reviews/<?php print('0' . $i) ?>.png?v=2.08" alt="img" class="lozad" width="368" height="210"></a>
												<?php
											}
											else if ($i == 8)
											{
												?>
												<a href="/voucher"><img data-src="/images/reviews/<?php print('0' . $i) ?>.png?v=2.07" alt="img" class="lozad" width="368" height="210"></a>
												<?php
											}
											else if ($i == 4)
											{
												?>
												<a href="/flashsale"><img data-src="/images/reviews/<?php print('0' . $i) ?>.png?v=2.07" alt="Flash sale upto 70% off" class="lozad" width="368" height="210"></a>
												<?php
											}
											else
											{
												?>
												<img data-src="/images/reviews/<?php ($i >= 10 ? print($i) : print('0' . $i)) ?>.png?v=2.08" alt="img" class="lozad" width="368" height="210">
											<?php } ?>
										</figure>
									</div>
								</div>
						...
						{
							?>
							<li style="width: 368px; height: 230px; overflow: visible; float: left;">
								<div class="slider-text-panel">
									<div class="slider-text-paneltext">
										<div class="text-center">
											<?php
											for ($j = 0; $j < $row['rtg_customer_overall']; $j++)
											{
												?>
												<img src="/images/star-green.png" width="24" height="24" alt="Review">
											<?php } ?>
										</div>
										<div class="row">
											<div class="col-12 mt10 text-center font-13"><?= $row['rtg_customer_review'] ?></div>

											<div class="col-12">
												<div class="row mt20">
													<div class="col-3"><span class="round-part"><?= $row['initial'] ?></span></div>
													<div class="col-9 pl0 font-11">
														<span class="font-11"><b><i><?= $row['user_name'] ?> </i></b></span>
														<span class="font-10"><?= date('jS M Y', strtotime($row['rtg_customer_date'])) ?></span><br>
														<span><?= $row['cities'] . ', ' . Booking::model()->getBookingType($row['bkg_booking_type']); ?></span></div>
												</div>
											</div>
										</div>
									</div>
							...
							?>
							<li><a href="https://bit.ly/ReviewGozoOnGoogle"><img data-src="/images/reviews/10.png?v=2.08" alt="img" width="368" height="210" class="lozad"></a></li>
						</ul>
