<div class="row">
    <div class="col-12 bg-black mb30 p0 text-center">
        <img src="/images/price-guarantee.jpg?v=0.5" alt="" class="img-fluid">
    </div>
</div>

<div class="container">
<div class="row">
    <div class="col-12 mt10 mb30 ul-style-c">
		<h1 class="font-22"><b>Power your travel desk with Gozo ©</b></h1>
		...
		<br><br>
		<h2 class="font-22"><b>Benefits of being a Gozo travel partner</b></h2>
		<ul>
			<li><i class="fas fa-check-circle mr10 color-green"></i>Leverage our nationwide network across 1000+ cities for airport transfers or outstation road transportation.</li>
			<li><i class="fas fa-check-circle mr10 color-green"></i>Your reception can create reservations without hassle. Gozo's 24x7 helpdesk is available to support you.</li>
