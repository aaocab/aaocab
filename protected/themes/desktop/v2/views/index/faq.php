        ...
        <div class="col-12">
            <div class="ul-style-2">
                ...
                <ul>
                    ...
                    <li><a href="#faq52">I see there are some bad reviews for aaocab online. Why is that?</a></li>
                    <li><a href="#faq54">Whats the best way to contact Gozo Cabs?</a></li>
                </ul>
            ...
            <ol>
                ...
                <li>
                    ...
                    <p>Please make sure your correct email and mobile phone information is entered under <a href="http://www.aaocab.com/index" target="_blank">your profile on aaocab</a></p>
                </li>
                <a name="faq11"></a>
                <li>
                ...
                <li>
                    ...
                    <p>Please write to us at <a href="mailto:corporateaccounts@aaocab.in">corporateaccounts@aaocab.in</a></p>
                ...
                <li>
                    ...
                    <p>Get our app at <a href="https://play.google.com/store/apps/details?id=com.aaocab.client&hl=en" target="_blank">https://play.google.com/store/apps/details?id=com.aaocab.client&hl=en</a></p>
				...
				<a name="faq53"></a>
				<li>
					<h4 class="mt30"><b>Why has aaocab boycotted the use of MouthShut.com?</b></h4>
				...
				<a name="faq54"></a>
				<li>
					<h4 class="mt30"><b>Whats the best way to contact Gozo Cabs?</b></h4>
                                        <p class="mb0">For sales - Tap contact on <a href="http://www.aaocab.com/" target="_blank">aaocab.com</a> and request a callback</p>
                                        <p class="mb0">For support - visit <a href="https://support.aaocab.com/open.php?topicId=18" target="_blank">c.gozo.cab/help</a> or write to <a href="mailto:info@aaocab.com">info@aaocab.com</a></p>
                                        <p>While on the trip, you can directly chat with our team using the Gozo Cabs app</p>
                                        <p class="line-height14"><span class="color-gray">c.gozo.cab</span><br>
                                            <a href="https://support.aaocab.com/open.php?topicId=18" target="_blank"><b>Gozo Cabs | Helpdesk</b></a><br>customer support platform
