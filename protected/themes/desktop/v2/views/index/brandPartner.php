...
<div class="container">        
			...
			<div class="col-sm-4 text-center brand-partners">
				<div class="panel panel-default partner-b">
					<div class="p20 panel-body">
						<figure><a class="trigger" href="#" data-toggle="modal" data-target="#mobikwik"><img src="/images/partners-logo2.png?v=1" rel="nofollow" alt="" class="img-fluid mb20"></a></figure>
    ...
    <div class="row row inner-top-mune m0 mb20 bg-primary text-white pb10 pt10 mt20">
        <div class="col-12 h6 m0 text-uppercase">Offers</div>
    </div>
    <div class="row">
