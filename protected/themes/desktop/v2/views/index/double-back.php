<div class="row">
    <div class="col-12 bg-black mb30 p0 text-center">
        <img src="/images/doubleback.jpg?v=0.6" alt="" class="img-fluid">
    </div>
</div>
...
<div class="container">
	<div class="row">
	<div class="col-12 mt30 n text-center"><a class="btn text-uppercase gradient-green-blue font-20 border-none mt15" href="/" role="button">BOOK NOW</a></div>
	<div class="col-12 ul-style-d">
		<ol class="p15">
                <li>This offer is valid for trips booked directly with Gozo Cabs either by booking by phone with us, on <a href="#" class="color-blue">aaocab.com</a> or through our mobile app.
                ...
                <li>The DOUBLE BACK GUARANTEE will match up to ₹5000 to double the original amount that you paid in advance at the time of booking. Amount that we will refund as double against the advance will be made in the Gozo wallet and is subject to conditions.</li>
                ...
                <li>In the scenario where Gozo’s car is a no-show, customer must inform via an email immediately to info@aaocab.in (will auto-reply with a case #) or via a phone call or web chat and get a case # immediately. Double back offer cannot be honored in the case of car no-show complaints unless a support case # was created and it is agreed between Gozo and customer in writing via an email or other instrument that the vehicle was not available for service.</li>
		...
		<p class="text-center mb30"><a class="btn text-uppercase gradient-green-blue font-20 border-none mt15" href="/" role="button">BOOK NOW</a></p>
	</div>
	</div>
</div>
