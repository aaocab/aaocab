...
<div class="row mb30">
    <div class="col-12">
        <div class="bg-white-box">
            <div class="row">
                <!--        <div class="col-12 col-sm-8 col-md-8 float-none marginauto">
                            <div class="col-12 col-sm-6 pl20 pr20 ">
                                <div class="form-group">
                                    <label class="control-label" for="usr_name">Name</label>
				<? //= $form->textFieldGroup($model, 'usr_name', array('label' => '', 'class' => 'form-control border-radius'))  ?>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 pl20 pr20">
                                <div class="form-group">
                                    <label class="control-label" for="exampleInputCompany6">Last name</label>
    ...
    <div class="col-12">
        <div class="bg-white-box">
            ...
            <div class="row">
				...
				<div class="col-12 col-lg-8 mt20 text-right">
                    <div class="form-group">
                        <button type="submit" class="btn-orange pl30 pr30 ml0 mr0"  name="sub" value="Submit">Save</button>
                    </div>
                </div>
            </div>
        </div>
