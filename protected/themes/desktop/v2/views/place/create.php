        ...
        <div class="bg-white-box">
            ...
            <div class="row">
                <div class="col-12 col-lg-6">
					...
					<?php echo $form->error($model, 'name', ['class' => 'help-block error']); ?>
                    </div>
                </div>
                <div class="col-12">
                    <div class="row">
                        <div class="col-12 col-lg-4">
                           <div class="form-group">
                            <label class="control-label" for="UserPlaces_address1">Address</label>
                            <?= $form->textField($model, 'address1', ['required' => true,'class'=>'form-control','placeholder'=>'Address1', 'value' => $model->address1]) ?>
                            <?php echo $form->error($model, 'address1', ['class' => 'help-block error']); ?>
                            </div>
                        </div>
                        <div class="col-12 col-lg-4 mt30">
                           <div class="form-group">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <?php echo $form->error($model, 'zip', ['class' => 'help-block error']); ?>
                   </div>
                </div>
                <div class="col-12">
