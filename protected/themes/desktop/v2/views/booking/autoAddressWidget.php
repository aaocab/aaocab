...
<style type="text/css">
    ...
    .stop-menu .navbar-nav li a{
		font-size: 14px;
	}
    .stop-menu .navbar-nav li{
			...
			<div class ="row mt10">
				...
				<div class="col-12 mb15">
					<div class="row">
						...
						<div class="col-2"><span class="autoMarkerLoc <?= $locMarkerFrom ?>" data-lockey="<?= $key ?>" data-toggle="tooltip" data-original-title="Select source location on map"><img src="/images/locator_icon4.png" alt="Precise location" width="30" height="30"></span></div>
					</div>
				</div>                    
...
//			}
					...
					<div class="row">
						...
						<div class="col-12">
							<div class="row">
								...
								<div class="col-2"><span class="autoMarkerLoc <?= $locMarkerTo ?>" data-lockey="<?= $key1 ?>" data-toggle="tooltip" data-original-title="Select destination location on map"><img src="/images/locator_icon4.png" alt="Precise location" width="30" height="30"></span></div>
							</div>
						</div>
		...
		<div class="row">
			...
			{
				?>
				<div class="col-12 p0 booking-info  " id="cityCentreText" style="display: none">
	...
	<? } ?>
    <button type="button" id="saveAddreses" class="btn btn-effect-ripple btn-success p5" name="saveAddreses" onclick="saveAddresses();">Save Addresses</button>
</div>
<?php $this->endWidget(); ?>
