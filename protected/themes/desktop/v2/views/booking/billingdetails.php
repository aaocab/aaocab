...
<div>
	...
	<div class="col-12">
		<div class="row billinfo mb15" id="city_state">
			<div class="col-12 col-sm-6 mt5">
              <div class="m0 form-group">
				<label class="control-label" for="BookingUser_bkg_bill_state">State</label>
				<?= $form->textField($model->bkgUserInfo, 'bkg_bill_state',['class' => "devClass form-control m0",'placeholder' => "Billing State"]) ?>
                <?php echo $form->error($model->bkgUserInfo, 'bkg_bill_state',['class'=>'help-block error']);?>  
              </div>
			</div>	
			<div class="col-12 col-sm-6 mt5">
               <div class="m0 form-group">
				<label class="control-label" for="BookingUser_bkg_bill_city">City</label>
				<?= $form->textField($model->bkgUserInfo, 'bkg_bill_city', ['class' => "devClass form-control m0",'placeholder' => "Billing City"]) ?>
	...
	<div class="col-12">
		<div class="row mb15 billinfo" id="address_zip">
			...
			<div class="col-12 col-sm-6 mt5">
              <div class="m0 form-group">
				<label class="control-label" for="BookingUser_bkg_bill_postalcode">Postal Code</label>
				<?= $form->textField($model->bkgUserInfo, 'bkg_bill_postalcode', ['class' => "devClass form-control m0",'placeholder' => "Billing Postal code"]) ?>
