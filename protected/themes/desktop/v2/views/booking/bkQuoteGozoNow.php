...
<!--					<img src="/images/3.png?v=0.1" alt="" class="img-fluid">-->
            ...
            <div class="row">
				<span class="font-20 color-orange pt15 text-center">We need to check available inventory and pricing before we can serve your booking. Estimated marked price range are given</span>
                <div class="col-md-12">
                    <div id="error-border">
                        <div class="row mt20">
                                ...
                                <div class="row flex">
									...
									foreach ($classes as $class => $clsRank)
									{
										...
										<div class="<?= $classRatesCol ?>  eco-widget color-white bg-navy-<?= $class ?>">
											...
											<p class="text-center mb0 value-widget font-12"><?php $sccLabel = explode(",", $classInfo->scc_tag);
									echo $sccLabel[0]
										?><br><?= $sccLabel[1]; ?> </p>
								...
								<div class="col-lg-5 car-widteg-2 ul-style-b font-12">
									<ul>
										...
										<li><img src="/images/briefcase.svg" width="23" alt="Seats + Driver" class="mr5">
											<?= (($luggageCapacity->largeBag != 0) ? $luggageCapacity->largeBag . ' Big bag(s) /' : '') ?>
						...
						<div class="<?= $classCol ?> colClassRates mb15">
							<div class="row">
								...
								foreach ($classes as $class => $clsRank)
								{
									...
									$this->renderPartial("bkQuoteGozoNowTier", $arrTier, false, false);
								}
								?></div>
						</div>
					</div>
