...
?>
<div class="col-12 list-type-3 font-12 mt20">
    <div class="mb20" id="linkedusers">
        <div class="sidebar">
            <div class="sidenav">
                <button class="dropdown-btn">BOARDING CHECKS <i class="fa fa-caret-down"></i>
				</button>
            ...
            <div class="sidenav">
                <button class="dropdown-btn">ON TRIP DOs & DONTs <i class="fa fa-caret-down"></i>
				</button>
                <div class="dropdown-container" style="display: none;">
                    <div class="compact">
						<?php
            ...
            <div class="sidenav">
                <button class="dropdown-btn">OTHER TERMS <i class="fa fa-caret-down"></i>
				</button>
                <div class="dropdown-container" style="display: none;">
                    <div class="compact">
						<?php
...
/* $oneWayInfo = '<h3>Important Information: </h3>
  ...
  <li>Drivable (' . $bkg_trip_distance . ')  kms in your quote are estimates. You will be billed for the actual distance travelled by you. If you have not provided the exact address before your pickup or if the exact address could not be determined at time of providing you the booking amount estimate then your quote includes travel from city center to city center. Distance to be driven as quoted in the booking is only applicable for travel between the addresses, waypoints and locations as exactly specified in your itinerary.</li>
  ...
  <li>
  Customer agrees to raise complaints about service, if any, within 7days of completion of service. Our ability to address grievances shall be severely limited and only at a best effort basis, after 7days of completion of the trip.
  </li>
  </ol>';
  ...
  <li>
  <strong>15% of customers remaining payable amount </strong>shall be paid to the taxi operator while boarding the cab on the first day of trip
  </li>
  <li>
  <strong>Daily part payments:</strong> You are required to pay the remaining the amount in equal parts and is payable per day during your remaining days of the trip. The customer must settle all payment atleast 24hours last day of the trip or as requested by the taxi operator.
  </li>
  ...
  {
  $info = $oneWayInfo;
  if ($cab_type_id == VehicleCategory::SHARED_SEDAN_ECONOMIC)
  {
  $info = $flexxiInfo;
  }
  }
  ...
  if ($bookingtype == 2 || $bookingtype == 3|| $bookingtype == 9|| $bookingtype == 10|| $bookingtype == 11)
  {
