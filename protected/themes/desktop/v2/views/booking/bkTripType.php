...
<div class="row menuTripType">
	<div class="col-8 offset-2 bg-white-box">
		<div class="row trip_btn" data-toggle="buttons">
			<div class="col-sm-6 p5">
				<div class="button raised clickable <?= $arrActive[1] ?>">
					<input type="checkbox" class="toggle newtriptype" name="<?= $tripTypeElemName ?>" id="<?= $tripTypeElemId ?>_0" onclick="$jsBookNow.changeTripType(this)" value="1"> <div class="anim"></div><span>One way Trip</span>
				</div>
			</div>
			<div class="col-sm-6 p5">
				<div class="button raised clickable <?= $arrActive[3] ?>">
					<input type="checkbox" class="toggle newtriptype" name="<?= $tripTypeElemName ?>" id="<?= $tripTypeElemId ?>_2" onclick="$jsBookNow.changeTripType(this)" value="3"> <div class="anim"></div><span>Round Trip / Multi City</span>
				</div>
			</div>
			<div class="col-sm-6 p5">
				<div class="button raised clickable <?= $arrActive[4] ?>">
			...
			<div class="col-sm-6 p5">
				<div class="button raised clickable <?= $arrActive[7] ?>">
			...
			<div class="col-sm-6 p5">
				<div class="button raised clickable <?= $arrActive[9] ?>">
			...
			<div class="col-sm-6 p5">
				<div class="button raised clickable <?= $arrActive[5] ?>">
