...
?>
<div class="content-boxed-widget login-box-container">
    <div class="one-half"><span class="color-gray-dark">Trip ID:</span> <br><span class="label-orange font-16 color-white"><b><?= $cabModel->bcb_id ?></b></span></div>
    <div class="one-half last-column text-right"><span class="color-gray-dark">Amount To Collect:</span><br> <span class="font-18">&#x20B9;<b><?= round($model->bkgInvoice->bkg_due_amount) ?></b></span></div>
    <div class="clear"></div>       
        <?php
        foreach ($bModels as $bModel) {
            ...
            <div class="text-center mt20 mb20">
                <span style="color:red"><b> * Driver App must be used.<br>  <a href="#section2" class="btn-2 font-14">See Trip Rules</a></b></span>
                <?php
            ...
            <div class="content-boxed-widget login-box-container pb30">
                                <div class="font-18 mb10"><b>Customer Details:</b></div>
                                <?php
                                if ($bModel->bkg_status > 2) {
                                    if ($bModel->bkgTrack->btk_cust_details_viewed == 0) {
                                        ?>

                                      <div id="viewCustDetails"><a href="" class="btn btn-primary btn-sm mb5 mr5 color-white" onclick="viewCustomerContact(<?= $bModel->bkg_id ?>)" title="View Customer Details" style="">Click here to view Customer Details</a>
                                        </div>
                                        ...
                                        <div id="customerDetails">
                                            <div class="one-half mr10">
                                                <p class="line-height16 mb0 color-orange font-12">Full Name:</p>
                                                <p class="line-height16 mb0 font-14"><?= $bModel->bkgUserInfo->getUsername() ?></p>
                                            </div>
                                            <div class="one-half last-column">
                                                <p class="line-height16 mb0 color-orange font-12">Email:</p>
                                                <p class="line-height16 mb0 font-14"><?= $bModel->bkgUserInfo->bkg_user_email; ?></p>
                                            </div>
                                            <div class="clear"></div>  
                                            </div>
                                            <?php
                                            ...
                                            <div class="one-half last-column">
                                                <p class="line-height16 mb0 color-orange font-12">Primary Phone:</p>
                                                <p class="line-height16 mb0 font-14">+<?= $bModel->bkgUserInfo->bkg_country_code ?><?= $bModel->bkgUserInfo->bkg_contact_no ?></p>
                                            </div>
                                                <?php
                                            }
                                            if ($bModel->bkgUserInfo->bkg_alt_contact_no != '') {
                                                ...
                                                <div class="row">
                                                    <div class="col-12 summary-div" style="font-size:12px;">
                                                        <div class="col-12 col-sm-5"><b>Alternate Phone:</b></div>
                                                        <div class="col-12 col-sm-7">+<?= $bModel->bkgUserInfo->bkg_alt_country_code ?><?= $bModel->bkgUserInfo->bkg_alt_contact_no ?></div>
                                                    </div>
                                                </div>
                                                <?php
												}
            ...
            if (!empty($note)) {
                ...
                <div class="content-boxed-widget login-box-container">
                    <div class="font-16 color-white text-center p10" style="background: #0d4da7;"><b>Special instructions & advisories that may affect your planned travel</b></div>
            ...
            <div class="content-boxed-widget login-box-container">
                <div class="bg-white-box">
                    ...
                    $serviceVndDesc .= '</ol>';
                    ?>
			<div class="font-18 mb10 pl0"><b>Rental Details</b></div>
                        <div>
                            <p class="line-height16 mb0 color-orange font-12">Car Package For:</p>
                            <p class="line-height16 font-14 color-black mb20"><?php echo $ct ?></p>

                        </div>

                    <div>
                        <p class="line-height16 mb0 color-orange font-12">Cab type & Class:</p>
                        <p class="line-height16 font-14 color-black mb20"><?= $bModel->bkgSvcClassVhcCat->scc_VehicleCategory->vct_label . '('. $bModel->bkgSvcClassVhcCat->scc_ServiceClass->scc_label. ') - '.$bModel->bkgVehicleType->vht_make.' '.$bModel->bkgVehicleType->vht_model?>
							<?php 
                    ...
                    <div>
                        <p class="line-height16 mb0 color-orange font-12">Pickup Address:</p>
                        <p class="line-height16 font-14 color-black mb20"><a href="https://maps.google.com/?q=<?php echo $bModel->bookingRoutes[0]->brt_from_latitude . "," . $bModel->bookingRoutes[0]->brt_from_longitude; ?>" target="_blank"><?= $bModel->bkg_pickup_address; ?></a>
						</p>
                    </div>

                    <div>
                        <p class="line-height16 mb0 color-orange font-12">Final Drop Address:</p>
                        <p class="line-height16 font-14 color-black mb20">
                    ...
                    <div>
                        <p class="line-height16 mb0 color-orange font-12">Journey Type:</p>
                        <p class="line-height16 font-14 color-black mb20"><?= $bModel->getBookingType($bModel->bkg_booking_type); ?></p>
                    </div>

                    <div>
                        <p class="line-height16 mb0 color-orange font-12">Pickup  Date Time:</p>
                        <p class="line-height16 font-14 color-black mb20"><?= date('jS M Y (D) h:i A', strtotime($bModel->bkg_pickup_date)); ?></p>
                    </div>

                    <div>
                        <p class="line-height16 mb0 color-orange font-12">Kms Included:</div>
                        <p class="line-height16 font-14 color-black mb20"><?= $bModel->bkg_trip_distance; ?> km</p>
                    </div>

                    <div>
                        <p class="line-height16 mb0 color-orange font-12">Charges beyond <?= $bModel->bkg_trip_distance ?> Km:</p>
                        <p class="line-height16 font-14 color-black mb20"><?= $bModel->bkgInvoice->bkg_rate_per_km_extra; ?> / km</p>
                    </div>
				...
				?>
				<div>
                        <p class="line-height16 mb0 color-orange font-12">Included with quotation:</p>
                        <p class="line-height16 font-14 color-black mb20">
...
//						}
					...
					<div>
                        <p class="line-height16 mb0 color-orange font-12">Additional charges paid:</p>
                        <p class="line-height16 font-14 color-black mb20">
						<?php
						$splRequest = 0;
			...
			<div>
                        <p class="line-height16 mb0 color-orange font-12">Customer to pay separately:</p>
                        <p class="line-height16 font-14 mb0 color-black">
						<ul>
...
<!--
                    ...
                    ?>
					 <div>
                        <p class="line-height16 mb0 color-orange font-12">Number of Passengers:</p>
                        <p class="line-height16 font-14 color-black mb20"><?= ($bModel->bkgAddInfo->bkg_no_person == '') ? '0' : $bModel->bkgAddInfo->bkg_no_person; ?></p>
                    </div>

                    <div>
                        <p class="line-height16 mb0 color-orange font-12">Number of large suitcases:</p>
                        <p class="line-height16 font-14 color-black mb20"><?= $bModel->bkgAddInfo->bkg_num_large_bag; ?></p>
                    </div>

                    <div>
                        <p class="line-height16 mb0 color-orange font-12">Number of small bags:</p>
                        <p class="line-height16 font-14 color-black mb20"><?= $bModel->bkgAddInfo->bkg_num_small_bag; ?></p>
                    </div>

                </div>
			
				<div class="content-boxed-widget login-box-container">
						<div class="font-18 mb10 pl0"><b>Fare Details:</b></div>
				<!--<div class="row summary-div">
			...
			<?php
				...
				?>  
				<div>
				<p class="line-height16 mb0 color-orange font-12">Amount To Collect:</p>
				<p class="line-height16 font-18 color-black mb20">
                                    Rs.<span class="font-18"><b><?= round($bModel->bkgInvoice->bkg_due_amount) ?></b></span>
				</p>
				</div>
                ...
                <div class="content-boxed-widget login-box-container">
                    <div class="table-responsive">
                        <div class="font-18 mb10 pl0"><b>Booking Summary:</b></div>
...
<li>Driver must arrive at pickup location at least 15min before pickup time.</li>
		...
		<div class="col-12 col-sm-6"><?= $bModel->getFullInstructions(); ?></div>
	</div>
			</div>
        </div>
