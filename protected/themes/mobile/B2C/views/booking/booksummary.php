...
$this->renderPartial('bkSummary', array('isredirct'			 => true, 'model'				 => $model,
	...
	'refcode' => $refcode, 'walletBalance'		 => $walletBalance,'whatappShareLink' => $whatappShareLink,'applicableAddons' => $applicableAddons,'routeRatesArr' => $routeRatesArr), false, false);
 }
else
{
