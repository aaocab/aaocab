...
if ($quotes)
{
	...
	<div class="container top-10" id="p_clist">
		<div class="content-boxed-widget mb5 list-view-panel p0 hide">
			<div>
				<div>
		...
		<?php
		$this->renderPartial("bkRouteHeader" . $this->layoutSufix, ['prevStep' => 1, 'model' => $model, 'quoteModel' => $quoteModel]);
		?>   
		<?php
		...
		<div>
			...
			foreach ($categories as $category => $rank)
			{
				...
				<div class="content-padding content-boxed-widget mb0 pb0 p0 list-view-panel clsCategory<?php echo $category; ?>" style="overflow: hidden; position: relative;">
					...
					<div class="widget-price line-height14"><span class="bolder hide">&#x20B9;<?= $quote->routeRates->minTotalAmount . ' - &#x20B9;' . $quote->routeRates->maxTotalAmount ?></span></div>
				</div>
