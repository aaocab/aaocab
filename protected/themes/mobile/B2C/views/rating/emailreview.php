...
$bookingInfo = '<div class="panel-heading">
	<div class="content-boxed-widget pb5 bottom-20">
		<div class="col-12">
                <div class="mb30">
...
<div class="card card-red">
			<h1 class="color-white bolder center-text top-20">Your review link has been expired </h1>
		</div>
</div>
<?php
}
...
<div class="content-boxed-widget">
    <div id="section1">
        <div class="row title-widget mb20">
        ...
        if ($ifReviewExist) {
            ...
            <div class="bg-white-box mb20">
                <div class="text-center">
                    <img src="<?= Yii::app()->createAbsoluteUrl('images/email/local_rental/local_rental.png?v1.2') ?>" class="preload-image responsive-image bottom-5">
                </div>
            </div>

            <div class="content-boxed-widget pb5">
                <div class="bg-white-box mb30">
                    <div class="pb10 pt30 text-center"><span style="font-size: 18px;"><strong><?= $model->getAttributeLabel('rtg_customer_recommend') ?></strong></span></div>
                    ...
                    <div class="row">
                        <div class="col-4 col-sm-4 pb10 text-right"></div>
                    ...
                    <div id="otherrating">
                        ...
                        <div id="carRatingBox">
                            <div class="box-design1a pt0">
                                <div class="box-design1 border-new-b text-center"><b style="color: #008000;">What was good? <img src="/images/icon/happy-smiley.png" alt="" ></b></div>
                                <ul>
                                    <?php
                            ...
                            <div class="box-design2a pt0">

                                <div class="box-design2 border-new-b text-center"><b style="color: #DC143C;">What was not? <img src="/images/icon/sad-icon.png" alt="" ></b></div>
                                <ul>
                                    <?php
                    ...
                    <div>
                        <div class="top-10">Did you find website & app easy</div>
                        <div>
                            <label class="radio2-style mb5">
                        ...
                        <div>
                            <div class="form-group input-simple-1 textarea has-icon bottom-30">
                                <?= $form->textArea($model, 'rtg_platform_exp_cmt', array('class' => 'textarea-simple-1', 'placeholder' => 'Comments about our website & app')) ?>
                                <?php echo $form->error($model, 'rtg_platform_exp_cmt', ['class' => 'help-block error']); ?>
                            </div>
                            <div class="top-15 n color-gray">You have <span id="charleftcount4">1000 characters left.</span> (Maximum characters: 1000)</div>
                    ...
                    <div>
                        ...
                        <div>
                            <div class="form-group input-simple-1 textarea has-icon">
                                <?= $form->textArea($model, 'rtg_customer_review', array('class' => 'textarea-simple-1', 'placeholder' => 'Overall trip comments')) ?>
                                <?php echo $form->error($model, 'rtg_customer_review', ['class' => 'help-block error']); ?>
                            </div>
                            <div class="top-15 n color-gray">You have <span id="charleftcount">1000 characters left.</span> (Maximum characters: 1000)</div>
                        </div>
                        <div id="revErr" class="review">Please give your feedback.</div>
                        <div id="overErr" class="review">Max 1000 characters.</div>
                    </div> 

                    <div class="p15 mb50 pb30 text-center" id="DivSubmitRate">
                        <button class="uppercase btn-orange shadow-medium" type="submit" value="Rate" tabindex="2" >Submit Review</button>
                    </div>
		...
		<div class="content-boxed-widget" style="overflow: hidden;">
			<div style="border: #f36e32 10px solid; float: left;">
					<div class="text-center font-36 bg-orange color-white pb10" style="background: #f36e32; font-size: 36px; line-height: normal;"><b>Need a cab?</b></div>
					<div class="text-center font-10 weight500 pt5"><b>Chauffeur driven AC cabs at the best possible prices</b></div>
					<div class="text-center font-12 pt0" style="line-height: 16px;"><b>Local - Airport transfers & Daily rentals<br>
					...
					<div style="margin: auto; position: relative;" >
						...
						?>
						<a href="<?= Yii::app()->createAbsoluteUrl('/users/GetQRCode') ?>"><img src='<?= $path ?>' alt='' style='width: 2.5in; margin:auto;'/></a>
