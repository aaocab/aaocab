                            ...
                            <div class="form" >
                                ...
                                <div class="col-12" style="min-height:100px">
                                    <div class="form-group pt20 text-center">
                                        <div class="row">
                                            <div class="col-12 text-center pb10"><?= $model->getAttributeLabel('rtg_customer_recommend') ?></div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="form-group pt10">
                                        <div class="row">
                                        <div class="col-12 offset-md-3 col-md-9 pb10"><?= $model->getAttributeLabel('rtg_customer_overall') ?></div>
                                        <div class="col-12 col-md-6 offset-md-4 pb10">
                                            <?
                                            $this->widget('CStarRating', array(
                                                'model' => $model,
                                    ...
                                    <div id="otherrating">
                                        <div class="row pt10">
                                            <div class="col-6"><?= $model->getAttributeLabel('rtg_customer_driver') ?></div>
                                        ...
                                        <div class="row pt20">
                                            <div class="col-6"><?= $model->getAttributeLabel('rtg_customer_csr') ?></div>
                                            <div class="col-6">
                                                <?
                                                $this->widget('CStarRating', array(
                                                    'model' => $model,
                                        ...
                                        <div class="row pt20">
                                            <div class="col-6"><?= $model->getAttributeLabel('rtg_customer_car') ?></div>
                                            <div class="col-6">
                                                <?
                                                $this->widget('CStarRating', array(
                                                    'model' => $model,
                                    ...
                                    <div class="form-group pt20">
                                        ...
                                        <div class="col-12">
                                           <div class="form-group">
                                            <label class="control-label" for="Ratings_rtg_customer_review">Overall trip comments</label>
                                        ...
                                        <div id="revErr" class="review pl15">Please give your feedback.</div>  
                                    </div> 
                                    <div class="col-12 p15 pt0 text-center ">
                                        <button class="btn btn-primary text-uppercase gradient-green-blue border-none mt15" type="submit" value="Rate" tabindex="2" >Rate</button>
                                    </div>
                                    </div>
                                </div>
                                <?php $this->endWidget(); ?>
