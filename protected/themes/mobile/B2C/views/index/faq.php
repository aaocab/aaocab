...
<div class="content-boxed-widget">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f1">1. Are there any cancellation charges?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f1">
				<p>We understand that plans do change. <b>There are no charges for cancelling a trip upto 24hours in advance.</b></p>
				<p>You may cancel your reservation by logging onto <a href="/" class="color-highlight">www.gozocabs.com</a> and and cancelling your reservation directly.<br>
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f2">2. Can I request my taxi to be waiting at a place (e.g airport or street intersection)?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f2">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f3">3. Do you provide A/C (Air conditioned) cars?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f3">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f4">4. Do you provide multiple pickups or drops?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f4">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f5">5. Do you provide non AC cabs?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f5">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f6">6. Do you provide self drive cars?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f6">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f7">7. How and when do I get the driver and cab details ?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f7">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f8">8. How can I edit my existing booking?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f8">
				<p>Please <a href="/login" class="color-highlight">login to the Gozo website.</a> Go to the My bookings section and you can make changes to your booking directly on the website by selecting the specific booking in booking history list. You can change your pickup date, time or add special instructions into the TEXT BOX.</p>
			</div>
		</div>
	</div>
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f9">9. How do I get confirmation about our booking?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f9">
				<p>As soon as you create a booking with us, you will receiving the booking confirmation via email and/or SMS.</p>
			</div>
		</div>
	</div>
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f10">10. I want a taxi on a sharing basis. Will you provide it to me?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f10">
				<p>Starting October 2018, we have introduced our Gozo Flexxi SHARE service. You can now rent a seat in a outstation cab provided by Gozo. Visit <a href="https://www.gozocabs.com/goFLEXXI" class="color-highlight">www.gozocabs.com/GozoSHARE</a> to learn more.</p>
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f11">11. I want to make a booking for a round-trip with Gozo cabs, can I do that?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f11">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f12">12. I'm going from City A to city B for x days. During that time I will travel to neighboring cities from city B - is that all included in my quoted kms?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f12">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f13">13. I'm hiring a car from Gozo. In the kms quoted on my fixed quote can I use the car for local travel before I leave the city?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f13">
				...
				<p>We care for our customers and work hard to meet all your requests. We want you to have a special trip or vacation. Simply give us a call and we will work with you provide you the best solution for your needs. <br>
					For all queries, please contact us at <a href="mailto:info@gozocabs.com" class="color-highlight">info@gozocabs.com</a> or simply call our help line
				</p>
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f14">14. In how many cities do you provide services?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f14">
				...
				<p>Our city coverage across India is always expanding...and we are always happy to help you with your travel needs across India.<br>
					If the city you want to travel to or from is not listed on our website, simply call us and we will do our best to serve you.</p>
			</div>
		</div>
	</div>
	<div class="accordion-widget">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			...
			<div class="accordion-content" id="accordion-f16">
				...
				<p>Learn more about our business travel program <a href="https://www.gozocabs.com/business-travel" target="_blank" class="color-highlight">here</a></p>
			</div>
		</div>
	</div>
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f17">17. Sometimes I find Gozo's prices are slightly higher compared to other companies on the same routes<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f17">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f18">18. What advantages do I get by booking in advance?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f18">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f19">19. What car categories do you provide?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f19">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f20">20. What if Driver asks me for extra payment? and I do not agree...<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f20">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f21">21. What if my cab shows up late?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f21">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f22">22. What if my taxi does not show up?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f22">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f23">23. What if the cab breaks down during the journey<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f23">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f24">24. What is the earliest I should make a reservation with Gozo?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f24">
				<p>You may reserve with Gozo at anytime. <br>
					We are open 24x7 and our platform automatically gets to work for arranging cabs - no human intervention required.</p>
				<p>However, the shorter the notice, fewer the inventory choices and tighter the inventory in the market. While Gozo has the largest and most expansive network of inter-city cabs across India , our ability to get you the highest quality and best pricing gets diminished as the journey date gets closer.</p>
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f25">25. Will Gozo drivers take detour per our request?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f25">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f26">26. we will be landing at Bangalore airport and then want to go Cochin? Should I prebook my car or book after landing?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f26">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f27">27. Do you provide an English-speaking driver?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f27">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f28">28. I left something in the Gozo Cab, how do I report the lost item so you can help me get it back.<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f28">
				<p>We’re sorry that you left your belonging in the car. We will try our to search for the item and if found we will contact you on how to best get it back to you. Typically the item will be sent to you by post at your cost of the courier service. Please go to <a href="http://support.gozocabs.com/open.php" class="color-highlight">http://support.gozocabs.com/open.php</a> and open a new ticket, use help topic lost and found. This will get us what we need and we can start a lost & found inquiry for you.</p>
			</div>
		</div>
	</div>
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f29">29. Are pets allowed?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f29">
	...
	<div class="mt30 font-16 color-green3-dark"><b>Making, modifying or cancelling a reservation</b></div>
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f31">31. How can I cancel my booking with Gozo?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f31">
				...
				<p>Please DO NOT CALL the helpdesk / reservations desk for cancelling bookings as these bookings cannot be cancelled by the representatives. You need to <a href="/login" class="color-highlight">login to your account</a> to cancel your booking.</p>
			</div>
		</div>
	</div>
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f32">32. How can I get a bill/receipt for my trip?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f32">
				<p>Invoices are automatically generated and sent to you by email for every trip that you complete with us. <br>
					If you have lost your invoice email or cannot find it your invoice can  be retrieved by logging in at <a href="/" class="color-highlight">www.gozocabs.com.</a> <br>
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f33">33. How many people can travel per taxi?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f33">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f34">34. I have done my booking by phone, is toll included in the costs?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f34">
				...
				<p>For round-trip or multi-city trips we will exclude this items from the quotation. In anycase, your booking confirmation (booking contract) provides complete transparency on what is included in your trip plan and quote.</p>
			</div>
		</div>
	</div>
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f35">35. Is Toll tax included or excluded from my Total fare?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f35">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f36">36. We have elderly travelers in the vehicle?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f36">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f37">37. What if I have a lot of luggage to be carried during the journey?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f37">
	...
	<div class="mt30 font-16 color-green3-dark"><b>Questions about charges or payment</b></div>
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f39">39. Are there any waiting charges?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f39">
				<p>There are no waiting charges up to first 30 minutes during the trip. </p>
				<p>At pickup time, your cab will wait for a maximum of 30 minutes. If requested to wait longer (provided the cab driver is able to wait) you will be responsible for waiting charges at the rate of Rs.300/hour.</p>
			</div>
		</div>
	</div>
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f40">40. Do I need to pay any extra amount apart from the one listed here on website?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f40">
				<p>No, the amount listed on the website is the final amount you will need to Pay. Our quotes are commpletely transparent and we list all the applicable charges upfront. Most our trip quotes are inclusive of the toll tax, state tax and other charges.</p>
                        ...
                        Parking charges are typically Rs.150-300 in the case of most airport pickups.</p>
			</div>
		</div>
	</div>
	<div class="mt30 font-16 color-green3-dark"><b>Gozo Flexxi SHARE</b></div>
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f41">41. What is Gozo Flexxi SHARE?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f41">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f42">42. How does Gozo Flexxi SHARE work?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f42">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f43">43. What is the benefit for Gozo Flexxi SHARE riders?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f43">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f44">44. What is the benefit for Gozo Flexxi SHARE promoters?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f44">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f45">45. Can I pay the driver cash?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f45">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f46">46. As the Gozo Flexxi SHARE promoter, Can I reschedule my trip time?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f46">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f47">47. I'm a Gozo Flexxi SHARE promoter, can I get cash back instead of getting credit applied to my booking amount?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f47">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f48">48. I have booked a Gozo Flexxi SHARED seat, how long will the car wait for me?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f48">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f49">49. What is the cancellation policy for Gozo Flexxi SHARE?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f49">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f50">50. Why do I have to sign in with my Facebook profile when booking a Gozo Flexxi SHARE?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f50">
	...
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f51">51. What are the other terms and conditions for booking a Gozo Flexxi SHARE?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f51">
				<p>Full terms and conditions for Gozo Flexxi SHARE are listed at <a href="https://www.gozocabs.com/terms-GozoFLEXXI" target="_block" class="color-highlight">www.gozocabs.com/terms-GozoFLEXXI</a></p>
			</div>
		</div>
	</div>
	<div class="accordion-widget">
		<div class="accordion accordion-style-1">
			<a href="javascript:void(0);" data-accordion="accordion-f52">52. How do you collect toll from every person in the shared taxi?<i class="fa fa-arrow-down"></i></a>
			<div class="accordion-content" id="accordion-f52">
