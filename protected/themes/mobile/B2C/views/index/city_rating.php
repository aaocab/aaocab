...
?>
	<div class="container content-padding p10 bottom-10">
		<div class="above-overlay color-white text-center">
        
			<h1 class="bold top-0 color-white font-18">Rent a Car in <?=$cityName; ?></h1>
		  
		</div>
		<div class="overlay gradient-top-blue-green"></div>
	</div>
 <!--- --->
