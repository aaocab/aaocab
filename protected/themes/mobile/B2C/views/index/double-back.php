...
<div class="content-boxed-widget pt5 pb5">

		<figure><img src="/images/doubleback.jpg?v=0.1" alt="price-guarantee" class="preload-image responsive-image"></figure>		
		
		<div class="text-center">
			<div class="clear"></div>
			<div class="text-center mt20 pt10"><a class="btn booking-new-btn default-link uppercase btn-orange shadow-medium" href="/" role="button">BOOK NOW</a></div>
		</div>
		...
		<div class="text-center mb20" style="margin-top: 30px;"><a class="btn booking-new-btn default-link uppercase btn-orange shadow-medium" href="/" role="button">BOOK NOW</a></div>
</div>
<div class="clear"></div>