...
?>
<div class="content-boxed-widget login-box-container voucherCheckLogin" id="contentpadding<?php echo $id; ?>" style="display:none;">
	...
	<div class="social-log mt10 mb20 text-center">
		<div class="">
			...
			<a  href="javascript:void(0);" class="social-log-g" onclick="socailSigin('google')"><i class="fab fa-google"></i></a>
			<a href="javascript:void(0);" class="social-log-e" data-menu="menu-list-modal<?php echo $id; ?>"><i class="far fa-envelope"></i></a>
...
<div id="menu-list-modal<?= $id ?>" data-selected="menu-components" data-width="300" data-height="325" class="menu-box menu-modal">
    <div class="menu-title"><a href="#" class="menu-hide mt15 n" id="menubox<?php echo $id; ?>"><i class="fa fa-times"></i></a>
        <h1>Log In</h1>
    </div>
    <div class="menu-page">
		<div style="color:#B80606; text-align: center;" id="errmsg_login<?php echo $id; ?>" class="hide"><span>You have entered an invalid email address or a password. Please enter correct details!</span></div>
        <div class="page-login page-login-full">
            <div class="page-login-field top-30">
                <i class="fa fa-user color-highlight"></i>
                <input type="text" placeholder="Username" name="username" id="username<?php echo $id; ?>">
                <em>(required)</em>
            </div>
            <div class="page-login-field bottom-30">
                <i class="fa fa-lock color-highlight"></i>
                <input type="password" name="password" id="password<?php echo $id; ?>" placeholder="Password">
                <em>(required)</em>
            </div>

            <a href="#" id="userloginmodal<?php echo $id; ?>" class="button bg-highlight button-full button-rounded button-sm uppercase ultrabold shadow-small">LOGIN</a>
        </div>
    </div>
</div>
<script>
	$(document).ready(function(){
		...
		$('#userloginmodal' + idkey).click(function () {
			...
			jQuery.ajax({'type': 'GET', 'url': href, 'dataType': 'html',
				'data': {Users: {usr_email: username, usr_password: pass}},
