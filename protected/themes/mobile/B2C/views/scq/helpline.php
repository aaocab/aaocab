...
.list-group li a{ cursor: pointer;}
</style>

    <div class="booking-no pt10">
        <ul class="list-group list-group-flush pl20 mb10">
            <li class="list-group-item line-height18 mb20">
				<i class="fas fa-phone-square"></i> New Booking:
				<div class="weight500"><a type="button" class="color-green3-dark font-16" onclick="reqCMB(1)"> Request a call back</a></div>
            ...
            <li class="list-group-item line-height18 mb20">
				...
				<div class="weight500"><a type="button" class="color-green3-dark font-16" onclick="reqCMB(2)"> Request a call back</a></div>
			...
			if ($isContactVendor === 0 || $isContactVendor > 0)
			{
				...
				<li class="list-group-item line-height18 mb20">
					...
					<div class="weight500"><a type="button" class="color-green3-dark font-16" onclick="reqCMB(4)"> Request a call back</a></div>
			...
			if ($isContactVendor === 0 || $isContactVendor == null)
			{
				...
				<li class="list-group-item line-height18 mb20">
					...
					<div class="weight500"><a type="button" class="color-green3-dark font-16" onclick="reqCMB(3)"> Request a call back</a></div>
			...
			<li class="list-group-item  line-height18 mb20">
                <div class="row">
                    ...
                    <div class="weight500"><a href="tel:+919051877000" class="color-green3-dark font-16">+91 90518-77000</a></div>
