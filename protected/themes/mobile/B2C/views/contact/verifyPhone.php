                ...
                <div style="text-align:left; margin:20px 0;">
                    ...
                    <div class="form-group">
                        <div class="text-center mb20">
                            <?= CHtml::numberField('phn_verify_otp', yii::app()->shortHash->unhash($otp), $htmlOptions = array('readonly' => true, 'class' => "form-control text-center font-22 weight600 bg-teal-dark pt5 pb5")); ?> 
                        </div>
                        <div class=" text-center mb20 col-md-1">
                            <?= CHtml::submitButton('Verify', ['onclick' => 'phonevalidate()', 'class' => 'uppercase btn-orange shadow-medium']); ?>
                        </div>
                    </div>
                </div>
                <?
        ...
        case Contact::MODIFY_CON_TEMPLATE:            
            ...
            if ($contactModel->phn_is_expired == 0)
            {
                ...
                <div style="text-align:left; margin:20px 0;">
                    ...
                    <div class=" text-center mb20 col-md-1">   
						<?= CHtml::submitButton('Verify', ['onclick' => 'phonevalidate()', 'class' => 'btn btn-primary uppercase btn-orange shadow-medium']); ?>
                    </div>
                </div>
                <?
            }
