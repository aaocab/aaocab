...
<section id="section2">
	<div class="row p20">
		<div class="col-xs-12 col-sm-10 col-md-10 float-none marginauto"> 
			...
			<div class="col-xs-12 col-sm-3 col-md-2 mb20 pull-right">
		...
		<!--<h3>Tempo traveller fares for <?//= count($topTenRoutes); ?> popular trips to or from <?//= $cmodel->cty_name; ?></h3>-->
			<h2>Tempo traveller fares for rentals in and around <?= $cmodel->cty_name; ?></h2>
			...
			<h3>WHY HIRE TEMPO TRAVELLER FROM GOZO IN <?= strtoupper($cmodel->cty_name); ?></h3>
