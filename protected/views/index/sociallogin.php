            ...
            <div class="panel-body">
                ...
                <div class="row" style="text-align: center;">
                                    ...
                                    <div class="col-xs-12 col-md-6 col-md-offset-3 google-btn">
                                        <a class="btn btn-lg btn-social btn-googleplus pl15 pr15" target="_blank"  href="<?= Yii::app()->createUrl('index/oauth', array('provider' => 'Google')); ?>"><img src="../images/google_icon.png" alt="aaocab"> Connect with Google</a>
                                    </div>
