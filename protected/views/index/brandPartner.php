...
<!--        <div class="col-xs-12 col-sm-6 text-center brand-partners">
        ...
        <div class="col-xs-12 col-sm-4 text-center brand-partners">
            <div class="panel panel-default partner-b">
                <div class="p20 panel-body">
                    <figure><a href="#" data-toggle="modal" data-target="#mobikwik"><img src="/images/partners-logo2.png?v=1" rel="nofollow" alt="" class="mb20"></a></figure>
        ...
        <div class="col-xs-12 col-sm-4 text-center brand-partners">
            <div class="panel panel-default partner-b">
                <div class="p20 panel-body mt50">
                    <figure><img src="/images/partners-logo4.png?v=1" rel="nofollow" alt="UP Gov. + UP Tourism" class="mb20"></figure>
				</div>
            </div>
        </div>
        <div class="col-xs-12 col-sm-4 text-center brand-partners">
...
<!--<div class="modal fade" id="travelspice" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<section>
    <div class="row row inner-top-mune m0 mb20">
        <div class="col-xs-12 h4 m0 text-uppercase">Offers</div>
    </div>
    <div class="row">
