									...
									<div class="row">
										...
										<div class="col-xs-12">
											...
											<div id = "ppayment" style="display: block">
												...
												<div class="row">
													<div class="col-sm-6">
														<?= $form->numberFieldGroup($model, 'partialPayment', array('label' => '', 'widgetOptions' => array('htmlOptions' => ['class' => 'form-control clsPartialPayment', 'placeholder' => "Partial Payment", 'min' => $orderAmount, 'max' => $orderAmount]))) ?>
													</div>
													<div class="col-xs-6">
										...
										<div class="col-xs-12" >
											...
											<label class="">
													<?= $form->checkboxGroup($model, 'vor_tnc', ['class' => 'test', 'label' => 'I agree to the Gozo <a href="javascript:void(0);" onclick="opentns()" >terms and conditions</a>']) ?>
											</label> 
											<div id="error_div1" style="display: none" class="alert alert-block alert-danger"></div>
										</div>

										<div class="col-xs-12 text-right  pr20">
											<input type="submit" value="Pay Now" class="btn proceed-new-btn text-uppercase white-color" id="proceedPayNow">
											<input type="button" value="Pay Now" class="btn proceed-new-btn text-uppercase white-color" style="display: none" id="payubtn" >
										</div>
									</div>
								</div>
							</div>
