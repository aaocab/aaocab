<div class="panel panel-default mt20" style="display: none" id="fPass">
    <div class="panel-body" >
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-8 float-none marginauto">
                ...
                <a class="a-pointer btn btn-info" id="bKlogin" onclick="bKlogin()" style="float:none;">Return to Sign in</a>
            </div></div>
        <?php $this->endWidget(); ?>
    </div>
