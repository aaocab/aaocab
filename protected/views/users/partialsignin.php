                    ...
                    <div class="panel-body pt0">
                        <div class="row flex m0">
                            <div class="col-sm-6 p0 signin-left">
                                <div class="pt30 pb30">
                                    <div class="mt20 mb30"><img src="/images/logo_outstation.png?v=0.2" alt="Gozocabs"></div>
                            ...
                            $.ajax({
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-7 float-none marginauto">                        
                                        <?= $form->emailFieldGroup($emailModel, 'eml_email_address', array('label' => 'Email', 'widgetOptions' => array('htmlOptions' => ['required' => TRUE, 'class' => 'mb0', 'placeholder' => "Email"]))) ?>
                                    </div>
                                </div> 
                                <div class="row">
                                    <div class="col-xs-12 col-sm-7 float-none marginauto">                        
                                        <?= $form->passwordFieldGroup($model, 'usr_password', array('label' => 'Password', 'widgetOptions' => array('htmlOptions' => ['required' => TRUE, 'placeholder' => "Password"]))) ?>
