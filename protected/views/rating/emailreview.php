...
{
	$routeDetail .= '<div class="col-xs-6 padded">
...
$bookingInfo = '<div class="panel-heading">
	<div class="row">
		<fieldset class="fset">
			...
			<div class="col-xs-12 col-sm-6 padded">
...
?>
<div class="row">
    <div id="section1" style="color:#555555; overflow: hidden;">
        <h3 class="text-center m0 mb10 weight400 mt10" style="color:#fff">How did we do on <?= $bookingcode ?></h3>
		<?php
		if ($ifReviewExist)
		{
			?>   
			<div id="row">
				<div class="col-xs-11 col-sm-10 col-md-10 col-lg-8 float-none marginauto">
					<div class="panel" >
											...
											if ($status == 'success')
											{
												...
												<div class="p10 p115">
													...
													if ($model->rtg_customer_overall >= 4)
													{
														...
														Refer your friends. Once they travel, as a thankyou we will give you upto 20% back on what you or your friend paid. There is no limit on referrals, you can get 20% cashback for every friend who travels after your referral.<br> 
						...
						<div class="panel-body p0">
							<div class="panel-scroll1">
								<div class="col-xs-12" style="min-height:100px;color:#666666">
									<div class="text-center">
										<div class="row">
											<div class="col-xs-12 pb10 text-center"><span style="font-size: 20px;"><strong><?= $model->getAttributeLabel('rtg_customer_recommend') ?></strong></span></div>
										</div>
										<div class="row">
											<div class="col-sm-4 col-xs-2 pb10 text-right"><b>Never</b></div>
											<div class="col-lg-4 col-sm-5 col-xs-7 pb10 text-center">
												<?php
											...
											<div class="col-sm-4 col-xs-2  pb10 text-left"><b>Absolutely</b></div>
										</div>
									</div>
									<div id="recommendErr" class="review">Please rate how would you like to recommend Gozo to your friends and family.</div>
									<div class="row">
										<div class="col-sm-offset-4 col-sm-8 pl0 pb10 email_review"><span style="font-size: 20px;"><strong><?= $model->getAttributeLabel('rtg_customer_overall') ?></strong></span>
										</div></div>
									<div class="row">
										<div class="col-xs-4 col-sm-4 pb10 text-right"><b>Horrible</b></div>
										<div class="col-xs-4 col-sm-4 pb10 text-center">
											<?php
											$this->widget('CStarRating', array(
												'model'		 => $model,
										...
										<div class="col-xs-4 col-sm-4 pb10 text-left"><b>Loved It!</b></div>
									</div>
									<div id="allErr" class="review">Please rate our Overall Service.</div>  
									<div id="otherrating">
										<div class="row">
											<div class="col-xs-6 col-sm-6"><b><?= $model->getAttributeLabel('rtg_customer_driver') ?></b></div>
										...
										<div class="row" id="driverRatingBox">
											<div class="col-xs-12 table_none pb10">
												<!--//-->
												<div class="col-xs-12">
													<div class="row">
															...
															<div class="panel panel-default">
																<div class="panel-body p0">
																	<div class="row m0 flex">
																		<div class="col-xs-6 col-sm-6 box-design1a pt0">
																			<div class="row">
																				<div class="col-xs-12 box-design1 border-new-b text-center"><b style="color: #008000;">What was good? <img src="/images/icon/happy-smiley.png" alt="" ></b></div>
																				<div class="col-xs-12">
																					<ul class="mt10">
																						<?php
																		...
																		<div class="col-xs-6 col-sm-6 box-design2a pt0">
																			<div class="row">
																				<div class="col-xs-12 box-design2 border-new-b text-center"><b style="color: #DC143C;">What was not? <img src="/images/icon/sad-icon.png" alt="" ></b></div>
																				<div class="col-xs-12">
																					<ul class="mt10">
																						<?php
	...
	<?php } ?>
																	...
																	<div class="row m0 pt10 pb10">
																		...
																		<div class="col-xs-3 col-sm-6 options text-center label-tab">
																		</div>
																	</div>
																	<div class="row m0 mb20">
																		<div class="col-xs-6 col-sm-12">
	<?= $form->textAreaGroup($model, 'rtg_driver_cmt', array('label' => '', 'widgetOptions' => array('htmlOptions' => array()))) ?>
										...
										<div class="row pt20">
											<div class="col-xs-6 "><b><?= $model->getAttributeLabel('rtg_customer_csr') ?></b></div>
											<div class="col-xs-6">
												<?php
												$this->widget('CStarRating', array(
													'model'		 => $model,
	...
	<?php } ?>
																...
																<div class="row m0 pt10 pb10">
																	<div class="col-xs-6 col-sm-12">
	<?= $form->textAreaGroup($model, 'rtg_csr_cmt', array('label' => '', 'widgetOptions' => array('htmlOptions' => array()))) ?>
										...
										<div class="row pt20">
											<div class="col-xs-6"><b><?= $model->getAttributeLabel('rtg_customer_car') ?></b></div>
											<div class="col-xs-6">
												<?php
												$this->widget('CStarRating', array(
													'model'		 => $model,
	...
	<?php } ?>
															...
															<div class="row m0  pt10 pb10">
																<div class="col-xs-6 col-sm-12">
	<?= $form->textAreaGroup($model, 'rtg_car_cmt', array('label' => '', 'widgetOptions' => array('htmlOptions' => array()))) ?>
									...
									<div class="panel-body border-new-all from-top">

										<div class="row">
											<div class="col-xs-12"><?= $form->checkboxGroup($model->rtgBooking->bkgPref, 'bkg_contact_gozo', array('label' => 'I want Gozo team to contact me', 'widgetOptions' => array('htmlOptions' => []))) ?></div>
										</div>

										<div class="row">
											<div class="col-xs-12 table_none">
												<table class="table table-responsive">
													<tr>
														<td>
															<div class="col-xs-4">Did you find website & app easy</div>
															<div class="col-xs-8"><?=
																$form->radioButtonListGroup($model, 'rtg_platform_exp', array('label'			 => '',
																	'widgetOptions'	 => array('data' => array(1 => 'Yes', 0 => 'No', 2 => "Didn't use")),
																	'inline'		 => true), array(1 => 'checked', 'class' => 'col-xs-4 text-right'))
																?>
															</div>        
														</td>
													</tr>
													<tr>
														<td>
	<?= $form->textAreaGroup($model, 'rtg_platform_exp_cmt', array('label' => '', 'widgetOptions' => array('htmlOptions' => array()))) ?>
															<div>You have <span id="charleftcount4">1000 characters left.</span> (Maximum characters: 1000)</div>
									...
									<div class="row pt10">
										...
										<!--<div class="col-xs-12"><?= $model->getAttributeLabel('rtg_customer_review') ?></div>-->
										<div class="col-xs-12">
											<?=
									...
									<div class="col-xs-12 p15 text-center " id="DivSubmitRate">
										<button class="btn btn-primary btn-lg" type="submit" value="Rate" tabindex="2" >Submit Review</button>
									</div>
								</div>
