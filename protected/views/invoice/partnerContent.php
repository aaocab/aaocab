...
if (!$isPDF)
{
	...
	<div style="font-size: 11px ;line-height: 1.3em">
		<div style="width: 50%;float: left">
			...
			<?php if ($invoiceList['bkg_bill_company'] != '')
			{ ?>
				<b>Company Name: </b><?= ucfirst($invoiceList['bkg_bill_company']); ?><br/>
			<?php } ?>
	...
	<?php } ?>
			<?
			if ($invoiceList['bkg_user_fname'] != '' || $invoiceList['bkg_user_lname'] != '')
			{
			?>
			<br/>
			<b>Name: </b><?= ucfirst($invoiceList['bkg_user_fname']) .' '. ucfirst($invoiceList['bkg_user_lname']); ?>
			<? } ?>
			<?
	...
	if ($invoiceList['bkg_agent_id'] > 0)
	{
		...
		<div style="width:100%;float: left ;padding-top: 10px; font-size: 11px;line-height: 1.3em">
			...
			<b>Address: </b><?= (trim($invoiceList['agt_address']) != '') ? trim($invoiceList['agt_address']) : "" ?><br/>
