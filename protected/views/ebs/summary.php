		    ...
		    ?>
                    ...
                    <div class="row">
                        <div class="col-xs-12 summary-div">
                            ...
                            <div class="col-xs-12 col-sm-7"><?= $fname . ' ' . $lname ?></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 summary-div">
                            <div class="col-xs-12 col-sm-5"><b>Cab:</b></div>
                            <div class="col-xs-12 col-sm-7"><?= $model->bkgSvcClassVhcCat->scc_VehicleCategory->vct_label . ' ' . $model->bkgSvcClassVhcCat->scc_VehicleCategory->vct_desc .' ('.$model->bkgSvcClassVhcCat->scc_ServiceClass->scc_label.')'?></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 summary-div">
            ...
            <div class="thumbnail p10 border-radius">
                <div class="caption pl0 pr0">
                    <ul class="pl20">
                        ...
                        <li><b>Cancellation:</b> You may cancel your Booking with us by logging in to our Mobile App or Website. All bookings cancelled less than 24 hours before the scheduled pickup time shall be subject to Cancellation & Refund Policy as laid down in our 
