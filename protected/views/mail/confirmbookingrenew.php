...
$file		 = "<a href='$fileLink' target='_blank'>here</a>";
...
?>
												...
												<div>
													...
													<div>
														...
														<p style="margin-bottom: 10px; margin-top: 0;"><?php $vhtModel	 = ($model->bkgSvcClassVhcCat->scc_ServiceClass->scc_id == 4) ? ' - ' . $model->bkgVehicleType->vht_make . ' ' . $model->bkgVehicleType->vht_model : ''; ?>
															<?= SvcClassVhcCat::getCatrgoryLabel($model->bkg_vehicle_type_id, true) . $vhtModel ?></p>
													</div>
													<div>
						...
						<?php } ?>
						<div style="width: 100%; float: left; margin-top: 10px;">Your auto-generated invoice can be viewed <a href="#" style="color:#0279E8;"><b><?= $file; ?></b></a> after the trip is completed</div>
						<div style="width: 100%; float: left; margin-top: 10px;">
							<?php
