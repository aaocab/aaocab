...
//$model->bkgInvoice->populateAmount(false, true, true, false,$model->bkg_agent_id);
...
$returnInfoPerKm = '<ol type="1" style="font-size:10px; line-height:15px;padding-left:5px;">
...
<table style="width:98%;border: #d4d4d4 0px solid;border-collapse: collapse; font-family: 'Arial'; font-size: 12px; padding: 5px; color: #000;"  bgcolor="#fff" align="center" cellpadding="5" cellspacing="0">
    <tr>
        <td align="center"><p><strong style="font-size:16px;"><?php
					if ($model->bkgInvoice->bkg_advance_amount > 0)
					{
						echo 'B2B RESERVATION CONFIRMED';
					}
					else
					{
						echo 'B2B RESERVATION CREATED';
					}
					?></strong><br /><?php
				if ($model->bkgInvoice->bkg_advance_amount > 0)
				{
                    ...
                    <td>
                        <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="5" bordercolor="#CCCCCC">
                            <tr>
                                ...
                                <td><a href="<?= $payurl ?>" target="_blank" style="text-decoration: none;"><strong style="color:#000"><?= Filter::formatBookingId($model->bkg_booking_id); ?></strong>CLICK FOR LIVE BOOKING STATUS UPDATES</a></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><?= ($model->bkgUserInfo->bkg_contact_no != '') ? '+' . $model->bkgUserInfo->bkg_country_code . ' ' . $model->bkgUserInfo->bkg_contact_no : '' ?></td>
                            </tr>
                            <tr>
							...
							<tr>
                                ...
                                <td><?= $model->bkgSvcClassVhcCat->scc_ServiceClass->scc_desc; ?></td>
                            </tr>
                        </table></td>
                            ...
                            <tr>
								...
								if ($model->bkg_agent_id == 0 || $model->bkg_agent_id == '')
								{
									...
									<td><strong style="color:#7a7a7a">BOOKING  STATUS : </strong><?php
										...
										{
											echo '<font style="color:green"><b>CONFIRMED</b></font>';
										}
										?></td>
<? } ?>
                            </tr>
<!--                            <tr>
                            ...
                            <tr>
                                <td><img src="http://gozocabs.com/images/price-guarantee-img.jpg" alt="Price Guarantee"  /></td>
                            </tr>-->
                        </table>
                    </td>
                </tr>
...
//       if ($due > 0) {
						?>
                                                    <td align="left" valign="middle"><a href="<? //= $payurl    ?>" target="_blank"><img src="http://gozocabs.com/images/paynow_btn.png" alt="Pay Now" /></a></td>
						<?php //}
						?>
        ...
        <td>
            <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="4" bordercolor="#CCCCCC">
                ...
                <tr>
                    ...
                    <td align="left"><?= '(' . $model->bkgSvcClassVhcCat->scc_ServiceClass->scc_label . ') ' . SvcClassVhcCat::getCatrgoryLabel($model->bkg_vehicle_type_id, false) . ' ' . $model->bkgSvcClassVhcCat->scc_VehicleCategory->vct_desc . ' (' . $model->bkgSvcClassVhcCat->scc_VehicleCategory->vct_capacity . ' seater)' ?></td>
                </tr>
                <tr>
...
//if ($model->bkg_trip_type != 1)
                ...
                <tr>
					...
					if ($model->bkg_agent_id == 0 || $model->bkg_agent_id == '')
					{
						...
						<td align="left">Parking charges; Any parking charges <?php
    ...
    <tr>
        <td>
            <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="4" bordercolor="#CCCCCC">
                ...
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Airport  Entry Fee <?php echo ($model->bkgInvoice->bkg_is_airport_fee_included == 1) ? "(Included)" : "" ?></strong></td>
                    <td align="left">Rs.<strong><em><?php echo ($model->bkgInvoice->bkg_airport_entry_fee != '') ? $model->bkgInvoice->bkg_airport_entry_fee : 0; ?></em></strong></td>
                </tr>
				<?
...
<!--                    <td align="left" bgcolor="#FF6600"><span style="color: #FFFFFF"><strong style="font-size:20px;">Rs.<? //= number_format($model->bkg_total_amount)     ?></strong></span></td>-->
                </tr>
				<?
...
<!--                    <tr>
                        ...
                        <td align="left">Rs.<strong><? //= number_format($model1->bkg_total_amount - $model->bkg_total_amount)     ?></strong></td>
                    </tr>-->
                <tr>
                    <td align="left" bgcolor="#FF6600"><span class="style3"><strong style="font-size:20px;">Total  cost: </strong></span></td>
...
<? } ?>
	...
	<tr>
        <td style="padding-top:5px;"><strong style="font-size:16px;">Cancellation Information </strong>(Booking created at <?= date('d M Y h:i A', strtotime($model->bkg_create_date)); ?>)</td>
    </tr>
	<tr>
		<td>
