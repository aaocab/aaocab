...
//				'<br/>GozoCabs<br/><br/>';
		$msg = '<p>Dear '.$arr['userName'].'</p>' .
			'<p>Thank you for signing up with Gozocabs. We are thrilled to have you as a new member of our platform. To ensure the security and validity of your email address, we kindly request you to verify your email ID.</p>'.
