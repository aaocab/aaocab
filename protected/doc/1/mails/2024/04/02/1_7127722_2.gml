										...
										<tr>
											<td>
												<div>
													...
													<p style="margin-bottom: 10px; margin-top: 0;">Ankesh Singh</p>
												</div>
												<div>
													<span style="color: #858585; padding-right: 5px;">Email</span>
													<p style="margin-bottom: 10px; margin-top: 0;">jsrankesh.singh@gmail.com</p>
												</div>
												<div>
													<span style="color: #858585; padding-right: 5px;">Phone</span>
													<p style="margin-bottom: 10px; margin-top: 0;">+91 9903430853</p>
												</div>
																							</td>
											<td width="50%">
												<div>
														...
														<p style="margin-bottom: 10px; margin-top: 0;">Compact (Economy)</p>
													</div>
													<div>
														<span style="color: #858585; padding-right: 5px;">Pickup Date/Time</span>
														<p style="margin-bottom: 10px; margin-top: 0;">3rd Apr 2024 (Wed) 06:00 AM</p>
													</div>
													<div>
														<span style="color: #858585; padding-right: 5px;">Pickup Address</span>
														<p style="margin-bottom: 10px; margin-top: 0;">Delhi railway station, Siraspur Road, Sector 18, Rohini, Delhi, India</p>
													</div>
												</div>
											</td>
										</tr>
								...
								<td>
									<div>
										...
										<div style="width: 100%; float: left; overflow: hidden;">
											<span style="padding-right: 20px;">Quoted Distance: <b>225 Km</b></span>
