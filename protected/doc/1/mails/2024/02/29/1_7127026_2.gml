...
<table style="width:98%;border: #d4d4d4 0px solid;border-collapse: collapse; font-family: 'Arial'; font-size: 12px; padding: 5px; color: #000;"  bgcolor="#fff" align="center" cellpadding="5" cellspacing="0">
    <tr>
        <td align="center"><p><strong style="font-size:16px;">RESERVATION CONFIRMED</strong><br />Thank you for choosing GozoCabs. We have confirmed your reservation request.You will receive the cab details at least 3 hours before your scheduled pickup time.                </p></td>
          ...
          <tr>
        <td class="text-center bg-danger p10 mb10">Please use OTP: <b>468079</b> at the time of pickup. Please don't share OTP before boarding the cab.
</td>
    </tr>
        <tr>
        <td>
                    ...
                    <td>
                        <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="5" bordercolor="#CCCCCC">
                            <tr>
                                ...
                                <td><a href="https://www.gozocabs.com/bkpn/3898068/YhBQC/e/f83j0" target="_blank">AP40-3898068 <p style="font-size:12px;">Check driver, car info and other details</p></a></td>
                            ...
                            <tr>
                                ...
                                <td>18th Mar 2024 (Mon) 10:30 PM</td>
                            </tr>
                            <tr>
                                <td><strong style="color:#7a7a7a">PICKUP ADDRESS:</strong></td>
                                <td>Ashok Nagar Block B Nehru Nagar III Nehru Nagar MC5XW3R Ashok Nagar Nehru Nagar III Nehru Na</td>
                            </tr>
                            <tr>
							...
							<tr>
                                ...
                                <td>["CNG cabs preferred"]</td>
									...
									<td>Paras travels( Rajesh Singh )</td>
								</tr>
							                        </table></td>
            ...
            <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="4" bordercolor="#CCCCCC">
                <tr>
                    ...
                    <td align="center" bgcolor="#FF6600"><span class="style1">Est.  Travel Duration</span></td>
                                    ...
                                    <tr>
                        <td align="center">Ghaziabad<br>Ashok Nagar Block B Nehru Nagar III Nehru Nagar MC5XW3R Ashok Nagar Nehru Nagar III Nehru Na</td>
                        <td align="center">Indira Gandhi International Airport (Terminal 3, Delhi Airport)<br>IGI AirportT2</td>
                        <td align="center">18/03/2024</td>
                        <td align="center">10:30 pm</td>
                        <td align="center">50 Km</td>
                        <td align="center">1 Hours</td>
                    </tr>
                </table>
        </td>
    </tr>
        ...
        <td>
            <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="4" bordercolor="#CCCCCC">
                <tr>
                    ...
                    <td align="left">Ghaziabad -> Indira Gandhi International Airport (Terminal 3, Delhi Airport)</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left">Ashok Nagar Block B Nehru Nagar III Nehru Nagar MC5XW3R Ashok Nagar Nehru Nagar III Nehru Na</td>
                </tr>
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Final  Drop Address</strong></td>
                    <td align="left">IGI AirportT2</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left">18th Mar 2024 (Mon) 10:30 PM</td>
                </tr>
                                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Return  Date Time</strong></td>
                    <td align="left">18th Mar 2024 (Mon) 11:47 PM</td>
                </tr>
                ...
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Charges  beyond 50 Km</strong></td>
                    <td align="left">20.00 / km</td>
                </tr>
                
                 <tr>
                    <td align="left"><strong style="color:#7a7a7a">Included with quotation</strong></td>
                    <td align="left">Upto 50 kms for the exact itinerary listed below. NO route deviations allowed unless listed in itinerary ; Toll & state taxes                    </td>
                </tr>
                <tr>
	...
	<tr>
        <td style="padding-top:5px;"><strong style="font-size:16px;">Cancellation Information </strong>(Booking created at 29 Feb 2024 07:31 PM)</td>
    </tr>
	<tr>
		<td>
				...
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #4CCD74 3px solid; text-align: center; padding: 10px; width: 100%;">
						...
						<p style="margin-bottom: 0;">29 Feb 2024 19:40 pm&nbsp;<span><img src="/images/email/transfer.png" alt="img" style="margin: 0 10px;"></span>&nbsp;29 Feb 2024 08:10 pm</p>
					</td>
				</tr>
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #f39132 3px solid; text-align: center; padding: 10px; margin-top: 2px;">
						<span style="font-size: 14px;"><b>Cancellation Charge : &#x20b9;1200</b></span>
						<p style="margin-bottom: 0;">29 Feb 2024 08:10 pm&nbsp;<span><img src="/images/email/transfer.png" alt="img" style="margin: 0 10px;"></span>&nbsp;18 Mar 2024 10:30 pm</p>
					</td>
				</tr>
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #EF2B2B 3px solid; text-align: center; padding: 10px; margin-top: 2px;">
						<span style="font-size: 14px;"><b>Cancellation Charge : &#x20b9;1200 </b></span>
						<p style="margin-bottom: 0;">after 18 Mar 2024 10:30 pm</p>
					</td>
				</tr>
			</table>
		</td>
