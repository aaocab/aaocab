...
<table style="width:98%;border: #d4d4d4 0px solid;border-collapse: collapse; font-family: 'Arial'; font-size: 12px; padding: 5px; color: #000;"  bgcolor="#fff" align="center" cellpadding="5" cellspacing="0">
    <tr>
        <td align="center"><p><strong style="font-size:16px;">RESERVATION CONFIRMED</strong><br />Thank you for choosing GozoCabs. We have confirmed your reservation request.You will receive the cab details at least 3 hours before your scheduled pickup time.                </p></td>
    </tr>
          <tr>
        <td class="text-center bg-danger p10 mb10">Please use OTP: <b>494981</b> at the time of pickup. Please don't share OTP before boarding the cab.
</td>
    </tr>
        <tr>
        <td>
                    ...
                    <td>
                        <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="5" bordercolor="#CCCCCC">
                            <tr>
                                ...
                                <td><a href="https://www.gozocabs.com/bkpn/3898057/lCEXf/e/D3ItR" target="_blank">OW40-3898057 <p style="font-size:12px;">Check driver, car info and other details</p></a></td>
                            ...
                            <tr>
                                ...
                                <td>4th Mar 2024 (Mon) 09:15 AM</td>
                            </tr>
                            <tr>
                                <td><strong style="color:#7a7a7a">PICKUP ADDRESS:</strong></td>
                                <td>Jaipur,Rajasthan, Jaipur, Jaipur,Rajasthan</td>
                            </tr>
                            <tr>
                                <td><strong style="color:#7a7a7a">SPECIAL INSTRUCTIONS:</strong></td>
                                <td><b>Customer special request</b><li>cab should be clean</li></td>
                            </tr>
							<tr>
                                <td><strong style="color:#7a7a7a">Cab Type Info:</strong></td>
                                <td>["CNG cabs preferred"]</td>
                            </tr>
															<tr>
									<td><strong style="color:#7a7a7a">Booked By:</strong></td>
									<td>Opoli( Saurabh Singh )</td>
								</tr>
							                        </table></td>
            ...
            <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="4" bordercolor="#CCCCCC">
                <tr>
                    ...
                    <td align="center" bgcolor="#FF6600"><span class="style1">Est.  Travel Duration</span></td>
                                    ...
                                    <tr>
                        <td align="center">Jaipur<br>Jaipur,Rajasthan, Jaipur, Jaipur,Rajasthan</td>
                        <td align="center">Greater Noida<br>Greater Noida,Uttar Pradesh, Greater Noida, Greater Noida,Uttar Pradesh</td>
                        <td align="center">04/03/2024</td>
        ...
        <td>
            <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="4" bordercolor="#CCCCCC">
                <tr>
                    ...
                    <td align="left">Jaipur -> Greater Noida</td>
                </tr>
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Cab type & Class </strong></td>
                    <td align="left">(Economy) Sedan Dzire, Toyota Etios, Tata Indigo or equivalent (4 seater)</td>
                </tr>
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Pickup  Address</strong></td>
                    <td align="left">Jaipur,Rajasthan, Jaipur, Jaipur,Rajasthan</td>
                </tr>
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Final  Drop Address</strong></td>
                    <td align="left">Greater Noida,Uttar Pradesh, Greater Noida, Greater Noida,Uttar Pradesh</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left">4th Mar 2024 (Mon) 09:15 AM</td>
                </tr>
                                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Return  Date Time</strong></td>
                    <td align="left">4th Mar 2024 (Mon) 02:06 PM</td>
                </tr>
                 
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Kms Included  in your quotation</strong></td>
                    <td align="left">314 km</td>
                </tr>
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Charges  beyond 314 Km</strong></td>
                    <td align="left">12.75 / km</td>
                </tr>
                
                 <tr>
                    <td align="left"><strong style="color:#7a7a7a">Included with quotation</strong></td>
                    <td align="left">Upto 314 kms for the exact itinerary listed below. NO route deviations allowed unless listed in itinerary ; Toll & state taxes                    </td>
                </tr>
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Additional charges paid</strong></td>
                    <td align="left">  
                       No special requests received                    </td>
                </tr>
                 <tr>
                                       </tr>
            </table>
	...
	<tr>
        <td style="padding-top:5px;"><strong style="font-size:16px;">Cancellation Information </strong>(Booking created at 29 Feb 2024 03:19 PM)</td>
    </tr>
	<tr>
		<td>
				...
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #4CCD74 3px solid; text-align: center; padding: 10px; width: 100%;">
						...
						<p style="margin-bottom: 0;">29 Feb 2024 15:24 pm&nbsp;<span><img src="/images/email/transfer.png" alt="img" style="margin: 0 10px;"></span>&nbsp;29 Feb 2024 03:54 pm</p>
					</td>
				</tr>
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #f39132 3px solid; text-align: center; padding: 10px; margin-top: 2px;">
						<span style="font-size: 14px;"><b>Cancellation Charge : &#x20b9;1650</b></span>
						<p style="margin-bottom: 0;">29 Feb 2024 03:54 pm&nbsp;<span><img src="/images/email/transfer.png" alt="img" style="margin: 0 10px;"></span>&nbsp;04 Mar 2024 09:15 am</p>
					</td>
				</tr>
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #EF2B2B 3px solid; text-align: center; padding: 10px; margin-top: 2px;">
						<span style="font-size: 14px;"><b>Cancellation Charge : &#x20b9;1650 </b></span>
						<p style="margin-bottom: 0;">after 04 Mar 2024 09:15 am</p>
					</td>
				</tr>
			</table>
		</td>
...
<!--    <tr>
        <td><strong style="font-size:16px;"><u>OUR PARTNERS</u></strong></td>
    </tr>
    <tr>
        <td>
...
<ol type="1" style="font-size:10px; line-height:15px;padding-left:5px;">
    ...
    <ol type="a">
        ...
        <li>Drivable (314)  kms in your quote are estimates. You will be billed for the actual distance travelled by you. If you have not provided the exact address before your pickup or if the exact address could not be determined at time of providing you the booking amount estimate then your quote includes travel from city center to city center. Distance to be driven as quoted in the booking is only applicable for travel between the addresses, waypoints and locations as exactly specified in your itinerary.</li>
	...
	<li>AT PICKUP TIME. 
        <ol type="a">
            ...
            <li>
                DO NOT RIDE IF THE VEHICLE & DRIVER INFORMATION DO NOT MATCH THE INFORMATION PROVIDED BY GOZO. WE SHALL NOT BE RESPONSIBLE OR LIABLE IN ANY MANNER IF YOU CHOOSE TO RIDE IN A VEHICLE THAT IS NOT COMMERCIALLY LICENSED OR RIDE WITH A DRIVER OR VEHICLE OTHER THAN THE ONE THAT WE HAVE ASSIGNED TO YOU.    
            </li>
            <li>
