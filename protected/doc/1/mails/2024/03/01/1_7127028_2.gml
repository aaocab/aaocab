...
<table style="width:98%;border: #d4d4d4 0px solid;border-collapse: collapse; font-family: 'Arial'; font-size: 12px; padding: 5px; color: #000;"  bgcolor="#fff" align="center" cellpadding="5" cellspacing="0">
    <tr>
        <td align="center"><p><strong style="font-size:16px;">RESERVATION CONFIRMED</strong><br />Thank you for choosing aaocab. We have confirmed your reservation request.You will receive the cab details at least 3 hours before your scheduled pickup time.                </p></td>
    </tr>
          <tr>
                    ...
                    <td>
                        <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="5" bordercolor="#CCCCCC">
                            <tr>
                                ...
                                <td><a href="http://www.aaocab.com/bkpn/3898070/nKd2I/e/Tavvg" target="_blank">OW40-3898070 <p style="font-size:12px;">Check driver, car info and other details</p></a></td>
