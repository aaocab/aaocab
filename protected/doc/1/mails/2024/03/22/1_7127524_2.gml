...
<table style="width:98%;border: #d4d4d4 0px solid;border-collapse: collapse; font-family: 'Arial'; font-size: 12px; padding: 5px; color: #000;"  bgcolor="#fff" align="center" cellpadding="5" cellspacing="0">
    <tr>
        <td align="center"><p><strong style="font-size:16px;">RESERVATION CREATED</strong><br />Thank  you for choosing GozoCabs. We have received your reservation request.                </p></td>
    </tr>
          <tr>
        <td class="text-center bg-danger p10 mb10">Please use OTP: <b>613609</b> at the time of pickup. Please don't share OTP before boarding the cab.
</td>
    </tr>
        <tr>
        <td>
                    ...
                    <td>
                        <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="5" bordercolor="#CCCCCC">
                            <tr>
                                ...
                                <td><a href="https://www.gozocabs.com/bkpn/3898454/7U90s/e/OmyV9" target="_blank">OW40-3898454 <p style="font-size:12px;">Check driver, car info and other details</p></a></td>
                            ...
                            <tr>
                                ...
                                <td>23rd Mar 2024 (Sat) 01:23 PM</td>
                            </tr>
                            <tr>
							...
							<tr>
                                ...
                                <td>["Diesel or Petrol Cabs only"]</td>
                            </tr>
															<tr>
									<td><strong style="color:#7a7a7a">Booked By:</strong></td>
									<td>SugerBox( Ritika Trehan )</td>
								</tr>
							                        </table></td>
            ...
            <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="4" bordercolor="#CCCCCC">
                <tr>
                    ...
                    <td align="center" bgcolor="#FF6600"><span class="style1">Est.  Travel Duration</span></td>
                                    ...
                                    <tr>
                        <td align="center">Chennai<br>Chennai</td>
                        <td align="center">Bhopal<br>Indian Institute of Science Education and Research Bhopal (IISERB)</td>
                        <td align="center">23/03/2024</td>
                        <td align="center">01:23 pm</td>
                        <td align="center">1509 Km</td>
                        <td align="center">27 Hours</td>
                    </tr>
                </table>
        </td>
    </tr>
        ...
        <td>
            <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="4" bordercolor="#CCCCCC">
                <tr>
                    ...
                    <td align="left">Chennai -> Bhopal</td>
                </tr>
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Cab type & Class </strong></td>
                    <td align="left">(Value) Compact Indica, Swift, Alto, Ford Figo or equivalent (4 seater)</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left">Indian Institute of Science Education and Research Bhopal (IISERB)</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left">23rd Mar 2024 (Sat) 01:23 PM</td>
                </tr>
                                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Return  Date Time</strong></td>
                    <td align="left">24th Mar 2024 (Sun) 04:39 PM</td>
                </tr>
                 
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Kms Included  in your quotation</strong></td>
                    <td align="left">1509 km</td>
                </tr>
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Charges  beyond 1509 Km</strong></td>
                    <td align="left">14.50 / km</td>
                </tr>
                
                 <tr>
                    <td align="left"><strong style="color:#7a7a7a">Included with quotation</strong></td>
                    <td align="left">Upto 1509 kms for the exact itinerary listed below. NO route deviations allowed unless listed in itinerary                     </td>
                </tr>
                <tr>
	...
	<tr>
        <td style="padding-top:5px;"><strong style="font-size:16px;">Cancellation Information </strong>(Booking created at 22 Mar 2024 12:14 PM)</td>
    </tr>
	<tr>
		<td>
				...
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #4CCD74 3px solid; text-align: center; padding: 10px; width: 100%;">
						...
						<p style="margin-bottom: 0;">22 Mar 2024 12:14 pm&nbsp;<span><img src="/images/email/transfer.png" alt="img" style="margin: 0 10px;"></span>&nbsp;22 Mar 2024 01:23 pm</p>
					</td>
				</tr>
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #f39132 3px solid; text-align: center; padding: 10px; margin-top: 2px;">
						<span style="font-size: 14px;"><b>Cancellation Charge : &#x20b9;0</b></span>
						<p style="margin-bottom: 0;">22 Mar 2024 01:23 pm&nbsp;<span><img src="/images/email/transfer.png" alt="img" style="margin: 0 10px;"></span>&nbsp;23 Mar 2024 01:23 pm</p>
					</td>
				</tr>
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #EF2B2B 3px solid; text-align: center; padding: 10px; margin-top: 2px;">
						<span style="font-size: 14px;"><b>Cancellation Charge : &#x20b9;0 </b></span>
						<p style="margin-bottom: 0;">after 23 Mar 2024 01:23 pm</p>
					</td>
				</tr>
			</table>
		</td>
...
<ol type="1" style="font-size:10px; line-height:15px;padding-left:5px;">
    ...
    <ol type="a">
        ...
        <li>Drivable (1509)  kms in your quote are estimates. You will be billed for the actual distance travelled by you. If you have not provided the exact address before your pickup or if the exact address could not be determined at time of providing you the booking amount estimate then your quote includes travel from city center to city center. Distance to be driven as quoted in the booking is only applicable for travel between the addresses, waypoints and locations as exactly specified in your itinerary.</li>
