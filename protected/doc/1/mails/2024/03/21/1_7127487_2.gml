...
<table style="width:98%;border: #d4d4d4 0px solid;border-collapse: collapse; font-family: 'Arial'; font-size: 12px; padding: 5px; color: #000;"  bgcolor="#fff" align="center" cellpadding="5" cellspacing="0">
    <tr>
        <td align="center"><p><strong style="font-size:16px;">RESERVATION CREATED</strong><br />Thank  you for choosing GozoCabs. We have received your reservation request.                </p></td>
          ...
          <tr>
        <td class="text-center bg-danger p10 mb10">Please use OTP: <b>445764</b> at the time of pickup. Please don't share OTP before boarding the cab.
</td>
    </tr>
        <tr>
        <td>
                    ...
                    <td>
                        <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="5" bordercolor="#CCCCCC">
                            <tr>
                                ...
                                <td><a href="https://www.gozocabs.com/bkpn/3898434/l7gru/e/NjQ8b" target="_blank">OW40-3898434 <p style="font-size:12px;">Check driver, car info and other details</p></a></td>
                            ...
                            <tr>
                                ...
                                <td>21st Mar 2024 (Thu) 08:27 PM</td>
                            </tr>
                            <tr>
            ...
            <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="4" bordercolor="#CCCCCC">
                <tr>
                    ...
                    <td align="center" bgcolor="#FF6600"><span class="style1">Est.  Travel Duration</span></td>
                                    ...
                                    <tr>
                        <td align="center">Hyderabad<br>Hyderabad</td>
                        <td align="center">Thane<br>HY-TECH Engineers Pvt. Ltd.</td>
                        <td align="center">21/03/2024</td>
                        <td align="center">08:27 pm</td>
        ...
        <td>
            <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="4" bordercolor="#CCCCCC">
                <tr>
                    ...
                    <td align="left">Hyderabad -> Thane</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left">HY-TECH Engineers Pvt. Ltd.</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left">21st Mar 2024 (Thu) 08:27 PM</td>
                </tr>
                                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Return  Date Time</strong></td>
                    <td align="left">22nd Mar 2024 (Fri) 10:00 AM</td>
                </tr>
                 
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Kms Included  in your quotation</strong></td>
                    <td align="left">739 km</td>
                </tr>
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Charges  beyond 739 Km</strong></td>
                    <td align="left">15.00 / km</td>
                </tr>
                
                 <tr>
                    <td align="left"><strong style="color:#7a7a7a">Included with quotation</strong></td>
                    <td align="left">Upto 739 kms for the exact itinerary listed below. NO route deviations allowed unless listed in itinerary ; Toll & state taxes                    </td>
                </tr>
                <tr>
	...
	<tr>
        <td style="padding-top:5px;"><strong style="font-size:16px;">Cancellation Information </strong>(Booking created at 21 Mar 2024 04:24 PM)</td>
    </tr>
	<tr>
		<td>
				...
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #4CCD74 3px solid; text-align: center; padding: 10px; width: 100%;">
						...
						<p style="margin-bottom: 0;">21 Mar 2024 16:24 pm&nbsp;<span><img src="/images/email/transfer.png" alt="img" style="margin: 0 10px;"></span>&nbsp;21 Mar 2024 04:54 pm</p>
					</td>
				</tr>
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #f39132 3px solid; text-align: center; padding: 10px; margin-top: 2px;">
						...
						<p style="margin-bottom: 0;">21 Mar 2024 04:54 pm&nbsp;<span><img src="/images/email/transfer.png" alt="img" style="margin: 0 10px;"></span>&nbsp;21 Mar 2024 08:27 pm</p>
					</td>
				</tr>
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #EF2B2B 3px solid; text-align: center; padding: 10px; margin-top: 2px;">
						<span style="font-size: 14px;"><b>Cancellation Charge : &#x20b9;0 </b></span>
						<p style="margin-bottom: 0;">after 21 Mar 2024 08:27 pm</p>
					</td>
				</tr>
			</table>
		</td>
...
<ol type="1" style="font-size:10px; line-height:15px;padding-left:5px;">
    ...
    <ol type="a">
        ...
        <li>Drivable (739)  kms in your quote are estimates. You will be billed for the actual distance travelled by you. If you have not provided the exact address before your pickup or if the exact address could not be determined at time of providing you the booking amount estimate then your quote includes travel from city center to city center. Distance to be driven as quoted in the booking is only applicable for travel between the addresses, waypoints and locations as exactly specified in your itinerary.</li>
