...
<table style="width:98%;border: #d4d4d4 0px solid;border-collapse: collapse; font-family: 'Arial'; font-size: 12px; padding: 5px; color: #000;"  bgcolor="#fff" align="center" cellpadding="5" cellspacing="0">
    <tr>
        <td align="center"><p><strong style="font-size:16px;">RESERVATION CONFIRMED</strong><br />Thank you for choosing GozoCabs. We have confirmed your reservation request.You will receive the cab details at least 3 hours before your scheduled pickup time.                </p></td>
          ...
          <tr>
        <td class="text-center bg-danger p10 mb10">Please use OTP: <b>746096</b> at the time of pickup. Please don't share OTP before boarding the cab.
</td>
    </tr>
        <tr>
        <td>
                    ...
                    <td>
                        <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="5" bordercolor="#CCCCCC">
                            <tr>
                                ...
                                <td><a href="https://www.gozocabs.com/bkpn/1899261/s9mLj/e/okOzy" target="_blank">AP30-1899261 <p style="font-size:12px;">Check driver, car info and other details</p></a></td>
                            ...
                            <tr>
                                ...
                                <td>28th Feb 2023 (Tue) 06:30 PM</td>
                            </tr>
                            <tr>
                                <td><strong style="color:#7a7a7a">PICKUP ADDRESS:</strong></td>
                                <td>Amritsar Bus Stand, Mehar Pura, Amritsar, Punjab, India</td>
                            </tr>
                            <tr>
                                <td><strong style="color:#7a7a7a">SPECIAL INSTRUCTIONS:</strong></td>
                                <td><b>Customer special request</b><li>Senior Citizen Travelling</li><li>Kids on board</li><li>Women traveling</li><li>Require vehicle with Carrier</li><li>Cab should be clean</li></td>
                            </tr>
							<tr>
            ...
            <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="4" bordercolor="#CCCCCC">
                <tr>
                    ...
                    <td align="center" bgcolor="#FF6600"><span class="style1">Est.  Travel Duration</span></td>
                                    ...
                                    <tr>
                        <td align="center">Amritsar<br>Amritsar Bus Stand, Mehar Pura, Amritsar, Punjab, India</td>
                        <td align="center">Sri Guru Ram Dass Jee International Airport (ATQ), Amritsar<br>Sri Guru Ram Dass Jee International Airport</td>
                        <td align="center">28/02/2023</td>
                        <td align="center">06:30 pm</td>
                        <td align="center">13 Km</td>
                        <td align="center">0 Hours</td>
                    </tr>
                </table>
        </td>
    </tr>
        ...
        <td>
            <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="4" bordercolor="#CCCCCC">
                <tr>
                    ...
                    <td align="left">Amritsar -> Sri Guru Ram Dass Jee International Airport (ATQ), Amritsar</td>
                </tr>
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Cab type & Class </strong></td>
                    <td align="left">(Economy) Compact Indica, Swift, Alto, Ford Figo or equivalent (4 seater)</td>
                </tr>
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Pickup  Address</strong></td>
                    <td align="left">Amritsar Bus Stand, Mehar Pura, Amritsar, Punjab, India</td>
                </tr>
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Final  Drop Address</strong></td>
                    <td align="left">Sri Guru Ram Dass Jee International Airport</td>
                </tr>
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Journey  Type</strong></td>
                    <td align="left">Airport Packages</td>
                </tr>
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Pickup  Date Time</strong></td>
                    <td align="left">28th Feb 2023 (Tue) 06:30 PM</td>
                </tr>
                                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Return  Date Time</strong></td>
                    <td align="left">28th Feb 2023 (Tue) 06:56 PM</td>
                </tr>
                 
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Kms Included  in your quotation</strong></td>
                    <td align="left">13 km</td>
                </tr>
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Charges  beyond 13 Km</strong></td>
                    <td align="left">18.00 / km</td>
                </tr>
                
                 <tr>
                    <td align="left"><strong style="color:#7a7a7a">Included with quotation</strong></td>
                    <td align="left">Upto 13 kms for the exact itinerary listed below. NO route deviations allowed unless listed in itinerary ; Toll & state taxes                    </td>
                </tr>
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Additional charges paid</strong></td>
                    <td align="left">  
                       Carrier requested in car (Rs. 150/-)                    </td>
                </tr>
                 <tr>
                                       </tr>
            </table>
	...
	<tr>
        <td style="padding-top:5px;"><strong style="font-size:16px;">Cancellation Information </strong>(Booking created at 08 Feb 2023 04:08 PM)</td>
    </tr>
	<tr>
		<td>
				...
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #4CCD74 3px solid; text-align: center; padding: 10px; width: 100%;">
						...
						<p style="margin-bottom: 0;">08 Feb 2023 16:10 pm&nbsp;<span><img src="/images/email/transfer.png" alt="img" style="margin: 0 10px;"></span>&nbsp;27 Feb 2023 06:30 pm</p>
					</td>
				</tr>
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #f39132 3px solid; text-align: center; padding: 10px; margin-top: 2px;">
						<span style="font-size: 14px;"><b>Cancellation Charge : &#x20b9;762</b></span>
						<p style="margin-bottom: 0;">27 Feb 2023 06:30 pm&nbsp;<span><img src="/images/email/transfer.png" alt="img" style="margin: 0 10px;"></span>&nbsp;28 Feb 2023 06:30 pm</p>
					</td>
				</tr>
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #EF2B2B 3px solid; text-align: center; padding: 10px; margin-top: 2px;">
						<span style="font-size: 14px;"><b>Cancellation Charge : &#x20b9;762 </b></span>
						<p style="margin-bottom: 0;">after 28 Feb 2023 06:30 pm</p>
					</td>
				</tr>
			</table>
		</td>
