...
<table style="width:98%;border: #d4d4d4 0px solid;border-collapse: collapse; font-family: 'Arial'; font-size: 12px; padding: 5px; color: #000;"  bgcolor="#fff" align="center" cellpadding="5" cellspacing="0">
    <tr>
        <td align="center"><p><strong style="font-size:16px;">RESERVATION CREATED</strong><br />Thank  you for choosing GozoCabs. We have received your reservation request.                </p></td>
          ...
          <tr>
        <td class="text-center bg-danger p10 mb10">Please use OTP: <b>699241</b> at the time of pickup. Please don't share OTP before boarding the cab.
</td>
    </tr>
        <tr>
        <td>
                    ...
                    <td>
                        <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="5" bordercolor="#CCCCCC">
                            <tr>
                                ...
                                <td><a href="https://www.gozocabs.com/bkpn/3898408/gqtse/e/JFSQJ" target="_blank">AP40-3898408 <p style="font-size:12px;">Check driver, car info and other details</p></a></td>
                            ...
                            <tr>
                                ...
                                <td>21st Mar 2024 (Thu) 01:56 PM</td>
                            </tr>
                            <tr>
            ...
            <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="4" bordercolor="#CCCCCC">
                <tr>
                    ...
                    <td align="center" bgcolor="#FF6600"><span class="style1">Est.  Travel Duration</span></td>
                                    ...
                                    <tr>
                        <td align="center">Kempegowda International Airport (blr),  Bangalore<br>Bangalore</td>
                        <td align="center">Kempegowda International Airport (blr),  Bangalore<br>Taj Bangalore, Bengaluru</td>
        ...
        <td>
            <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="4" bordercolor="#CCCCCC">
                <tr>
                    ...
                    <td align="left">Kempegowda International Airport (blr),  Bangalore -> Kempegowda International Airport (blr),  Bangalore</td>
                </tr>
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Cab type & Class </strong></td>
                    <td align="left">(Value) Sedan Dzire, Toyota Etios, Tata Indigo or equivalent (4 seater)</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left">Taj Bangalore, Bengaluru</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left">21st Mar 2024 (Thu) 01:56 PM</td>
                </tr>
                                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Return  Date Time</strong></td>
                    <td align="left">21st Mar 2024 (Thu) 02:01 PM</td>
                </tr>
                ...
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Charges  beyond 1 Km</strong></td>
                    <td align="left">30.00 / km</td>
                </tr>
                
                 <tr>
                    <td align="left"><strong style="color:#7a7a7a">Included with quotation</strong></td>
                    <td align="left">Upto 1 kms for the exact itinerary listed below. NO route deviations allowed unless listed in itinerary ; Toll & state taxes                    </td>
                </tr>
                <tr>
	...
	<tr>
        <td style="padding-top:5px;"><strong style="font-size:16px;">Cancellation Information </strong>(Booking created at 20 Mar 2024 12:35 PM)</td>
    </tr>
	<tr>
		<td>
				...
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #4CCD74 3px solid; text-align: center; padding: 10px; width: 100%;">
						...
						<p style="margin-bottom: 0;">20 Mar 2024 12:35 pm&nbsp;<span><img src="/images/email/transfer.png" alt="img" style="margin: 0 10px;"></span>&nbsp;20 Mar 2024 01:56 pm</p>
					</td>
				</tr>
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #f39132 3px solid; text-align: center; padding: 10px; margin-top: 2px;">
						...
						<p style="margin-bottom: 0;">20 Mar 2024 01:56 pm&nbsp;<span><img src="/images/email/transfer.png" alt="img" style="margin: 0 10px;"></span>&nbsp;21 Mar 2024 01:56 pm</p>
					</td>
				</tr>
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #EF2B2B 3px solid; text-align: center; padding: 10px; margin-top: 2px;">
						<span style="font-size: 14px;"><b>Cancellation Charge : &#x20b9;0 </b></span>
						<p style="margin-bottom: 0;">after 21 Mar 2024 01:56 pm</p>
					</td>
				</tr>
			</table>
		</td>
