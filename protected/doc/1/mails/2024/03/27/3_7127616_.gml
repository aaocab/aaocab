        ...
        <div style="border-top:1px solid #C4C4C4;">
            <div style="width:600px; margin:0 auto; padding:20px 0;">
                <p style="color: #515151; font-size:12px; font-weight:300; text-align:center; padding:0; margin:0;">
                    This email is sent to jsrankesh.singh@yahoo.co.in because you have used this email address to register with Gozocabs.
                    If you haven't done so, please ignore this email.
If you received this email in error or do not wish to receive any further communications, please <a href="https://www.gozocabs.com/index/unsubscribeemail/hash/00000/email/jsrankesh.singh@yahoo.co.in" target="_BLANK">unsubscribe here.</a>
...
<table width="640" align="center" cellpadding="15" cellspacing="0"  bgcolor="#DDF5FF" style="font-family: 'Arial'; font-size: 14px; word-wrap: break-word; min-width: 360px;width: 640px;max-width: 640px; border: rgb(221, 245, 255) 1px solid;">
	...
	<tr>
		<td>
			<p style="color: #515151; font-size:12px; font-weight:300; text-align:center; padding:0; margin:0;">
				This email is sent to jsrankesh.singh@yahoo.co.in you because you have used this email address to register with Gozocabs.
				<!--                        If you haven't done so, please ignore this email.-->
				If you received this email in error or do not wish to receive any further communications, please <a href="https://www.gozocabs.com/index/unsubscribeemail/hash/00000/email/jsrankesh.singh@yahoo.co.in/type/3" target="_BLANK">unsubscribe here.</a>
				<a href="http://gozocabs.com/" style="color: #3d4f99;">Gozocabs</a> and the Gozocabs logo is a copyright of <br/><b>Gozo Technologies Pvt. Ltd.</b>
			</p>
		</td>
	</tr>
