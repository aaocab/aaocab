...
<table style="width:98%;border: #d4d4d4 0px solid;border-collapse: collapse; font-family: 'Arial'; font-size: 12px; padding: 5px; color: #000;"  bgcolor="#fff" align="center" cellpadding="5" cellspacing="0">
    <tr>
        <td align="center"><p><strong style="font-size:16px;">RESERVATION CREATED</strong><br />Thank  you for choosing GozoCabs. We have received your reservation request.                </p></td>
          ...
          <tr>
        <td class="text-center bg-danger p10 mb10">Please use OTP: <b>854128</b> at the time of pickup. Please don't share OTP before boarding the cab.
</td>
    </tr>
        <tr>
        <td>
                    ...
                    <td>
                        <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="5" bordercolor="#CCCCCC">
                            <tr>
                                ...
                                <td><a href="https://www.gozocabs.com/bkpn/3898270/OxATy/e/4aVHH" target="_blank">AP40-3898270 <p style="font-size:12px;">Check driver, car info and other details</p></a></td>
                            ...
                            <tr>
                                ...
                                <td>13th Mar 2024 (Wed) 07:00 PM</td>
                            </tr>
                            <tr>
            ...
            <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="4" bordercolor="#CCCCCC">
                <tr>
                    ...
                    <td align="center" bgcolor="#FF6600"><span class="style1">Est.  Travel Duration</span></td>
                        ...
                        <td align="center">Mumbai<br>Lower Malad</td>
                        <td align="center">13/03/2024</td>
                        <td align="center">07:00 pm</td>
        ...
        <td>
            <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="4" bordercolor="#CCCCCC">
                ...
                <tr>
                    ...
                    <td align="left">13th Mar 2024 (Wed) 07:00 PM</td>
                </tr>
                                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Return  Date Time</strong></td>
                    <td align="left">13th Mar 2024 (Wed) 07:28 PM</td>
                </tr>
                ...
                <tr>
                    <td align="left"><strong style="color:#7a7a7a">Charges  beyond 15 Km</strong></td>
                    <td align="left">22.00 / km</td>
                </tr>
                
                 <tr>
                    <td align="left"><strong style="color:#7a7a7a">Included with quotation</strong></td>
                    <td align="left">Upto 15 kms for the exact itinerary listed below. NO route deviations allowed unless listed in itinerary ; Toll & state taxes                    </td>
                </tr>
                <tr>
	...
	<tr>
        <td style="padding-top:5px;"><strong style="font-size:16px;">Cancellation Information </strong>(Booking created at 13 Mar 2024 06:13 PM)</td>
    </tr>
	<tr>
		<td>
				...
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #4CCD74 3px solid; text-align: center; padding: 10px; width: 100%;">
						...
						<p style="margin-bottom: 0;">13 Mar 2024 18:13 pm&nbsp;<span><img src="/images/email/transfer.png" alt="img" style="margin: 0 10px;"></span>&nbsp;13 Mar 2024 06:43 pm</p>
					</td>
				</tr>
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #f39132 3px solid; text-align: center; padding: 10px; margin-top: 2px;">
						...
						<p style="margin-bottom: 0;">13 Mar 2024 06:43 pm&nbsp;<span><img src="/images/email/transfer.png" alt="img" style="margin: 0 10px;"></span>&nbsp;13 Mar 2024 07:00 pm</p>
					</td>
				</tr>
				<tr>
					<td width="100%" style="border: #efefef 3px solid; border-left: #EF2B2B 3px solid; text-align: center; padding: 10px; margin-top: 2px;">
						<span style="font-size: 14px;"><b>Cancellation Charge : &#x20b9;0 </b></span>
						<p style="margin-bottom: 0;">after 13 Mar 2024 07:00 pm</p>
					</td>
				</tr>
			</table>
		</td>
