	...
	public function actionSendSMSForDCOApp($number = "9831100164")
	{
		for ($x = 0; $x < 10; $x++)
		{
			...
			foreach ($result as $data)
			{
				...
				#$number	 = "9831100164";
				$sms = new Messages();
				$msg = 'Dear Driver Partner, thank you for signing up. Download the app using https://c.gozo.cab/rMnyi and complete the profile to receive cab bookings - Gozocabs';
