...
//		if($model->brt_from_formatted_address=='' && $model->brt_to_formatted_address=='' && !$model->brt_from_city_is_airport && !$model->brt_to_city_is_airport)
//		{
//			$model->brt_from_latitude = '';
//			$model->brt_to_latitude = '';
//			$model->brt_from_longitude = '';
//			$model->brt_to_longitude = '';
//		}
	...
	public function setModelData(\BookingRoute $route)
	{
		...
		$this->source	 = new Location();
		$this->source->setData($route->brt_from_city_id, $fromCityName, $route->brt_from_location, $route->brt_from_latitude, $route->brt_from_longitude, $route->brt_from_is_airport, $route->brt_from_place_name);

		$this->destination = new Location();
		$this->destination->setData($route->brt_to_city_id, $toCityName, $route->brt_to_location, $route->brt_to_latitude, $route->brt_to_longitude, $route->brt_to_is_airport, $route->brt_to_place_name);
	}
	...
	public function getStoppageRouteData($stoppages, $pickupTime, $routeDuration, $endTime, $arrFinalRoute)
	{
		...
		//$model->brt_pickup_datetime = $pickupTime;
		return $model;
	}
